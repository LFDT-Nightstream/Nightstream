...
example (shape : Shape)
    ...
    productionHeader.length + carrierFieldCount shape 4 14 = 26713 :=
...
example (shape : Shape)
    ...
    (publicWidth : shape.publicWidth = 270)
    (matrixCount : shape.matrixCount = 13) :
    productionHeader.length + carrierFieldCount shape 18 14 = 37297 :=
  production_field_count shape rowVariables publicWidth matrixCount

example : conservativeFamilyFieldCount 18 - 37296 = 5748 := by
  simpa [conservativeFamilyFieldCount]
