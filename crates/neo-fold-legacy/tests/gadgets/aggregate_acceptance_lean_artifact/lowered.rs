...
use neo_fold_legacy::engine::r1cs_circuit::R1csEncodingTrace;
use neo_fold_legacy::frontends::f_prime::gadget_native::EncodedGadgetNativeR1cs;
use neo_fold_legacy::frontends::f_prime::gadget_native::GadgetNativeCoordinateGateRoles;
use neo_math::F;
