...
namespace tests.NebulaFullClaimEnvelope
...
#check Nightstream.Implementation.Nebula.FullClaimEnvelopeRows.input_eq_block
#check Nightstream.Implementation.Nebula.FullClaimNifsCall.satisfying_call_and_transition_bind_exact_claim
...
end tests.NebulaFullClaimEnvelope
