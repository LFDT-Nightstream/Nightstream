...
theorem chunkLeaf56 :
    ((rowsChunk wire 56).map (fun row => row.sourceIndex) =
        List.range' 3670016 65536) ∧
      ((rowsChunk wire 56).all (rowWellFormedAt 11187825 11078210) = true) ∧
...
theorem chunkLeaf57 :
    ((rowsChunk wire 57).map (fun row => row.sourceIndex) =
        List.range' 3735552 65536) ∧
      ((rowsChunk wire 57).all (rowWellFormedAt 11187825 11078210) = true) ∧
