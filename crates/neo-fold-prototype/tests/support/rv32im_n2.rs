...
use neo_fold_prototype::public_proof::rv32im::side_relation_spartan::measure_rv32im_side_binding_circuit_constraints;
use neo_fold_prototype::public_proof::rv32im::statement::build_rv32im_nightstream_statement_from_final;
...
use neo_fold_prototype::public_proof::NightstreamStatement;
use neo_fold_prototype::rv32im::audit::{
    prove_rv32im_public_proof_and_published_seam_with_perf, Rv32imPublishedProofSeam,
};
...
impl Rv32imN2Fixture {
    ...
    pub fn build_side_debug_inputs(
        ...
        (
            ...
            Vec<neo_fold_prototype::rv32im::kernel::FamilyEvalClaimWitness>,
        ),
        SimpleKernelError,
    > {
        let (_, witness) =
            neo_fold_prototype::public_proof::rv32im::side_eval_claim_relation::build_rv32im_side_eval_claim_relation_from_accepted_artifact(
                &self.accepted_artifact,
            )?;
        Ok((
            self.side_proof
    ...
    pub fn build_side_audit_inputs(
        ...
        (
            (),
            neo_fold_prototype::public_proof::rv32im::side_eval_claim_relation::Rv32imSideEvalClaimRelationWitness,
        ),
        SimpleKernelError,
    > {
        neo_fold_prototype::public_proof::rv32im::side_eval_claim_relation::build_rv32im_side_eval_claim_relation_from_accepted_artifact(
    ...
    Ok(FIXTURE
        .get_or_init(|| {
            ...
            let published_statement =
                neo_fold_prototype::rv32im::Rv32imAccumulatorPublicStatement::from_final_artifacts(
                    &final_statement,
                    &final_proof,
