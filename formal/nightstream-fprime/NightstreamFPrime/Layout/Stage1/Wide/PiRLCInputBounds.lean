...
namespace NightstreamFPrime.Layout.Stage1.Wide.PiRLCInputBounds
...
private theorem phase_le_commitment :
    PiRLCInputs.phaseOffset ≤
      PiRLC.Wide.Formal.commitmentOffset PiRLCInputs.phaseOffset := by
  unfold PiRLC.Wide.Formal.commitmentOffset
    PiRLC.Wide.Formal.samplerOffset
  omega
...
private theorem commitment_le_publicInput :
    PiRLC.Wide.Formal.commitmentOffset PiRLCInputs.phaseOffset ≤
      PiRLC.Wide.Formal.publicInputOffset PiRLCInputs.phaseOffset := by
  unfold PiRLC.Wide.Formal.publicInputOffset
  omega

private theorem publicInput_le_evalK :
    PiRLC.Wide.Formal.publicInputOffset PiRLCInputs.phaseOffset ≤
      PiRLC.Wide.Formal.evalKOffset PiRLCInputs.phaseOffset := by
  unfold PiRLC.Wide.Formal.evalKOffset
  omega

private theorem evalK_le_evalA :
    PiRLC.Wide.Formal.evalKOffset PiRLCInputs.phaseOffset ≤
      PiRLC.Wide.Formal.evalAOffset PiRLCInputs.phaseOffset := by
...
private theorem samplerChallengeBelow
    ...
    (PiRLC.Wide.ProjectedBatch.outputChallenge PiRLCInputs.phaseOffset source lane).VarsBelow
      (PiRLC.Wide.Formal.commitmentOffset PiRLCInputs.phaseOffset) :=
  PiRLC.Wide.ProjectedBatch.outputChallenge_below PiRLCInputs.phaseOffset source lane
...
theorem assumptions
    (relation : ProductionKey.LogicalRelation logicalWidth publicFits)
    (env : Env) :
    PiRLC.Wide.Formal.Assumptions relation
...
end NightstreamFPrime.Layout.Stage1.Wide.PiRLCInputBounds
