...
/-!
Owns the one physical R1CS lowering plan for the candidate wide PiRLC phase.
...
theorem physicalFreshColumnCount_eq_production
    ...
    physicalFreshColumnCount relation interface offset = 7875216 := by
...
theorem physicalRowCount_eq_production
    ...
    (interface : Formal.Interface logicalWidth publicFits) (offset : Nat)
    (inputs : InputShapes relation interface offset) :
    physicalRowCount relation interface offset = 7960165 := by
...
theorem physicalColumnCount_eq_production
    ...
    (interface : Formal.Interface logicalWidth publicFits) (offset : Nat)
    (inputs : InputShapes relation interface offset) :
    physicalColumnCount relation interface offset = offset + 7982945 := by
