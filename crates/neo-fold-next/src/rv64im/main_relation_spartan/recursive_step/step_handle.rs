...
pub(in crate::rv64im::main_relation_spartan) fn fixed_shape_recursive_step_handle_digest_circuit<
...
pub(in crate::rv64im::main_relation_spartan) fn fixed_shape_recursive_step_handle_digest_circuit_from_vars<
    CS: ConstraintSystem<SpartanF>,
>(
    cs: &mut CS,
    label: &str,
