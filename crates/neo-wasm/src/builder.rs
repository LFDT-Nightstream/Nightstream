...
use super::layout::{
    ...
    COL_LOCAL_VALUE_HI, COL_LOCAL_WRITE_ENABLED, COL_MEMORY_PAGES_AFTER, COL_MEMORY_PAGES_BEFORE, COL_ONE,
    COL_OPCODE_CODE, COL_PADDING_ACTIVE, COL_PARAM_INIT_ACTIVE_AFTER, COL_PARAM_INIT_ACTIVE_BEFORE,
    ...
    COL_PC_EDGE_KIND_IS_STATIC, COL_PC_ROM_ACTIVE, COL_SELECT_OUT_DELTA, COL_SHOUT_ENABLED, COL_SHOUT_ID,
    COL_SHOUT_VALUE, COL_SIGN_EXT_BIT, COL_SIGN_EXT_LOW7, COL_SP_AFTER, COL_SP_BEFORE, COL_STACK_READ0_ACTIVE,
    COL_STACK_READ0_ADDR, COL_STACK_READ0_VALUE, COL_STACK_READ0_VALUE_HI, COL_STACK_READ1_ACTIVE,
    COL_STACK_READ1_ADDR, COL_STACK_READ1_VALUE, COL_STACK_READ1_VALUE_HI, COL_STACK_READ2_ACTIVE,
    COL_STACK_READ2_ADDR, COL_STACK_READ2_VALUE, COL_STACK_READ2_VALUE_HI, COL_STACK_READS, COL_STACK_WRITE0_ACTIVE,
    COL_STACK_WRITE0_ADDR, COL_STACK_WRITE0_VALUE, COL_STACK_WRITE0_VALUE_HI, COL_STACK_WRITES, COL_TABLE_ID,
