...
namespace Nightstream.Implementation.R1CS.Artifacts.MinimizerCampaign.Generated.RecursiveNifsPiRlcVerifyPaddingYRingRedundancyLeaf0
...
theorem chunkLeaf0 :
    ((rowsChunk wire 0).filter
        (fun row => decide (row.family = certFamily)) =
      (certParts 0).map (fun scalar => scalar.candidate)) ∧
      ((certParts 0).all (fun scalar =>
        duplicateOk scalar &&
...
end Nightstream.Implementation.R1CS.Artifacts.MinimizerCampaign.Generated.RecursiveNifsPiRlcVerifyPaddingYRingRedundancyLeaf0
