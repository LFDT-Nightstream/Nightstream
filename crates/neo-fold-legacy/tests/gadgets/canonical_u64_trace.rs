...
use neo_fold_legacy::engine::r1cs_circuit::encoding_trace::CanonicalU64TraceTestMutation;
use neo_fold_legacy::engine::r1cs_circuit::u64_arith::{alloc_u64_bits, decompose_var_to_u64_bits};
use neo_fold_legacy::engine::r1cs_circuit::{Lc, R1csBuilder, R1csEncodingTrace, R1csSnapshot, Var};
