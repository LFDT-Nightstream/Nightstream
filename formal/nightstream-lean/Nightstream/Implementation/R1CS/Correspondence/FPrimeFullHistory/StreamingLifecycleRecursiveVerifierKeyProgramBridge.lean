...
import Nightstream.Implementation.R1CS.Artifacts.FPrimeFullHistory.StreamingLifecycleRecursiveVerifierKeyHashValidityCertificate
import Nightstream.Implementation.Rust.CanonicalConformance.NativeStep.VerifierKeyProgram

/-!
Contract: exact value-order bridge from the Rust-emitted recursive
verifier-key hash recipes to the typed native preimage programs.
...
namespace Nightstream.Implementation.R1CS.Correspondence.FPrimeFullHistory.StreamingLifecycleRecursiveVerifierKeyProgramBridge
...
policy hash. This is a constant-size artifact leaf, not a reduction over the
complete generated stage. -/
theorem base_outputColumns_feed_policy :
    rawArtifact.baseVerifierKeyHash.recipe.outputColumns =
      baseDigestColumns := by
  change [30394927, 30394928, 30394929, 30394930] =
    List.range' 30394927 4
...
theorem policyBinding_rightColumns_exact :
  ...
  change [30397951, 30397952, 30397953, 30397954] =
    [30397951, 30397952, 30397953, 30397954]
  rfl
...
theorem initialBoundaryBinding_rightColumns_exact :
  ...
  change [30400373, 30400374, 30400375, 30400376] =
    [30400373, 30400374, 30400375, 30400376]
  rfl
...
end Nightstream.Implementation.R1CS.Correspondence.FPrimeFullHistory.StreamingLifecycleRecursiveVerifierKeyProgramBridge
