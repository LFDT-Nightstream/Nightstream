...
use neo_fold_prototype::circuit::superneo::k_field::{alloc_constant_k, alloc_k, KNum};
use neo_fold_prototype::circuit::superneo::sumcheck::{sumcheck_eval_gadget, sumcheck_round_gadget};
...
fn rv32im_main_relation_sumcheck_gadgets_match_native_horner_logic() {
    ...
    neo_fold_prototype::circuit::superneo::k_field::enforce_k_eq(&mut cs, &eval, &expected_eval, "eval_eq");
