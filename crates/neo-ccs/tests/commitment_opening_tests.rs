...
fn test_commitment_opening_large_rows() {
    ...
    let rows = vec![
        ...
        vec![F::from_u64(0), F::from_u64(0), F::from_u64(1), F::from_u64(1), 
             F::from_u64(1), F::from_u64(1), F::from_u64(0), F::from_u64(0)],
        vec![F::from_u64(5), F::from_u64(0), F::from_u64(0), F::from_u64(0), 
             F::from_u64(0), F::from_u64(0), F::from_u64(0), F::from_u64(7)],
    ];
    
    let z_digits = vec![F::from_u64(1), F::from_u64(1), F::from_u64(2), F::from_u64(2),
                        F::from_u64(3), F::from_u64(3), F::from_u64(4), F::from_u64(4)];
    let witness = build_opening_witness(&z_digits);
...
fn test_commitment_lincomb_large_vectors() {
    ...
    let c_prev = vec![F::from_u64(10), F::from_u64(20), F::from_u64(30), 
                      F::from_u64(40), F::from_u64(50)];
    let c_step = vec![F::from_u64(1), F::from_u64(2), F::from_u64(3), 
                      F::from_u64(4), F::from_u64(5)];
