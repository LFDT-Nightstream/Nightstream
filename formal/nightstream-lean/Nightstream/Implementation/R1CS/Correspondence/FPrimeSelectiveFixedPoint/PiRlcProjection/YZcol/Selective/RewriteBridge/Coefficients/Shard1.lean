...
/-!
Proof-free coefficient certificate for rewrite pairs 250 through 499.
...
|---|---|---|---|
| rewrite chunk 1 | all thirteen normalized port forms match | checked | 250 records |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.RewriteBridge.Coefficients.Shard1
...
def pairs : List RewritePair := rewriteCoefficientChunk1

def data : List CoefficientMatchShape := rewriteCoefficientDataChunk1

theorem dataLengthExact : data.length = 250 :=
  rewriteCoefficientDataChunkLengthsExact.2.1
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.RewriteBridge.Coefficients.Shard1
