...
/-- info: 'Nightstream.Implementation.R1CS.FPrimeFullHistoryStreamingPiRLCFamilyBodyAlgebraRetained.decoder_prefix_exact' depends on axioms: [Lean.trustCompiler] -/
#guard_msgs in
#audit_axioms decoder_prefix_exact

/-- info: 'Nightstream.Implementation.R1CS.FPrimeFullHistoryStreamingPiRLCFamilyBodyAlgebraRetained.retained_intervals_exact' depends on axioms: [Lean.trustCompiler] -/
#guard_msgs in
