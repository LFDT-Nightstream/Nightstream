...
pub(super) struct Rv32imChunkNifsVerifierCtx<'a> {
    ...
    pub(super) cover_chunk: &'a Rv32imMainCircuitChunkCover,
    pub(super) chunk: &'a Rv32imMainCircuitChunkReplaySurface,
    ...
    pub(super) boundary_plan: Rv32imChunkBoundaryPlan,
    pub(super) rlc_zero_commit_suffix_len: usize,
    pub(super) exact_initial_chunk_step_count: Option<usize>,
}

pub(in crate::frontends::rv32im::main_relation_spartan) struct Rv32imPiCcsStageOutput {
    pub(in crate::frontends::rv32im::main_relation_spartan) effective_output_count: usize,
    pub(in crate::frontends::rv32im::main_relation_spartan) me_input_projection_digests:
        Vec<[AllocatedNum<SpartanF>; 4]>,
    pub(in crate::frontends::rv32im::main_relation_spartan) padded_ccs_outputs: Vec<CircuitCeClaim>,
    pub(in crate::frontends::rv32im::main_relation_spartan) r_prime_vars: Vec<KNumVar>,
    pub(in crate::frontends::rv32im::main_relation_spartan) s_col_prime_vars: Vec<KNumVar>,
    pub(in crate::frontends::rv32im::main_relation_spartan) fold_digest: [AllocatedNum<SpartanF>; 4],
    pub(in crate::frontends::rv32im::main_relation_spartan) public_chunk_instance_digest: [AllocatedNum<SpartanF>; 4],
    pub(in crate::frontends::rv32im::main_relation_spartan) public_chunk_digest: [AllocatedNum<SpartanF>; 4],
    pub(in crate::frontends::rv32im::main_relation_spartan) public_chunk_start_index: AllocatedNum<SpartanF>,
    pub(in crate::frontends::rv32im::main_relation_spartan) public_chunk_start_index_halves:
        [AllocatedNum<SpartanF>; 2],
    pub(in crate::frontends::rv32im::main_relation_spartan) public_chunk_start_index_half_values: [SpartanF; 2],
    pub(in crate::frontends::rv32im::main_relation_spartan) public_chunk_start_index_value: SpartanF,
    pub(in crate::frontends::rv32im::main_relation_spartan) public_step_count: AllocatedNum<SpartanF>,
    pub(in crate::frontends::rv32im::main_relation_spartan) public_step_count_halves: [AllocatedNum<SpartanF>; 2],
    pub(in crate::frontends::rv32im::main_relation_spartan) public_step_count_half_values: [SpartanF; 2],
    pub(in crate::frontends::rv32im::main_relation_spartan) public_step_count_value: SpartanF,
    pub(in crate::frontends::rv32im::main_relation_spartan) public_step_vars:
        Vec<crate::superneo_circuit::public_chunk::PublicStepVar>,
    pub(in crate::frontends::rv32im::main_relation_spartan) fe_rounds: Vec<Vec<KNumVar>>,
    pub(in crate::frontends::rv32im::main_relation_spartan) fe_round_values: Vec<Vec<K>>,
    pub(in crate::frontends::rv32im::main_relation_spartan) nc_rounds: Vec<Vec<KNumVar>>,
    pub(in crate::frontends::rv32im::main_relation_spartan) nc_round_values: Vec<Vec<K>>,
}

pub(super) struct Rv32imPiRlcStageOutput {
    pub(super) parent_claim: CircuitCeClaim,
}

pub(super) struct Rv32imChunkNifsVerifierBodyOutput {
    pub(super) next_claims: Rv32imClaimBundle,
    pub(super) pi_ccs: Rv32imPiCcsStageOutput,
...
fn enforce_public_step_matches_fresh_claim<CS: ConstraintSystem<SpartanF>>(
    cs: &mut CS,
    public_step: &crate::superneo_circuit::public_chunk::PublicStepVar,
    fresh: &crate::superneo_circuit::output_binding::FreshCcsClaimVar,
    layout: Rv32imMainCircuitPublicInputLayout,
    label: &str,
...
fn public_input_projection_index(
    ...
    match layout {
        Rv32imMainCircuitPublicInputLayout::PackedPrefix => (col % D)
            .checked_mul(m_in)
...
pub(super) fn synthesize_rv32im_chunk_nifs_verifier_body_with_outer_relation_mode<CS: ConstraintSystem<SpartanF>>(
    params: &NeoParams,
...
) -> Result<Rv32imChunkNifsVerifierBodyOutput, SynthesisError> {
    ...
    Ok(Rv32imChunkNifsVerifierBodyOutput {
...
pub(super) fn synthesize_rv32im_chunk_nifs_verifier_body_with_synthetic_chunk_relation_io<
...
>(
    ...
    Ok(synthesize_rv32im_chunk_nifs_verifier_body_with_outer_relation_mode(
        params,
        structure,
        dims,
        mat_digest,
...
pub(super) fn synthesize_pi_ccs_stage<CS: ConstraintSystem<SpartanF>>(
    ctx: &Rv32imChunkNifsVerifierCtx<'_>,
    cs: &mut CS,
    transcript: &mut Poseidon2TranscriptCircuit,
    carried_claims: &Rv32imClaimBundle,
    trace_prefix: Option<&str>,
) -> Result<Rv32imPiCcsStageOutput, SynthesisError> {
    let started = Instant::now();
    ...
    let covered_fresh_claim_vars = covered_fresh_claims
        ...
        .map(|(fresh_index, fresh)| {
            let witness = ctx
                ...
                .get(fresh_index)
                .ok_or(SynthesisError::Unsatisfiable)?;
            crate::superneo_circuit::output_binding::alloc_fresh_ccs_claim_with_witness(
    ...
    let public_step_vars = ctx
        ...
        .enumerate()
        .map(|(step_index, step)| {
            crate::superneo_circuit::public_chunk::alloc_public_step(
    ...
    let public_chunk_instance_digest = crate::superneo_circuit::public_chunk::public_chunk_instance_digest(
    ...
    let public_chunk_digest = crate::superneo_circuit::public_chunk::rv32im_public_chunk_digest(
    ...
    let me_input_projection_digests =
        if let Some((accumulator_handle, accumulator_handle_values)) = ctx.me_input_accumulator_handle {
            ...
            crate::superneo_circuit::pi_ccs::bind_me_inputs_with_native_claims(
    ...
    let constant_child_prefix = match ctx.boundary_plan.rlc_mode {
        Rv32imChunkRlcMode::Standard { constant_child_prefix } => constant_child_prefix,
        Rv32imChunkRlcMode::TerminalLastChunkShortcut => 0,
    };
...
pub(super) fn synthesize_pi_rlc_stage<CS: ConstraintSystem<SpartanF>>(
    ...
    cs: &mut CS,
    transcript: &mut Poseidon2TranscriptCircuit,
    pi_ccs: &Rv32imPiCcsStageOutput,
) -> Result<Rv32imPiRlcStageOutput, SynthesisError> {
    ...
    Ok(Rv32imPiRlcStageOutput { parent_claim })
}
...
pub(super) fn synthesize_pi_dec_stage<CS: ConstraintSystem<SpartanF>>(
    ...
    match ctx.boundary_plan.next_carry_mode {
        Rv32imChunkNextCarryMode::ReplaceWithEffectiveChildren => {
            ...
            Ok(Rv32imClaimBundle::from_padded_claims(
                padded_child_claims,
