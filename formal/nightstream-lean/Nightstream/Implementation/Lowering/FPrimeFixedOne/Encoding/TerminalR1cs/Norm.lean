...
namespace Nightstream.Implementation.Lowering.FPrimeFixedOne.Encoding.TerminalR1cs.Norm
...
theorem rowAt_supported {shape : Phi81Relation.Shape}
  ...
  · simpa [rowAt, even, OwnedRow.columnIds, Row.columnIds,
      CanonicalRow.row, Goldilocks.singleton, or_comm] using mentioned
  · simpa [rowAt, even, OwnedRow.columnIds, Row.columnIds,
      CanonicalRow.row, Goldilocks.singleton, or_comm] using mentioned
...
end Nightstream.Implementation.Lowering.FPrimeFixedOne.Encoding.TerminalR1cs.Norm
