...
/-!
Executable certificate for generated raw-running decoder shard 12.
...
Owns: the exact executable certificate for generated shard 12, containing
...
|---|---|---|
| `nifs.pi_ccs.nc.delayed.raw_decoder.artifact.census.chunk12` | check exactly one 252-record decoder shard | checked artifact |
-/

namespace Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder.Census.Chunk12

open Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder

theorem exact : ExactChunk ⟨12, by decide⟩
    Generated.Chunk12.schemaVersion
    Generated.Chunk12.sourceArm
    Generated.Chunk12.childCount
    Generated.Chunk12.logicalColumnCount
    Generated.Chunk12.finalColumnCount
    Generated.Chunk12.allocationRecords := by
  unfold ExactChunk ExactRecords
  native_decide

end Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder.Census.Chunk12
