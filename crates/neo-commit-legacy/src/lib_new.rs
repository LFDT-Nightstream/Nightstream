...
// Core Ajtai commitment module (always enabled)
pub mod ajtai;
...
// Re-export main types and functions from ajtai module
pub use ajtai::{
...
// Legacy compatibility exports (deprecated - use ajtai module directly)
#[deprecated(note = "Use ajtai::GOLDILOCKS_PARAMS instead")]
pub use ajtai::GOLDILOCKS_PARAMS as PRESET_GOLDILOCKS;
...
pub fn pack_decomp(mat: &RowMajorMatrix<F>, params: &NeoParams) -> Vec<RingElement<ModInt>> {
    ajtai::embedding::pack_decomp_matrix(mat, params.n)
}
