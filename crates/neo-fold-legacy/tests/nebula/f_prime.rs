...
use neo_fold_legacy::frontends::nebula::circuit::StepData;
...
use neo_fold_legacy::frontends::nebula::fingerprint::Gammas;
use neo_fold_legacy::frontends::nebula::layout::{encode_delayed_f_prime_suffix, NebulaParams};
...
use neo_fold_legacy::lifecycle::{preprocess, Preprocessing};
use neo_fold_legacy::paper::construction2::{LaneCommitmentMode, NebulaLane, RunningInstance};
...
use neo_fold_legacy::paper::f_prime::source_image::FPrimeSourceImage;
use neo_fold_legacy::paper::nifs::circuit::NifsVCircuitConfig;
...
fn shape_test_params() -> neo_fold_legacy::Params {
    ...
    neo_fold_legacy::Params::test_only_from_neo_params(inner)
}

fn shape_test_radix_four_params() -> neo_fold_legacy::Params {
    let inner = neo_params::NeoParams::new(
        neo_params::goldilocks_paper_b2::Q,
        neo_params::goldilocks_paper_b2::ETA as u32,
        neo_params::goldilocks_paper_b2::D as u32,
...
fn preprocessing(circuit: &neo_fold_legacy::frontends::nebula::circuit::SMemCircuit) -> Preprocessing {
...
fn base_step_composes_current_s_mem_and_exports_one_relation() {
    ...
    let circuit = neo_fold_legacy::frontends::nebula::circuit::SMemCircuit::new(params);
...
fn minimal_chain_params() -> neo_fold_legacy::Params {
    let inner = neo_params::NeoParams::new(
        neo_params::goldilocks_paper_b2::Q,
        neo_params::goldilocks_paper_b2::ETA as u32,
        neo_params::goldilocks_paper_b2::D as u32,
