...
pub(crate) fn add_poseidon_linkage_constraints(
    ...
    add_direct_state_image_pair_digest_constraints(a_trips, b_trips, c_trips, row, witness, source, source_start_col)?;
    add_digest_update_pair_constraints(a_trips, b_trips, c_trips, row, witness, source, source_start_col)?;
    add_construction2_boundary_pair_digest_constraints(
        a_trips,
        b_trips,
        c_trips,
        row,
...
fn add_direct_state_image_pair_digest_constraints(
    a_trips: &mut Vec<(usize, usize, F)>,
    b_trips: &mut Vec<(usize, usize, F)>,
    c_trips: &mut Vec<(usize, usize, F)>,
    row: &mut usize,
...
fn add_digest_update_pair_constraints(
    a_trips: &mut Vec<(usize, usize, F)>,
    b_trips: &mut Vec<(usize, usize, F)>,
    c_trips: &mut Vec<(usize, usize, F)>,
    row: &mut usize,
...
fn add_construction2_boundary_pair_digest_constraints(
    a_trips: &mut Vec<(usize, usize, F)>,
    b_trips: &mut Vec<(usize, usize, F)>,
    c_trips: &mut Vec<(usize, usize, F)>,
    row: &mut usize,
