...
namespace NightstreamFPrime.Layout.Stage1.Wide.PilotPiCCSPiRLCPiDEC
...
theorem piDecOffset_eq : piDecOffset = 27545310 := by
  rfl
...
end NightstreamFPrime.Layout.Stage1.Wide.PilotPiCCSPiRLCPiDEC
