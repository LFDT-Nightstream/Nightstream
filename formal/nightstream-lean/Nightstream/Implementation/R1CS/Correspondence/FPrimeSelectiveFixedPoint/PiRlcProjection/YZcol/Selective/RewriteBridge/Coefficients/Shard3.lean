...
/-!
Proof-free coefficient certificate for rewrite pairs 750 through 999.
...
|---|---|---|---|
| rewrite chunk 3 | all thirteen normalized port forms match | checked | 250 records |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.RewriteBridge.Coefficients.Shard3
...
def pairs : List RewritePair := rewriteCoefficientChunk3

def data : List CoefficientMatchShape := rewriteCoefficientDataChunk3

theorem dataLengthExact : data.length = 250 :=
  rewriteCoefficientDataChunkLengthsExact.2.2.2.1
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.RewriteBridge.Coefficients.Shard3
