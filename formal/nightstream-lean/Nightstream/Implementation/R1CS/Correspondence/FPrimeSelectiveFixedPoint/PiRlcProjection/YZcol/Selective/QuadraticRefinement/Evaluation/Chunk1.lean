...
/-!
Executable evaluation-group certificate shard 1.
...
|---|---|---|
| evaluation shard 1 | every pair in this slice matches its independent target | checked |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk1
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk1
