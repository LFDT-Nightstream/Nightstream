...
namespace Nightstream.Implementation.NebulaV2.SnapshotSlotRows
...
open Nightstream.Protocol.NebulaV2.SnapshotSlot
...
def Layout.valueWord (layout : Layout) : BoundedWordRows.Layout :=
  { width := Nightstream.Protocol.NebulaV2.valueBits
...
def Layout.boundaryAddition (layout : Layout) : UnsignedAdditionRows.Layout :=
  { leftWidth := Nightstream.Protocol.NebulaV2.timestampBits
    rightWidth := Nightstream.Protocol.NebulaV2.timestampBits
  ...
  have bounded := BoundedWordRows.value_lt_twoPower
    (layout := layout.valueWord) (by
      norm_num [Layout.valueWord,
        Nightstream.Protocol.NebulaV2.valueBits, goldilocksP])
...
private theorem value_eval
  ...
  have base' : lcEval assignment
    ...
    simpa [bitWordBase, BoundedWordRows.Layout.terms,
      ...
      Nightstream.Protocol.NebulaV2.valueBits] using base
  rw [base']
...
private theorem timestamp_eval
  ...
  have base' : lcEval assignment
    ...
    simpa [bitWordBase, BoundedWordRows.Layout.terms,
      ...
      ConcreteLaneGeometry.timestampBits,
      Nightstream.Protocol.NebulaV2.timestampBits] using base
  rw [base']
...
private theorem packed_eval
  ...
  have stepTermBound : timestampLimit * scanSlots *
    ...
    norm_num [timestampLimit,
      Nightstream.Protocol.NebulaV2.timestampBits, scanSlots,
  ...
  have firstBound : assignment layout.aux.timestamp +
    ...
    norm_num [scanSlots, timestampLimit,
      Nightstream.Protocol.NebulaV2.timestampBits] at tupleBound ⊢
    omega
...
end Nightstream.Implementation.NebulaV2.SnapshotSlotRows
