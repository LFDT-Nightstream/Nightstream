...
def rawRow00 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 15504881536434223753 }], geometric := [{ slot := .externalA 0, initial := 4, ratio := 3 }, { slot := .externalA 1, initial := 6, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }, { slot := .externalA 3, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 4, ratio := 3 }, { slot := .previousLocal 84, initial := 4, ratio := 3 }, { slot := .previousLocal 83, initial := 12, ratio := 3 }, { slot := .previousLocal 82, initial := 8, ratio := 3 }, { slot := .previousLocal 81, initial := 2, ratio := 3 }, { slot := .previousLocal 80, initial := 2, ratio := 3 }, { slot := .previousLocal 79, initial := 6, ratio := 3 }, { slot := .previousLocal 78, initial := 4, ratio := 3 }, { slot := .previousLocal 85, initial := 6, ratio := 3 }, { slot := .previousLocal 84, initial := 18, ratio := 3 }, { slot := .previousLocal 83, initial := 12, ratio := 3 }, { slot := .previousLocal 82, initial := 6, ratio := 3 }, { slot := .previousLocal 81, initial := 3, ratio := 3 }, { slot := .previousLocal 80, initial := 9, ratio := 3 }, { slot := .previousLocal 79, initial := 6, ratio := 3 }, { slot := .previousLocal 78, initial := 3, ratio := 3 }, { slot := .previousLocal 85, initial := 6, ratio := 3 }, { slot := .previousLocal 84, initial := 4, ratio := 3 }, { slot := .previousLocal 83, initial := 2, ratio := 3 }, { slot := .previousLocal 82, initial := 2, ratio := 3 }, { slot := .previousLocal 81, initial := 3, ratio := 3 }, { slot := .previousLocal 80, initial := 2, ratio := 3 }, { slot := .previousLocal 79, initial := 1, ratio := 3 }, { slot := .previousLocal 78, initial := 1, ratio := 3 }, { slot := .previousLocal 85, initial := 4, ratio := 3 }, { slot := .previousLocal 84, initial := 2, ratio := 3 }, { slot := .previousLocal 83, initial := 2, ratio := 3 }, { slot := .previousLocal 82, initial := 6, ratio := 3 }, { slot := .previousLocal 81, initial := 2, ratio := 3 }, { slot := .previousLocal 80, initial := 1, ratio := 3 }, { slot := .previousLocal 79, initial := 1, ratio := 3 }, { slot := .previousLocal 78, initial := 3, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow01 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 2212164856944708396 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 4, ratio := 3 }, { slot := .externalA 2, initial := 6, ratio := 3 }, { slot := .externalA 3, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 2, ratio := 3 }, { slot := .previousLocal 84, initial := 2, ratio := 3 }, { slot := .previousLocal 83, initial := 6, ratio := 3 }, { slot := .previousLocal 82, initial := 4, ratio := 3 }, { slot := .previousLocal 81, initial := 1, ratio := 3 }, { slot := .previousLocal 80, initial := 1, ratio := 3 }, { slot := .previousLocal 79, initial := 3, ratio := 3 }, { slot := .previousLocal 78, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 4, ratio := 3 }, { slot := .previousLocal 84, initial := 12, ratio := 3 }, { slot := .previousLocal 83, initial := 8, ratio := 3 }, { slot := .previousLocal 82, initial := 4, ratio := 3 }, { slot := .previousLocal 81, initial := 2, ratio := 3 }, { slot := .previousLocal 80, initial := 6, ratio := 3 }, { slot := .previousLocal 79, initial := 4, ratio := 3 }, { slot := .previousLocal 78, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 18, ratio := 3 }, { slot := .previousLocal 84, initial := 12, ratio := 3 }, { slot := .previousLocal 83, initial := 6, ratio := 3 }, { slot := .previousLocal 82, initial := 6, ratio := 3 }, { slot := .previousLocal 81, initial := 9, ratio := 3 }, { slot := .previousLocal 80, initial := 6, ratio := 3 }, { slot := .previousLocal 79, initial := 3, ratio := 3 }, { slot := .previousLocal 78, initial := 3, ratio := 3 }, { slot := .previousLocal 85, initial := 4, ratio := 3 }, { slot := .previousLocal 84, initial := 2, ratio := 3 }, { slot := .previousLocal 83, initial := 2, ratio := 3 }, { slot := .previousLocal 82, initial := 6, ratio := 3 }, { slot := .previousLocal 81, initial := 2, ratio := 3 }, { slot := .previousLocal 80, initial := 1, ratio := 3 }, { slot := .previousLocal 79, initial := 1, ratio := 3 }, { slot := .previousLocal 78, initial := 3, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow02 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 1885257220781225929 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 4, ratio := 3 }, { slot := .externalA 3, initial := 6, ratio := 3 }, { slot := .previousLocal 85, initial := 2, ratio := 3 }, { slot := .previousLocal 84, initial := 2, ratio := 3 }, { slot := .previousLocal 83, initial := 6, ratio := 3 }, { slot := .previousLocal 82, initial := 4, ratio := 3 }, { slot := .previousLocal 81, initial := 1, ratio := 3 }, { slot := .previousLocal 80, initial := 1, ratio := 3 }, { slot := .previousLocal 79, initial := 3, ratio := 3 }, { slot := .previousLocal 78, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 2, ratio := 3 }, { slot := .previousLocal 84, initial := 6, ratio := 3 }, { slot := .previousLocal 83, initial := 4, ratio := 3 }, { slot := .previousLocal 82, initial := 2, ratio := 3 }, { slot := .previousLocal 81, initial := 1, ratio := 3 }, { slot := .previousLocal 80, initial := 3, ratio := 3 }, { slot := .previousLocal 79, initial := 2, ratio := 3 }, { slot := .previousLocal 78, initial := 1, ratio := 3 }, { slot := .previousLocal 85, initial := 12, ratio := 3 }, { slot := .previousLocal 84, initial := 8, ratio := 3 }, { slot := .previousLocal 83, initial := 4, ratio := 3 }, { slot := .previousLocal 82, initial := 4, ratio := 3 }, { slot := .previousLocal 81, initial := 6, ratio := 3 }, { slot := .previousLocal 80, initial := 4, ratio := 3 }, { slot := .previousLocal 79, initial := 2, ratio := 3 }, { slot := .previousLocal 78, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 12, ratio := 3 }, { slot := .previousLocal 84, initial := 6, ratio := 3 }, { slot := .previousLocal 83, initial := 6, ratio := 3 }, { slot := .previousLocal 82, initial := 18, ratio := 3 }, { slot := .previousLocal 81, initial := 6, ratio := 3 }, { slot := .previousLocal 80, initial := 3, ratio := 3 }, { slot := .previousLocal 79, initial := 3, ratio := 3 }, { slot := .previousLocal 78, initial := 9, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow03 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 17531637481572944510 }], geometric := [{ slot := .externalA 0, initial := 6, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }, { slot := .externalA 3, initial := 4, ratio := 3 }, { slot := .previousLocal 85, initial := 6, ratio := 3 }, { slot := .previousLocal 84, initial := 6, ratio := 3 }, { slot := .previousLocal 83, initial := 18, ratio := 3 }, { slot := .previousLocal 82, initial := 12, ratio := 3 }, { slot := .previousLocal 81, initial := 3, ratio := 3 }, { slot := .previousLocal 80, initial := 3, ratio := 3 }, { slot := .previousLocal 79, initial := 9, ratio := 3 }, { slot := .previousLocal 78, initial := 6, ratio := 3 }, { slot := .previousLocal 85, initial := 2, ratio := 3 }, { slot := .previousLocal 84, initial := 6, ratio := 3 }, { slot := .previousLocal 83, initial := 4, ratio := 3 }, { slot := .previousLocal 82, initial := 2, ratio := 3 }, { slot := .previousLocal 81, initial := 1, ratio := 3 }, { slot := .previousLocal 80, initial := 3, ratio := 3 }, { slot := .previousLocal 79, initial := 2, ratio := 3 }, { slot := .previousLocal 78, initial := 1, ratio := 3 }, { slot := .previousLocal 85, initial := 6, ratio := 3 }, { slot := .previousLocal 84, initial := 4, ratio := 3 }, { slot := .previousLocal 83, initial := 2, ratio := 3 }, { slot := .previousLocal 82, initial := 2, ratio := 3 }, { slot := .previousLocal 81, initial := 3, ratio := 3 }, { slot := .previousLocal 80, initial := 2, ratio := 3 }, { slot := .previousLocal 79, initial := 1, ratio := 3 }, { slot := .previousLocal 78, initial := 1, ratio := 3 }, { slot := .previousLocal 85, initial := 8, ratio := 3 }, { slot := .previousLocal 84, initial := 4, ratio := 3 }, { slot := .previousLocal 83, initial := 4, ratio := 3 }, { slot := .previousLocal 82, initial := 12, ratio := 3 }, { slot := .previousLocal 81, initial := 4, ratio := 3 }, { slot := .previousLocal 80, initial := 2, ratio := 3 }, { slot := .previousLocal 79, initial := 2, ratio := 3 }, { slot := .previousLocal 78, initial := 6, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow04 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 16769640728293682348 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 3, ratio := 3 }, { slot := .externalA 2, initial := 1, ratio := 3 }, { slot := .externalA 3, initial := 1, ratio := 3 }, { slot := .previousLocal 85, initial := 8, ratio := 3 }, { slot := .previousLocal 84, initial := 8, ratio := 3 }, { slot := .previousLocal 83, initial := 24, ratio := 3 }, { slot := .previousLocal 82, initial := 16, ratio := 3 }, { slot := .previousLocal 81, initial := 4, ratio := 3 }, { slot := .previousLocal 80, initial := 4, ratio := 3 }, { slot := .previousLocal 79, initial := 12, ratio := 3 }, { slot := .previousLocal 78, initial := 8, ratio := 3 }, { slot := .previousLocal 85, initial := 12, ratio := 3 }, { slot := .previousLocal 84, initial := 36, ratio := 3 }, { slot := .previousLocal 83, initial := 24, ratio := 3 }, { slot := .previousLocal 82, initial := 12, ratio := 3 }, { slot := .previousLocal 81, initial := 6, ratio := 3 }, { slot := .previousLocal 80, initial := 18, ratio := 3 }, { slot := .previousLocal 79, initial := 12, ratio := 3 }, { slot := .previousLocal 78, initial := 6, ratio := 3 }, { slot := .previousLocal 85, initial := 12, ratio := 3 }, { slot := .previousLocal 84, initial := 8, ratio := 3 }, { slot := .previousLocal 83, initial := 4, ratio := 3 }, { slot := .previousLocal 82, initial := 4, ratio := 3 }, { slot := .previousLocal 81, initial := 6, ratio := 3 }, { slot := .previousLocal 80, initial := 4, ratio := 3 }, { slot := .previousLocal 79, initial := 2, ratio := 3 }, { slot := .previousLocal 78, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 8, ratio := 3 }, { slot := .previousLocal 84, initial := 4, ratio := 3 }, { slot := .previousLocal 83, initial := 4, ratio := 3 }, { slot := .previousLocal 82, initial := 12, ratio := 3 }, { slot := .previousLocal 81, initial := 4, ratio := 3 }, { slot := .previousLocal 80, initial := 2, ratio := 3 }, { slot := .previousLocal 79, initial := 2, ratio := 3 }, { slot := .previousLocal 78, initial := 6, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow05 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 445908668462176974 }], geometric := [{ slot := .externalA 0, initial := 1, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 3, ratio := 3 }, { slot := .externalA 3, initial := 1, ratio := 3 }, { slot := .previousLocal 85, initial := 4, ratio := 3 }, { slot := .previousLocal 84, initial := 4, ratio := 3 }, { slot := .previousLocal 83, initial := 12, ratio := 3 }, { slot := .previousLocal 82, initial := 8, ratio := 3 }, { slot := .previousLocal 81, initial := 2, ratio := 3 }, { slot := .previousLocal 80, initial := 2, ratio := 3 }, { slot := .previousLocal 79, initial := 6, ratio := 3 }, { slot := .previousLocal 78, initial := 4, ratio := 3 }, { slot := .previousLocal 85, initial := 8, ratio := 3 }, { slot := .previousLocal 84, initial := 24, ratio := 3 }, { slot := .previousLocal 83, initial := 16, ratio := 3 }, { slot := .previousLocal 82, initial := 8, ratio := 3 }, { slot := .previousLocal 81, initial := 4, ratio := 3 }, { slot := .previousLocal 80, initial := 12, ratio := 3 }, { slot := .previousLocal 79, initial := 8, ratio := 3 }, { slot := .previousLocal 78, initial := 4, ratio := 3 }, { slot := .previousLocal 85, initial := 36, ratio := 3 }, { slot := .previousLocal 84, initial := 24, ratio := 3 }, { slot := .previousLocal 83, initial := 12, ratio := 3 }, { slot := .previousLocal 82, initial := 12, ratio := 3 }, { slot := .previousLocal 81, initial := 18, ratio := 3 }, { slot := .previousLocal 80, initial := 12, ratio := 3 }, { slot := .previousLocal 79, initial := 6, ratio := 3 }, { slot := .previousLocal 78, initial := 6, ratio := 3 }, { slot := .previousLocal 85, initial := 8, ratio := 3 }, { slot := .previousLocal 84, initial := 4, ratio := 3 }, { slot := .previousLocal 83, initial := 4, ratio := 3 }, { slot := .previousLocal 82, initial := 12, ratio := 3 }, { slot := .previousLocal 81, initial := 4, ratio := 3 }, { slot := .previousLocal 80, initial := 2, ratio := 3 }, { slot := .previousLocal 79, initial := 2, ratio := 3 }, { slot := .previousLocal 78, initial := 6, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow06 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 1308472042479836079 }], geometric := [{ slot := .externalA 0, initial := 1, ratio := 3 }, { slot := .externalA 1, initial := 1, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }, { slot := .externalA 3, initial := 3, ratio := 3 }, { slot := .previousLocal 85, initial := 4, ratio := 3 }, { slot := .previousLocal 84, initial := 4, ratio := 3 }, { slot := .previousLocal 83, initial := 12, ratio := 3 }, { slot := .previousLocal 82, initial := 8, ratio := 3 }, { slot := .previousLocal 81, initial := 2, ratio := 3 }, { slot := .previousLocal 80, initial := 2, ratio := 3 }, { slot := .previousLocal 79, initial := 6, ratio := 3 }, { slot := .previousLocal 78, initial := 4, ratio := 3 }, { slot := .previousLocal 85, initial := 4, ratio := 3 }, { slot := .previousLocal 84, initial := 12, ratio := 3 }, { slot := .previousLocal 83, initial := 8, ratio := 3 }, { slot := .previousLocal 82, initial := 4, ratio := 3 }, { slot := .previousLocal 81, initial := 2, ratio := 3 }, { slot := .previousLocal 80, initial := 6, ratio := 3 }, { slot := .previousLocal 79, initial := 4, ratio := 3 }, { slot := .previousLocal 78, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 24, ratio := 3 }, { slot := .previousLocal 84, initial := 16, ratio := 3 }, { slot := .previousLocal 83, initial := 8, ratio := 3 }, { slot := .previousLocal 82, initial := 8, ratio := 3 }, { slot := .previousLocal 81, initial := 12, ratio := 3 }, { slot := .previousLocal 80, initial := 8, ratio := 3 }, { slot := .previousLocal 79, initial := 4, ratio := 3 }, { slot := .previousLocal 78, initial := 4, ratio := 3 }, { slot := .previousLocal 85, initial := 24, ratio := 3 }, { slot := .previousLocal 84, initial := 12, ratio := 3 }, { slot := .previousLocal 83, initial := 12, ratio := 3 }, { slot := .previousLocal 82, initial := 36, ratio := 3 }, { slot := .previousLocal 81, initial := 12, ratio := 3 }, { slot := .previousLocal 80, initial := 6, ratio := 3 }, { slot := .previousLocal 79, initial := 6, ratio := 3 }, { slot := .previousLocal 78, initial := 18, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow07 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 17465001500823438575 }], geometric := [{ slot := .externalA 0, initial := 3, ratio := 3 }, { slot := .externalA 1, initial := 1, ratio := 3 }, { slot := .externalA 2, initial := 1, ratio := 3 }, { slot := .externalA 3, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 12, ratio := 3 }, { slot := .previousLocal 84, initial := 12, ratio := 3 }, { slot := .previousLocal 83, initial := 36, ratio := 3 }, { slot := .previousLocal 82, initial := 24, ratio := 3 }, { slot := .previousLocal 81, initial := 6, ratio := 3 }, { slot := .previousLocal 80, initial := 6, ratio := 3 }, { slot := .previousLocal 79, initial := 18, ratio := 3 }, { slot := .previousLocal 78, initial := 12, ratio := 3 }, { slot := .previousLocal 85, initial := 4, ratio := 3 }, { slot := .previousLocal 84, initial := 12, ratio := 3 }, { slot := .previousLocal 83, initial := 8, ratio := 3 }, { slot := .previousLocal 82, initial := 4, ratio := 3 }, { slot := .previousLocal 81, initial := 2, ratio := 3 }, { slot := .previousLocal 80, initial := 6, ratio := 3 }, { slot := .previousLocal 79, initial := 4, ratio := 3 }, { slot := .previousLocal 78, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 12, ratio := 3 }, { slot := .previousLocal 84, initial := 8, ratio := 3 }, { slot := .previousLocal 83, initial := 4, ratio := 3 }, { slot := .previousLocal 82, initial := 4, ratio := 3 }, { slot := .previousLocal 81, initial := 6, ratio := 3 }, { slot := .previousLocal 80, initial := 4, ratio := 3 }, { slot := .previousLocal 79, initial := 2, ratio := 3 }, { slot := .previousLocal 78, initial := 2, ratio := 3 }, { slot := .previousLocal 85, initial := 16, ratio := 3 }, { slot := .previousLocal 84, initial := 8, ratio := 3 }, { slot := .previousLocal 83, initial := 8, ratio := 3 }, { slot := .previousLocal 82, initial := 24, ratio := 3 }, { slot := .previousLocal 81, initial := 8, ratio := 3 }, { slot := .previousLocal 80, initial := 4, ratio := 3 }, { slot := .previousLocal 79, initial := 4, ratio := 3 }, { slot := .previousLocal 78, initial := 12, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
