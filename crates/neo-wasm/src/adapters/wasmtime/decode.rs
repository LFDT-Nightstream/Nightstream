...
pub(crate) fn decode_opcode(operator: &wasmparser::Operator<'_>) -> Option<(WasmOpcode, Option<u32>)> {
    match operator {
        ...
        wasmparser::Operator::I64ExtendI32U => Some((WasmOpcode::I64ExtendI32U, None)),
        wasmparser::Operator::I64ExtendI32S => Some((WasmOpcode::I64ExtendI32S, None)),
        wasmparser::Operator::I32Extend8S => Some((WasmOpcode::I32Extend8S, None)),
        wasmparser::Operator::I32Extend16S => Some((WasmOpcode::I32Extend16S, None)),
        wasmparser::Operator::I64Extend8S => Some((WasmOpcode::I64Extend8S, None)),
        wasmparser::Operator::I64Extend16S => Some((WasmOpcode::I64Extend16S, None)),
        wasmparser::Operator::I64Extend32S => Some((WasmOpcode::I64Extend32S, None)),
        ...
        wasmparser::Operator::I64LtS => Some((WasmOpcode::I64LtS, None)),
        wasmparser::Operator::I64LtU => Some((WasmOpcode::I64LtU, None)),
        wasmparser::Operator::I64GtS => Some((WasmOpcode::I64GtS, None)),
        wasmparser::Operator::I64GtU => Some((WasmOpcode::I64GtU, None)),
        wasmparser::Operator::I64LeS => Some((WasmOpcode::I64LeS, None)),
        wasmparser::Operator::I64LeU => Some((WasmOpcode::I64LeU, None)),
        wasmparser::Operator::I64GeS => Some((WasmOpcode::I64GeS, None)),
        wasmparser::Operator::I64GeU => Some((WasmOpcode::I64GeU, None)),
        wasmparser::Operator::I64Shl => Some((WasmOpcode::I64Shl, None)),
        wasmparser::Operator::I64ShrS => Some((WasmOpcode::I64ShrS, None)),
        wasmparser::Operator::I64ShrU => Some((WasmOpcode::I64ShrU, None)),
        wasmparser::Operator::I64Rotl => Some((WasmOpcode::I64Rotl, None)),
        wasmparser::Operator::I64Rotr => Some((WasmOpcode::I64Rotr, None)),
        wasmparser::Operator::I64DivS => Some((WasmOpcode::I64DivS, None)),
        wasmparser::Operator::I64DivU => Some((WasmOpcode::I64DivU, None)),
        wasmparser::Operator::I64RemS => Some((WasmOpcode::I64RemS, None)),
        wasmparser::Operator::I64RemU => Some((WasmOpcode::I64RemU, None)),
        wasmparser::Operator::I64Clz => Some((WasmOpcode::I64Clz, None)),
        wasmparser::Operator::I64Ctz => Some((WasmOpcode::I64Ctz, None)),
        wasmparser::Operator::I64Popcnt => Some((WasmOpcode::I64Popcnt, None)),
