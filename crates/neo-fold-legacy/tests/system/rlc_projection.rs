...
use neo_fold_legacy::engine::r1cs_circuit::ring_action::{enforce_beta_ladder, projection_quotient};
use neo_fold_legacy::engine::r1cs_circuit::R1csBuilder;
use neo_fold_legacy::paper::reductions::pi_rlc_circuit::{
...
fn quotient_helper_rejects_malformed_inputs() {
    use neo_fold_legacy::paper::reductions::pi_rlc_circuit::Error;
...
use neo_fold_legacy::paper::f_prime::projection_trace::{
    encode_projection_identity, encode_projection_pair, encode_projection_shared,
};
use neo_fold_legacy::paper::relations::ajtai_rlc_mixer;
use neo_fold_legacy::paper::{nifs, pi_ccs, pi_rlc};
