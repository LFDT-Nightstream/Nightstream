...
use neo_fold_legacy::engine::r1cs_circuit::field_ext::{KLc, KVar};
...
fn engine_sumcheck_walk_matches_native_verify_sumcheck_rounds_poseidon_v3() {
    use neo_fold_legacy::engine::r1cs_circuit::{enforce_sumcheck_rounds_engine, TranscriptGadget};
...
fn chi_alpha_empty_returns_singleton_one() {
    use neo_fold_legacy::engine::r1cs_circuit::enforce_chi_alpha;
