...
matrix source. The packet starts at global logical row 3535753.
...
private theorem fullRow_val (row : Fin 1188) :
    (fullRow relation fits geometry row).val = 3535753 + row.val := by
...
theorem globalRow_val (row : Fin 1188) : (globalRow row).val = 3535753 + row.val := rfl
