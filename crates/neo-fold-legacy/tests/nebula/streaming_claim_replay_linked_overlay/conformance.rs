...
pub(super) fn canonical_poseidon_call(
    steps: &[neo_fold_legacy::frontends::r1cs_f_prime::SelectiveProjectedPoseidon2SboxStep],
    rows: &[&neo_fold_legacy::frontends::r1cs_f_prime::SelectiveProjectedRowArtifact],
    source_start: usize,
    final_start: usize,
