...
│                                                                          │
│     crates/neo-fold-prototype/src/rv32im/decider/                             │
└──────────────────────────────┬───────────────────────────────────────────┘
...
│                                                                          │
│     crates/neo-fold-prototype/src/rv32im/nivc/                                │
│     crates/neo-fold-prototype/src/rv32im/main_relation_spartan/f_prime.rs     │
└──────────────────────────────┬───────────────────────────────────────────┘
...
│                                                                          │
│     crates/neo-fold-prototype/src/rv32im/nifs/                                │
│         ├── pi_ccs.rs                                                    │
│         ├── pi_rlc.rs                                                    │
│         └── pi_dec.rs                                                    │
│                                                                          │
│     circuit mirror: crates/neo-fold-prototype/src/rv32im/main_relation_circuit│
└──────────────────────────────┬───────────────────────────────────────────┘
...
```
crates/neo-fold-prototype/src/rv32im/
│
