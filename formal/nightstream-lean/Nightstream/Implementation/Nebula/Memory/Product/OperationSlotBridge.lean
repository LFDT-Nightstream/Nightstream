...
import Nightstream.Implementation.Nebula.Memory.Operation.SlotRows
...
namespace Nightstream.Implementation.Nebula.OperationSlotProductBridge
  ...
  have addressScaled := address_scaled_eval canonical one holds timestampLimit
    (by
      ...
      norm_num [timestampLimit,
        Nightstream.Protocol.Nebula.timestampBits, goldilocksP] at *
      omega)
  have ramBound : timestampLimit * romCells *
      assignment layout.isRamColumn < goldilocksP := by
    rcases ramBinary with ram | ram <;>
      norm_num [ram, timestampLimit,
        Nightstream.Protocol.Nebula.timestampBits, romCells, goldilocksP]
...
end Nightstream.Implementation.Nebula.OperationSlotProductBridge
