...
namespace Nightstream.Implementation.Nebula.ProductionFullClaimCarrierLayoutFor
...
end Nightstream.Implementation.Nebula.ProductionFullClaimCarrierLayoutFor
