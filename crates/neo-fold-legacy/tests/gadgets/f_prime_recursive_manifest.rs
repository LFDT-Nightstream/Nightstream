...
use neo_fold_legacy::engine::r1cs_circuit::projection_identity_trace::validate_projection_identity_traces;
use neo_fold_legacy::engine::r1cs_circuit::ring_action::PROJECTION_QUOTIENT_LEN;
use neo_fold_legacy::engine::r1cs_circuit::{
...
use neo_fold_legacy::paper::construction2::RunningInstance;
use neo_fold_legacy::paper::digest::{
...
use neo_fold_legacy::paper::f_prime::r1cs::{
...
use neo_fold_legacy::paper::f_prime::source_image::{BitRange, FPrimeSourceImage, Word64Image};
use neo_fold_legacy::paper::nifs::circuit::{NifsVCircuitConfig, NifsVCircuitMessages};
use neo_fold_legacy::paper::nifs::NifsProof;
use neo_fold_legacy::paper::reductions::pi_ccs_circuit::{stage as pi_ccs_stage, PiCcsVerifierConfig};
use neo_fold_legacy::paper::reductions::pi_ccs_output_message::Profile as PiCcsOutputMessageProfile;
use neo_fold_legacy::paper::relations::{CcsClaim, CeClaim};
use neo_math::ring::D;
use neo_math::F;
...
const SOURCE_PATHS: &[&str] = &[
    ...
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/builder.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/field_ext.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/poseidon2.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/projection_identity_trace.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/ring_action.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/sumcheck.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/transcript.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/u64.rs",
    // PiRLC transcript challenge and rejection sampler.
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/alphabet_sampling/mod.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/alphabet_sampling/acceptance.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/alphabet_sampling/chunk.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/alphabet_sampling/digest_rounds.rs",
    "crates/neo-fold-legacy/src/engine/r1cs_circuit/alphabet_sampling/selection.rs",
    // F-prime and NIFS protocol composition.
    "crates/neo-fold-legacy/src/paper/f_prime/r1cs.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/mod.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/stage.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/mod.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/consistency.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/fold_wires.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/padding.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/projection/mod.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/projection/binding.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/projection/identities.rs",
    "crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/projection/shared.rs",
    // PiCCS constraint families.
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_circuit/mod.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_circuit/stage.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_circuit/digests.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_circuit/output_message.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_circuit/output_message/sis_ownership.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_circuit/verifier.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_circuit/verifier/padded_row.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_circuit/verifier_claims.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_ccs_output_message.rs",
    // Shared SIS, PiRLC algebra, and PiDEC constraint families.
    "crates/neo-fold-legacy/src/paper/reductions/accumulator_sis_circuit.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_rlc_circuit/mod.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_rlc_circuit/stage.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_rlc_circuit/commitment.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_rlc_circuit/consistency.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_rlc_circuit/padded_k.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_rlc_circuit/x.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_rlc_circuit/y_ring.rs",
    "crates/neo-fold-legacy/src/paper/reductions/pi_dec_circuit.rs",
    // Drift-gate implementation and Lean consumers.
    "crates/neo-fold-legacy/tests/gadgets/f_prime_recursive_manifest.rs",
...
fn pi_ccs_config(prep: &neo_fold_legacy::Preprocessing) -> PiCcsVerifierConfig<'_> {
    PiCcsVerifierConfig {
        params: prep.params(),
...
fn step_config(prep: &neo_fold_legacy::Preprocessing) -> FPrimeStepConfig<'_> {
    FPrimeStepConfig {
...
fn build_fixture() -> Fixture {
    ...
    let (running, _) = neo_fold_legacy::paper::nifs::prove(
    ...
    let (next_running, proof) = neo_fold_legacy::paper::nifs::prove(
        &mut transcript,
        prep.params(),
        prep.structure(),
        prep.optimized_cache(),
