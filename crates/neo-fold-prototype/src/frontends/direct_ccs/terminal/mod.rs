//! Owns the direct-CCS final-state F' circuit and committed proof.
//!
//! This layer builds and verifies the final Construction-2 step that binds
...
pub(crate) use prove::prove_direct_ccs_terminal_snark;
