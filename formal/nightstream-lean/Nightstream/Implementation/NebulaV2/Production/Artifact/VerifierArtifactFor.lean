...
import Nightstream.Implementation.NebulaV2.Production.FPrime.Base.ChallengeAuthorityRowsFor
...
namespace Nightstream.Implementation.NebulaV2.ProductionVerifierArtifactFor
...
structure Artifact (candidate : Id)
  ...
  verifierKeyIdentity :
    Nightstream.Protocol.NebulaV2.Soundness.VerifierKeyIdentity Digest.Value
...
end Nightstream.Implementation.NebulaV2.ProductionVerifierArtifactFor
