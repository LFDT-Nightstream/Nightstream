...
/-!
Executable evaluation-group certificate shard 5.
...
|---|---|---|
| evaluation shard 5 | every pair in this slice matches its independent target | checked |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk5
...
def pairs : List EvaluationPair :=
  (evaluationPairs.drop 35).take 7
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk5
