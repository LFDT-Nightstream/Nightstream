...
/-! Provenance: copied from `formal/nightstream-lean/Nightstream/SuperNeo/Folding/BatchArity.lean`
...
namespace NightstreamFPrime.Spec.Folding
...
end NightstreamFPrime.Spec.Folding
