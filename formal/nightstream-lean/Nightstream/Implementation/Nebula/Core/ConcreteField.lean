...
namespace Nightstream.Implementation.Nebula.ConcreteField
...
theorem encode_injective_below_goldilocks :
  ...
  have leftBound' : left < goldilocksP := by
    simpa [Nightstream.Protocol.Nebula.Fingerprint.goldilocksModulus,
...
end Nightstream.Implementation.Nebula.ConcreteField
