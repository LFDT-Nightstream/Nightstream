...
namespace Nightstream.Implementation.Nebula.ProductPiRlcTranscriptRows
...
theorem candidateFields_injective : Function.Injective candidateFields := by
  ...
  have flatEqual : left.flat = right.flat := by
    unfold candidateFields ProductPoseidon2.candidateFields
      Nightstream.Implementation.Transcript.Construction3Poseidon2.candidateFields
      at fieldsEqual
    ...
    have leftFlatDef :
        Nightstream.Implementation.Transcript.Construction3Poseidon2.candidateFlat
...
end Nightstream.Implementation.Nebula.ProductPiRlcTranscriptRows
