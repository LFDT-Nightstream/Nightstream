...
use neo_fold_prototype::circuit::superneo::witness::alloc_packed_mat_witness;
use neo_fold_prototype::circuit::superneo::witness_transition::{
...
fn rv32im_main_relation_witness_transition_accepts_rlc_and_dec() {
...
#[test]
#[ignore = "Spartan-path tests are parked until native NIFS and F' replacement lands"]
fn rv32im_main_relation_witness_transition_rejects_bad_split() {
    let mut parent = Mat::zero(D, 1, F::ZERO);
