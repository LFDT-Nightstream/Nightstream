...
Assurance tier: paper-independent model-level reduction algebra.
...
`DelayedCombinedNc.sumcheckPolynomial ... finalPoint.coordinates`, hence is computed
...
namespace Nightstream.SuperNeo.Folding.PiCCS.SplitNc.Verifier.Polynomial.Nc.BlockLane.DelayedCombinedNc.Acceptance
...
end Nightstream.SuperNeo.Folding.PiCCS.SplitNc.Verifier.Polynomial.Nc.BlockLane.DelayedCombinedNc.Acceptance
