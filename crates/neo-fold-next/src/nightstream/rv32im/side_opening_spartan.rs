...
use super::side_opening_relation::{
    ...
    verify_rv32im_side_opening_relation, Rv32imSideOpeningRelationStatement, Rv32imSideOpeningRelationWitness,
    Rv32imStage1SelectedRowsWitness, Rv32imStage2SelectedEventsWitness, Rv32imStage3SelectedContinuityWitness,
};
...
struct DebugStage1PackagedOpeningDigestCircuit {
    ...
    witness: crate::nightstream::rv32im::side_claim_relation::Rv32imSingleStepPackagedProofWitness,
}
...
fn compare_stage_packaged_opening_digest_delta(
    statement: &Rv32imSideOpeningRelationStatement,
    lhs_witness: &crate::nightstream::rv32im::side_claim_relation::Rv32imSingleStepPackagedProofWitness,
    rhs_witness: &crate::nightstream::rv32im::side_claim_relation::Rv32imSingleStepPackagedProofWitness,
) -> Result<Option<String>, SimpleKernelError> {
...
fn validate_side_opening_statement(statement: &Rv32imSideOpeningRelationStatement) -> Result<(), SimpleKernelError> {
    validate_rv32im_side_opening_relation_statement(statement)
}

fn rv32im_side_opening_shape_digest(
    statement: &Rv32imSideOpeningRelationStatement,
...
fn dummy_rv32im_side_opening_witness(
    statement: &Rv32imSideOpeningRelationStatement,
...
fn setup_rv32im_side_opening_witness(
    statement: &Rv32imSideOpeningRelationStatement,
    _: &Rv32imSideOpeningRelationWitness,
) -> Result<Rv32imSideOpeningRelationWitness, SimpleKernelError> {
...
fn setup_rv32im_side_opening_witness_without_packaged_final_main_claims(
    statement: &Rv32imSideOpeningRelationStatement,
    witness: &Rv32imSideOpeningRelationWitness,
) -> Result<Rv32imSideOpeningRelationWitness, SimpleKernelError> {
    let mut setup_witness = setup_rv32im_side_opening_witness(statement, witness)?;
...
fn dummy_single_step_packaged_witness(
    step: &PublicStep,
) -> super::side_claim_relation::Rv32imSingleStepPackagedProofWitness {
    super::side_claim_relation::Rv32imSingleStepPackagedProofWitness {
        step: step.clone(),
