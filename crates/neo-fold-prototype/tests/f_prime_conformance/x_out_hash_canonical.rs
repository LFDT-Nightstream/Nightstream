...
use neo_fold_prototype::rv32im::audit::evaluate_rv32im_main_recursion_f_prime_advice;
use neo_fold_prototype::rv32im::Rv32imMainRecursionConstruction2StateImage;
...
fn f_prime_x_out_depends_only_on_hn_paper_canonical_inputs() {
    ...
    for (step, advice) in advices.iter().enumerate() {
        ...
        let rebuilt = Rv32imMainRecursionConstruction2StateImage::from_parts(
