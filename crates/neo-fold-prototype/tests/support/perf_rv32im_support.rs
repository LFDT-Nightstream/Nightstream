...
use neo_fold_prototype::core::proof::{FoldSchedule, PackagedProof};
use neo_fold_prototype::rv32im::audit::audit_rv32im_public_proof_with_perf;
use neo_fold_prototype::rv32im::audit::build_rv32im_published_proof_seam_with_perf;
use neo_fold_prototype::rv32im::ccs::{rv32im_root_main_lane_ccs, RV32IM_ROOT_PUBLIC_INPUTS, RV32IM_ROOT_ROW_WIDTH};
use neo_fold_prototype::rv32im::final_relation::prove_rv32im_final_statement_from_accepted;
use neo_fold_prototype::rv32im::ivc::Rv32imIvcState;
use neo_fold_prototype::rv32im::layout::RV32_REGISTER_COUNT;
use neo_fold_prototype::rv32im::stage1::build_stage1_summary;
use neo_fold_prototype::rv32im::stage2::{build_stage2_summary, RamAccessKind, RegisterReadRole};
use neo_fold_prototype::rv32im::stage3::build_stage3_summary;
use neo_fold_prototype::rv32im::tables::Rv32FamilyTag;
use neo_fold_prototype::rv32im::kernel::{OpeningAccumulator, OpeningAccumulatorStats, OpeningPointLabel};
...
fn collect_unique_opcode_labels(build: &neo_fold_prototype::rv32im::builder::Rv32ProgramBuild) -> String {
...
fn exact_stage_perf_rows(
    output: &neo_fold_prototype::rv32im::SimpleKernelOutput,
...
fn opening_reuse_stats(output: &neo_fold_prototype::rv32im::SimpleKernelOutput) -> (OpeningAccumulatorStats, Vec<[u8; 32]>) {
...
fn print_root_main_lane_family(
    output: &neo_fold_prototype::rv32im::SimpleKernelOutput,
    proof: &neo_fold_prototype::rv32im::Rv32imProof,
) {
...
fn print_opening_reuse_proxy(output: &neo_fold_prototype::rv32im::SimpleKernelOutput) {
...
fn print_verify_breakdown(
    title: &str,
    perf: &neo_fold_prototype::rv32im::Rv32imPublicProofVerifyPerf,
    opcode_count: usize,
...
fn aggregate_family_rows(output: &neo_fold_prototype::rv32im::SimpleKernelOutput) -> [FamilyRowStats; FAMILY_ORDER.len()] {
