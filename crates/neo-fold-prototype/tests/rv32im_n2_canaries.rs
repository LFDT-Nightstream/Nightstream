...
use neo_fold_prototype::public_proof::rv32im::side_relation_circuit::{
...
use neo_fold_prototype::public_proof::rv32im::side_relation_spartan::debug_check_rv32im_side_binding_circuit;
...
use neo_fold_prototype::rv32im::kernel::FamilyEvalSchemaId;
...
const RV32IM_N2_SIDE_CONSTRAINT_BUDGET: usize = 2_048;
...
fn rv32im_side_relation_n2_debug_satisfiable() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build N=2 fixture");
...
fn rv32im_main_relation_n2_debug_satisfiable() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build N=2 fixture");
    debug_check_rv32im_ivc_recursion_snark_circuit(&fixture.final_statement, &fixture.final_proof)
...
fn rv32im_main_relation_n2_published_seam_debug_satisfiable() {
    ...
    let ((proof, seam), _perf) =
        prove_rv32im_public_proof_and_published_seam_with_perf(&input).expect("build N=2 published seam");
...
#[test]
#[ignore = "Spartan-path tests are parked until native NIFS and F' replacement lands"]
fn rv32im_phase0_transcript_parity_n2() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build N=2 fixture");
...
fn rv32im_main_relation_n2_surface_proportionality() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build N=2 fixture");
...
fn rv32im_side_relation_n2_public_boundary() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build N=2 fixture");
