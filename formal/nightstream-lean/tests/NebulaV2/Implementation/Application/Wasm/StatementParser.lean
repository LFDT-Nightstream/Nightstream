import Nightstream.Implementation.NebulaV2.Application.Wasm.StatementParser

set_option autoImplicit false

namespace tests.NebulaV2WasmStatementParser
...
end tests.NebulaV2WasmStatementParser
