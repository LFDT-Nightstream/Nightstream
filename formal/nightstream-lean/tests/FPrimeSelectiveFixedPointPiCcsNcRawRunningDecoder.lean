...
#check Exact.finalColumn_injective
#check Exact.sourceRecord_eq_recordAt
#check ArtifactRefinement.rawRunningAssignments_decodedData
#check ArtifactRefinement.sourceColumnRowsBind_decodedData
#check ArtifactRefinement.finalColumn_eq_rawRunningAssignment
...
#check ArtifactRefinement.finalColumn_uniqueOwner
#check Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.Production.decodedRunning_live_eq_finalColumn
