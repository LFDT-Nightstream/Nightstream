//! HyperNova Construction 2 in the current RV32IM specialization runs in the
...
use neo_fold_prototype::rv32im::{
    build_rv32im_main_recursion_construction2_default_fresh_instance, evaluate_rv32im_main_recursion_f_prime_advice,
};
...
fn f_prime_single_slot_accumulator_threads_monotonically() {
    ...
    let mut expected_u_i = build_rv32im_main_recursion_construction2_default_fresh_instance(
