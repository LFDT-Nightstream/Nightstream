...
use neo_fold_next::rv64im::audit::{
    ...
    rv64im_main_recursion_advice_tamper_bridge_binding_digest_first_byte,
    rv64im_main_recursion_advice_tamper_bridge_handoff_digest_first_byte,
    ...
    rv64im_main_recursion_advice_tamper_fresh_state_out_transcript_absorbed, rv64im_main_recursion_advice_tamper_pc_i,
    rv64im_main_recursion_advice_tamper_prepared_step_digest_first_byte,
...
fn rv64im_n2_chunk_step_relations() -> Vec<neo_fold_next::rv64im::Rv64imChunkStepIvcRelation> {
    rv64im_n2_support::build_rv64im_n2_chunk_step_relations().expect("build rv64im n=2 chunk-step relations")
}

fn rv64im_n2_f_prime_advices() -> Vec<neo_fold_next::rv64im::Rv64imMainRecursionFPrimeAdvice> {
    rv64im_n2_support::build_rv64im_n2_f_prime_advices().expect("build rv64im n=2 F' advices")
}

fn rv64im_rows_per_chunk_one_n2_fixture() -> rv64im_n2_support::Rv64imRowsPerChunkOneN2Fixture {
    rv64im_n2_support::build_rv64im_rows_per_chunk_one_n2_fixture().expect("build rv64im RowsPerChunk(1) n=2 fixture")
}

fn rv64im_rows_per_chunk_one_n2_chunk_step_relations() -> Vec<neo_fold_next::rv64im::Rv64imChunkStepIvcRelation> {
    rv64im_n2_support::build_rv64im_rows_per_chunk_one_n2_chunk_step_relations()
        .expect("build rv64im RowsPerChunk(1) n=2 chunk-step relations")
}

fn rv64im_rows_per_chunk_one_n2_f_prime_advices() -> Vec<neo_fold_next::rv64im::Rv64imMainRecursionFPrimeAdvice> {
    rv64im_n2_support::build_rv64im_rows_per_chunk_one_n2_f_prime_advices()
...
fn main_recursion_step_test_guard() -> MutexGuard<'static, ()> {
    ...
    GUARD
        ...
        .lock()
        .expect("rv64im main recursion step test guard poisoned")
}

#[test]
fn rv64im_main_recursion_step_chain_round_trip() {
    let _guard = main_recursion_step_test_guard();
    let f_prime_advices = rv64im_n2_f_prime_advices();
...
fn rv64im_main_recursion_single_step_builder_rejects_multi_step_chunk_relations() {
    let _guard = main_recursion_step_test_guard();
    let err = build_rv64im_main_recursion_f_prime_advices_single_step(&rv64im_n2_chunk_step_relations())
...
fn rv64im_main_recursion_single_step_builder_accepts_rows_per_chunk_one() {
    let _guard = main_recursion_step_test_guard();
    let fixture = rv64im_rows_per_chunk_one_n2_fixture();
    let f_prime_advices = rv64im_rows_per_chunk_one_n2_f_prime_advices();
...
#[test]
fn rv64im_main_recursion_construction2_shape_builder_accepts_multi_step_whole_trace_advice() {
    let _guard = main_recursion_step_test_guard();
    let advices = rv64im_n2_f_prime_advices();
...
fn rv64im_main_recursion_construction2_shape_builder_accepts_single_step_advices() {
    let _guard = main_recursion_step_test_guard();
    let advices = rv64im_rows_per_chunk_one_n2_f_prime_advices();
...
#[test]
fn rv64im_main_recursion_advice_builder_rejects_tampered_legacy_relation_chunk_summary_shell() {
    let _guard = main_recursion_step_test_guard();
    let fixture = rv64im_n2_support::build_rv64im_n2_fixture().expect("build rv64im n=2 fixture");
    let chunk_step_relations = build_rv64im_chunk_step_ivc_relations(&fixture.final_statement, &fixture.final_proof)
        .expect("build chunk-step chain");
    ...
    let err = build_rv64im_main_recursion_f_prime_advices(&tampered_relations).expect_err(
    ...
    let rebuilt_step = evaluate_rv64im_main_recursion_f_prime_advice(&baseline_advices[0])
        .expect("evaluate baseline native F' advice");
...
#[test]
fn rv64im_main_recursion_construction2_shape_builder_rejects_tampered_legacy_fresh_state_out_transcript_absorbed() {
    let _guard = main_recursion_step_test_guard();
    ...
    let err = build_rv64im_main_recursion_construction2_f_prime_ccs_shape(&tampered_advices).expect_err(
    ...
    let rebuilt = build_rv64im_main_recursion_construction2_f_prime_ccs_shape(&f_prime_advices)
...
fn rv64im_main_recursion_construction2_fresh_instance_builder_builds_base_case_u1() {
    ...
    let expected_u_perp = build_rv64im_main_recursion_construction2_default_fresh_instance(
...
#[test]
fn rv64im_main_recursion_step_rejects_tampered_legacy_fresh_state_out_terminal_handle() {
    let _guard = main_recursion_step_test_guard();
    let fixture = rv64im_n2_support::build_rv64im_n2_fixture().expect("build rv64im n=2 fixture");
    let chunk_step_relations = build_rv64im_chunk_step_ivc_relations(&fixture.final_statement, &fixture.final_proof)
        .expect("build chunk-step chain");
    ...
    let err = evaluate_rv64im_main_recursion_f_prime_advice(&tampered)
    ...
    assert_eq!(
        evaluate_rv64im_main_recursion_f_prime_advice(&f_prime_advices[0])
...
fn rv64im_main_recursion_construction2_bridge_ignores_tampered_legacy_prepared_step_digest_vector() {
    ...
    let mut tampered = f_prime_advices[0].clone();
    rv64im_main_recursion_advice_tamper_prepared_step_digest_first_byte(&mut tampered);
...
#[test]
fn rv64im_main_recursion_step_spartan_rejects_synthetic_chunk_position_retag() {
    let _guard = main_recursion_step_test_guard();
    let source = build_mixed_opcode_perf_source_case(2);
    let input = Rv64imProofInput {
        max_steps: source.program_words.len(),
    ...
    let err = audit_rv64im_main_recursion_step_spartan_fixed_shape_at_chunk_positions(
...
fn rv64im_main_recursion_step_ignores_tampered_legacy_bridge_handoff_digest_field() {
    ...
    let mut tampered_advice = f_prime_advices[0].clone();
    rv64im_main_recursion_advice_tamper_bridge_handoff_digest_first_byte(&mut tampered_advice);
...
fn rv64im_main_recursion_step_ignores_tampered_legacy_bridge_binding_digest_field() {
    ...
    let baseline =
        evaluate_rv64im_main_recursion_f_prime_advice(&f_prime_advices[0]).expect("evaluate baseline native F' step");
    let mut tampered_advice = f_prime_advices[0].clone();
    rv64im_main_recursion_advice_tamper_bridge_binding_digest_first_byte(&mut tampered_advice);
...
fn rv64im_main_recursion_step_rejects_tampered_pi_ccs_replay() {
    ...
    let public_output =
        build_rv64im_main_recursion_f_prime_public_output(&f_prime_advices[0]).expect("build native F' public output");
    let mut tampered_advice = f_prime_advices[0].clone();
    rv64im_main_recursion_advice_tamper_authoritative_ccs_replay_first_round_coeff(&mut tampered_advice);
