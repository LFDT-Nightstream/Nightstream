...
namespace Nightstream.Implementation.Nebula.ProductionPaperCompactChainLifetimeFor

open Nightstream.Implementation.Nebula
open Nightstream.Implementation.R1CS
open Nightstream.Protocol.Nebula
open Nightstream.Protocol.Nebula.CommitmentBundle
open Nightstream.Protocol.Nebula.ExactDelayedSchedule
...
theorem LifetimeExtraction.precommitChain
    ...
    exists allBatches,
      ...
      allBatches = lifetime.rowDelayed.batches := by
  rcases
      Nightstream.Implementation.Nebula.ProductionPaperCompactChainLifetimeFor.SemanticLifetime.LifetimeExtraction.compactChain
        lifetime with
...
end Nightstream.Implementation.Nebula.ProductionPaperCompactChainLifetimeFor
