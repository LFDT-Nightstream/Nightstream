//! Native latest-step F' advice and evaluator output.
//!
//! This is the trusted Rust-side view of the latest direct-CCS transition that
//! later source/R1CS layers must encode. It is not proof authority by itself.
...
use super::source::DirectCcsFPrimeLowNormSourceImage;
