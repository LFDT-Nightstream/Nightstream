...
use self::authoritative_side::build_rv32im_side_opening_public;
...
use self::side_bridges::Rv32imSideProofBundle;
use self::side_bridges::{
    ...
    build_rv32im_verified_side_claims_from_accepted_artifact_fast, validate_rv32im_side_proof_bundle_structure,
};
use self::side_opening_relation::{
    ...
    Rv32imSideOpeningRelationStatement,
};
...
use self::side_runtime_binding::verify_rv32im_side_opening_statement_against_runtime_surfaces;
...
pub mod audit {
    ...
    use crate::rv32im::final_relation::{Rv32imFinalBuildProof, Rv32imFinalStatement};
    ...
    pub use super::side_relation_spartan::{
        ...
        prove_rv32im_side_binding, setup_rv32im_side_binding, setup_rv32im_side_binding_cached,
        verify_rv32im_side_binding, Rv32imSideBindingProverKey, Rv32imSideBindingVerifierKey,
    };
    ...
    pub fn build_rv32im_side_proof_bundle_from_accepted_artifact(
        ...
        super::build_rv32im_side_proof_bundle_from_accepted_artifact(artifact)
    }
    ...
    pub fn verify_rv32im_side_proof_bundle_from_accepted_artifact(
        ...
        super::verify_rv32im_side_proof_bundle_from_accepted_artifact(artifact, bundle)
    }

    pub fn build_rv32im_stage_claim_bundle_from_side_proof_bundle(
        bundle: &Rv32imSideProofBundle,
        execution_digest: [u8; 32],
    ) -> Result<crate::rv32im::kernel::SimpleKernelStageClaimBundle, SimpleKernelError> {
        super::build_rv32im_stage_claim_bundle_from_side_proof_bundle(bundle, execution_digest)
    }

    pub fn build_rv32im_kernel_opening_claim_from_side_proof_bundle(
        bundle: &Rv32imSideProofBundle,
        public_statement: &Rv32imProofStatement,
    ) -> Result<crate::rv32im::kernel::SimpleKernelOpeningClaim, SimpleKernelError> {
        super::build_rv32im_kernel_opening_claim_from_side_proof_bundle(bundle, public_statement)
    }
    ...
    pub fn build_rv32im_bound_side_proof_bundle_from_accepted_artifact(
        ...
        super::bind_rv32im_side_proof_bundle_to_statement_core(
            &super::build_rv32im_side_proof_bundle_from_accepted_artifact(artifact)?,
    ...
    pub fn build_rv32im_nightstream_statement_from_final(
        ...
        super::build_rv32im_nightstream_statement_from_final(
            public_io_digest,
    ...
    pub fn build_rv32im_nightstream_statement_from_published_statement(
        ...
        super::build_rv32im_nightstream_statement_from_published_statement(
            verifier_context_digest,
            published_statement,
            proof_binding_root,
        )
    ...
    pub fn rv32im_main_nightstream_proof_digest(main_proof: &super::Rv32imCompressedMainProof) -> [u8; 32] {
        super::rv32im_main_nightstream_proof_digest(main_proof)
    }
    ...
    pub fn build_rv32im_bound_phase0_claim_witnesses_from_accepted_artifact(
        ...
        let side_bundle = super::bind_rv32im_side_proof_bundle_to_statement_core(
            &super::build_rv32im_side_proof_bundle_from_accepted_artifact(artifact)?,
            statement.core_digest(),
        )?;
        Ok(
...
use crate::rv32im::kernel::{
    build_public_kernel_opening_claim_from_compact_surfaces, build_rv32im_kernel_export_proof_from_accepted_artifact,
    build_rv32im_opening_convergence_artifact_from_phase0_bundle_and_witnesses_trusted_local_with_perf,
    kernel_claim_bundle_from_statement_and_compact_surfaces, Rv32imAcceptedProofArtifact, Rv32imKernelExportProof,
    Rv32imProof, Rv32imProofStatement, Rv32imStageClaimDigestBundle, SimpleKernelError, SimpleKernelOpeningClaim,
...
fn rv32im_main_nightstream_proof_digest(main_proof: &Rv32imCompressedMainProof) -> [u8; 32] {
...
fn build_rv32im_side_proof_bundle_from_accepted_artifact_and_kernel_export(
    artifact: &Rv32imAcceptedProofArtifact,
...
fn build_rv32im_side_proof_bundle_from_accepted_artifact(
    artifact: &Rv32imAcceptedProofArtifact,
) -> Result<Rv32imSideProofBundle, SimpleKernelError> {
...
fn verify_rv32im_side_proof_bundle_from_accepted_artifact(
    artifact: &Rv32imAcceptedProofArtifact,
    bundle: &Rv32imSideProofBundle,
) -> Result<(), SimpleKernelError> {
    if bundle.digest != bundle.expected_digest() {
...
fn build_rv32im_stage_claim_bundle_from_side_proof_bundle(
    bundle: &Rv32imSideProofBundle,
    execution_digest: [u8; 32],
...
fn build_rv32im_kernel_opening_claim_from_side_proof_bundle(
    side_bundle: &Rv32imSideProofBundle,
    public_statement: &Rv32imProofStatement,
...
fn build_rv32im_nightstream_statement_from_final(
    public_io_digest: [u8; 32],
    verifier_context_digest: [u8; 32],
    statement: &Rv32imFinalStatement,
    proof: &Rv32imFinalBuildProof,
...
fn build_rv32im_nightstream_statement_from_published_statement(
    verifier_context_digest: [u8; 32],
    published_statement: &Rv32imPublishedStatement,
    proof_binding_root: [u8; 32],
) -> Result<NightstreamStatement, SimpleKernelError> {
...
fn build_rv32im_side_proof_from_bundle(
    nightstream_statement: &NightstreamStatement,
    side_bundle: &Rv32imSideProofBundle,
...
pub fn build_rv32im_nightstream_from_public_proof(
    proof: &Rv32imProof,
) -> Result<(NightstreamStatement, Rv32imNightstreamProof), SimpleKernelError> {
    build_rv32im_nightstream_from_public_proof_with_perf(proof).map(|(built, _)| built)
}

fn verify_rv32im_nightstream_carried_boundary(
    statement: &NightstreamStatement,
...
pub fn verify_rv32im_nightstream(
    statement: &NightstreamStatement,
    proof: &Rv32imNightstreamProof,
