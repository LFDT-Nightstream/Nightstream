...
namespace Nightstream.Implementation.NebulaV2.ProductPiCcsTranscriptGeometryFor
...
theorem statementFields_length
    ...
    (termCount : input.constraintPolynomial.terms.length = 66) :
    (statementFields input).length = 22234 + 2 * rowVariables := by
...
def statementControl (rowVariables : Nat) : SymbolicDuplexCount.Control :=
  SymbolicDuplexCount.absorbManyFast (22234 + 2 * rowVariables)
...
theorem occurrence_rows_length
    ...
    (degreeSum : KSparsePolynomial.totalDegreeSum
      input.constraintPolynomial.terms = 280) :
  ...
  have terminalDegree :
      KSparsePolynomial.totalDegreeSum
        (KPiCcsOccurrence.terminalInput
          (occurrenceInput input)).constraintPolynomial.terms = 280 := by
...
theorem rowCount_25 : rowCount 25 = 12112800 := by decide

theorem rowCount_26 : rowCount 26 = 12127977 := by decide

theorem exponent_26_adds_15177_rows :
    rowCount 26 = rowCount 25 + 15177 := by decide

end Nightstream.Implementation.NebulaV2.ProductPiCcsTranscriptGeometryFor
