use neo_fold_next::rv64im::audit::{
    ...
    rv64im_main_recursion_advice_tamper_folded_accumulator_input_digest_first_byte,
};
...
fn f_prime_recomputes_folded_accumulator_input_digest_from_state_in() {
    ...
    evaluate_rv64im_main_recursion_f_prime_advice(advice).expect("baseline F' advice must evaluate");

    let mut tampered = advice.clone();
    rv64im_main_recursion_advice_tamper_folded_accumulator_input_digest_first_byte(&mut tampered);
