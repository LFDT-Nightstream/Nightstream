...
use neo_ccs::Mat;
use neo_closure_proof::prove_explicit_obligation_closure_v1;
...
#[test]
fn bridge_proof_v2_explicit_closure_roundtrip_and_tamper() {
    let n = 16usize;
    ...
    let closure = prove_explicit_obligation_closure_v1(
        &closure_stmt,
        &params,
        &outputs.obligations,
    ...
    // Tamper the closure witness: Spartan proof still verifies, but closure must fail.
    ...
    let bad_closure = prove_explicit_obligation_closure_v1(
    ...
    .expect("prove explicit closure (bad witness)");
