...
fn wasm_frontend_scaffold_runs_through_clean_lifecycle() {
    ...
    let steps = vec![
        WasmStepTrace {
            ...
            stack_read2: None,
            stack_read2_hi: None,
            stack_write0: Some(StackLaneAccess { addr: 0, value: 7 }),
        ...
        WasmStepTrace {
            ...
            stack_read2: None,
            stack_read2_hi: None,
            stack_write0: Some(StackLaneAccess { addr: 2, value: 9 }),
            stack_write0_hi: None,
            linear_memory: None,
            linear_memory_offset: 0,
            memory_pages_before: None,
        ...
        WasmStepTrace {
            ...
            stack_read0_hi: None,
            stack_read1: Some(StackLaneAccess { addr: 2, value: 9 }),
            stack_read1_hi: None,
            stack_read2: None,
            stack_read2_hi: None,
            stack_write0: Some(StackLaneAccess { addr: 0, value: 16 }),
            stack_write0_hi: None,
            linear_memory: None,
            linear_memory_offset: 0,
            memory_pages_before: None,
