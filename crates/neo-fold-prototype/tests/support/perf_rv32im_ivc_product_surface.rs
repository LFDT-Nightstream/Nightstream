use neo_fold_prototype::rv32im::prove_rv32im_accepted_proof_with_options;
...
fn print_ivc_compressed_artifact_sizes(snark: &neo_fold_prototype::rv32im::Rv32imIvcSnark) {
...
struct IvcProductSurfaceFixture {
    relations: Vec<neo_fold_prototype::rv32im::Rv32imChunkStepIvcRelation>,
}
...
fn build_ivc_product_surface_state_from_relations(
    ...
    relations: &[neo_fold_prototype::rv32im::Rv32imChunkStepIvcRelation],
) -> Rv32imIvcState {
    assert!(
        !relations.is_empty(),
        "IVC product-surface fixture must expose at least one relation"
