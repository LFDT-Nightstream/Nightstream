//! Projection trace primitives, image regions, and semantic rows.

#[path = "../support/mod.rs"]
mod support;

use neo_fold_legacy::frontends::f_prime::image::{FPrimeImage, FPrimeImageLayout};
...
fn projection_rows_accept_honest_fill_and_reject_tampers() {
    use neo_fold_legacy::frontends::f_prime::image::{FPrimeImage, FPrimeImageConfig};
    use neo_fold_legacy::frontends::f_prime::structure::build_f_prime_structure;
