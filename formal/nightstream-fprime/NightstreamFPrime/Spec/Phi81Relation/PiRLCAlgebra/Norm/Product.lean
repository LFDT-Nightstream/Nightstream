...
/-! Provenance: copied from `formal/nightstream-lean/Nightstream/SuperNeo/Concrete/Phi81Relation/PiRLCAlgebra/Norm/Product.lean`
...
namespace NightstreamFPrime.Spec.Phi81Relation.PiRLCAlgebra.Norm.Product
