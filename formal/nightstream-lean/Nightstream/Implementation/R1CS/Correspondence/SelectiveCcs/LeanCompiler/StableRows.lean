...
namespace Nightstream.Implementation.R1CS.SelectiveCcs.LeanCompiler.StableRows
...
end Nightstream.Implementation.R1CS.SelectiveCcs.LeanCompiler.StableRows
