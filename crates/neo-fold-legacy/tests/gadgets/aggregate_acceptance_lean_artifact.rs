...
use neo_fold_legacy::engine::r1cs_circuit::{R1csBuilder, TranscriptGadget, Var};
use neo_fold_legacy::frontends::f_prime::gadget_native::{encode_r1cs_gadget_native, GadgetNativeCoordinateGateRoles};
use neo_math::F;
