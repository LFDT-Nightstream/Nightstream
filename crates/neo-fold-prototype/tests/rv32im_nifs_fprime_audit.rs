...
fn expect_tamper_failure<F>(
    label: &str,
    baseline_output: &neo_fold_prototype::rv32im::Rv32imMainRecursionFPrimePublicOutput,
...
fn assert_statement_matches_native_f_prime(
    step_index: usize,
    backend_relation: &Rv32imMainRecursionFPrimeBackendRelation,
    native_output: &neo_fold_prototype::rv32im::Rv32imMainRecursionFPrimeStepImage,
) {
    assert_eq!(
