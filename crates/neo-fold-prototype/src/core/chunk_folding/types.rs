...
pub(crate) struct SuperNeoChunkStep {
    pub(crate) replay_witness: ChunkReplayWitness,
    pub(crate) relation_result: ChunkRelationResult,
    pub(crate) fold_digest: [u8; 32],
    pub(crate) perf: crate::proof::ChunkProvePerf,
}
