...
use neo_fold_prototype::circuit::superneo::initial_sum::claimed_initial_sum_from_me_inputs;
...
fn synthetic_claims() -> Vec<neo_ccs::CeClaim<neo_ajtai::Commitment, GoldilocksF, NeoK>> {
    vec![
        neo_fold_prototype::circuit::superneo::terminal_identity::dummy_claim(
...
fn rv32im_main_relation_initial_sum_matches_native_formula() {
