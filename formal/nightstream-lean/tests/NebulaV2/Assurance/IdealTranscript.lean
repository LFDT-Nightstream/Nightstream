...
namespace Nightstream.Tests.NebulaV2IdealTranscript
...
example {Digest ChallengeField : Type}
    ...
    (frame : Frame Digest) :
    Nightstream.Assurance.NebulaV2.FingerprintSecurity.repeatedPoint
...
end Nightstream.Tests.NebulaV2IdealTranscript
