...
import Nightstream.Implementation.Nebula.Commitment.Compact.CheckedStepChainRows
import Nightstream.Implementation.Nebula.Commitment.Compact.ChainHeaderRows
...
namespace Nightstream.Implementation.Nebula.TerminalManifestSchema
...
structure Artifact
    ...
    (fullShape operationsShape snapshotShape : Shape) where
  profile : Nightstream.Protocol.Nebula.Profile.Identity
  profileExact : profile = Nightstream.Protocol.Nebula.Profile.v2
  ...
  verifierKeyDigest : Nightstream.Protocol.Nebula.Digest.Value
  relationManifestDigest : Nightstream.Protocol.Nebula.Digest.Value
  terminalManifestDigest : Nightstream.Protocol.Nebula.Digest.Value
...
theorem Artifact.bundleForwarding_rows_length
    ...
    (artifact.partRows .bundleForwarding).length =
      Nightstream.Protocol.Nebula.MemoryWireGeometry.mandatoryBundleBits :=
...
theorem Artifact.knownNumericRows_lower_bound
  ...
  rw [Nightstream.Protocol.Nebula.MemoryWireGeometry.mandatoryBundleBits_exact]
    at bundle
...
end Nightstream.Implementation.Nebula.TerminalManifestSchema
