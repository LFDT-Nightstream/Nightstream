...
use neo_fold_legacy::engine::r1cs_circuit::builder::{
...
use neo_fold_legacy::engine::r1cs_circuit::{Lc, R1csBuilder, R1csSnapshot, Var};
use neo_fold_legacy::frontends::r1cs_f_prime::terminal_r1cs::STREAMING_TERMINAL_R1CS_FAMILY_NAMES;
use neo_fold_legacy::paper::construction2::nebula_lane::NEBULA_GAMMA_TRANSCRIPT_LABEL;
...
use neo_fold_legacy::paper::relations::product_commitment_circuit::{AdvCommitmentDataWires, CommitmentDataWires};
use neo_math::F;
...
fn recover_leaf_block(
    source: &R1csSnapshot,
    block: SeededPhi81LinearBlock,
    openings: &[neo_fold_legacy::engine::r1cs_circuit::BalancedTernaryOpeningTraceEntry],
