...
impl DirectCcsFPrimeLowNormSourceR1csSummary {
    fn from_shape(shape: Option<DirectCcsFPrimeLowNormSourceR1csShape>) -> Self {
        ...
        Self {
            ...
            private_bits: shape.source_len,
            counter_carry_bits: shape.counter_carry_bits,
            shell_constraints: shape.shell_constraints(),
            bit_constraints: shape.bit_constraints,
            x_out_link_constraints: shape.x_out_link_constraints,
            construction2_boundary_link_constraints: shape.construction2_boundary_link_constraints,
            construction2_instance_digest_link_constraints: shape.construction2_instance_digest_link_constraints,
            construction2_commitment_shape_constraints: shape.construction2_commitment_shape_constraints,
            structural_counter_constraints: shape.structural_counter_constraints,
            structural_fixed_arity_constraints: shape.structural_fixed_arity_constraints,
            structural_counter_carry_bit_constraints: shape.structural_counter_carry_bit_constraints,
            canonical_field_lane_constraints: shape.canonical_field_lane_constraints,
            canonical_field_lane_aux_bits: shape.canonical_field_lane_aux_bits,
            poseidon_digest_recomputation_constraints: shape.poseidon_digest_recomputation_constraints,
            nifs_v_verifier_constraints: shape.nifs_v_verifier_constraints,
...
impl DirectCcsFPrimeVerifierNifsSummary {
    fn from_shape(shape: Option<&DirectCcsFPrimeVerifierBodyShape>) -> Self {
        Self {
            ...
            chunk_meta_constraints: shape.map_or(0, |shape| shape.nifs_chunk_meta_constraints),
            pi_ccs_constraints: shape.map_or(0, |shape| shape.nifs_pi_ccs_constraints),
            pi_rlc_constraints: shape.map_or(0, |shape| shape.nifs_pi_rlc_constraints),
            pi_dec_constraints: shape.map_or(0, |shape| shape.nifs_pi_dec_constraints),
        }
    }
}
