...
theorem emittedConstraints_varsSatisfy
  ...
  have sumcheckLocal : ∀ index,
    ...
    · norm_num [PiCCSArithmetic.sumcheckLogicalStart, PiCCSStarts.sumcheckLogicalStart,
        PiCCSArithmetic.initialClaimLogicalStart]
    · rw [PiCCSStarts.outputBindingWitnessStart_eq]
      norm_num [PiCCSArithmetic.sumcheckLogicalStart, PiCCSStarts.sumcheckLogicalStart,
        PiCCSStarts.initialClaimLogicalStart, PiCCSStarts.roundTranscriptWitnessStart_eq]
