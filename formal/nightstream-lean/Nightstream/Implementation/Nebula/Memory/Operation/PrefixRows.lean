import Nightstream.Implementation.Nebula.Memory.Product.OperationSlotBridge
import Nightstream.Implementation.Nebula.Memory.Product.ClaimBridge
...
namespace Nightstream.Implementation.Nebula.OperationPrefixRows
...
open Nightstream.Implementation.Nebula.OperationSlotProductBridge
open Nightstream.Implementation.Nebula.OperationSlotRows
...
open Nightstream.Protocol.Nebula.OperationSlot
    ...
    (fun slot : Fin operationSlots =>
      BoundedWordRows.rows (layout.writeTimestampWord slot)) (fun slot => by
        simpa [Layout.writeTimestampWord,
          Nightstream.Protocol.Nebula.timestampBits] using
...
private theorem write_timestamp_rule
  ...
  have timestampBound : claim.timestampIn <
      2 ^ Nightstream.Protocol.Nebula.timestampBits :=
    parsed.canonical.timestampIn
  have timestampColumnBound : assignment
      (layout.product.claim.counterValueColumn .timestampIn) <
      2 ^ Nightstream.Protocol.Nebula.timestampBits := by
    rw [timestampPlaced]
...
end Nightstream.Implementation.Nebula.OperationPrefixRows
