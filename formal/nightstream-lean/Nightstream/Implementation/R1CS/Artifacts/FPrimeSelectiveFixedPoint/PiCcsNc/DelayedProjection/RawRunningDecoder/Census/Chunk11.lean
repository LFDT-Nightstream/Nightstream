...
/-!
Executable certificate for generated raw-running decoder shard 11.
...
Owns: the exact executable certificate for generated shard 11, containing
...
|---|---|---|
| `nifs.pi_ccs.nc.delayed.raw_decoder.artifact.census.chunk11` | check exactly one 252-record decoder shard | checked artifact |
-/

namespace Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder.Census.Chunk11

open Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder

theorem exact : ExactChunk ⟨11, by decide⟩
    Generated.Chunk11.schemaVersion
    Generated.Chunk11.sourceArm
    Generated.Chunk11.childCount
    Generated.Chunk11.logicalColumnCount
    Generated.Chunk11.finalColumnCount
    Generated.Chunk11.allocationRecords := by
  unfold ExactChunk ExactRecords
  native_decide

end Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder.Census.Chunk11
