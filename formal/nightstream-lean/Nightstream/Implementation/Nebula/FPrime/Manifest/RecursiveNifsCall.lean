...
namespace Nightstream.Implementation.Nebula.RecursiveManifestNifsCall
  ...
  let global : Fin widths.totalBits :=
    ⟨Section.memory.bitOffset widths + index, by
      ...
      have memoryWidth : Section.memory.width widths =
          Nightstream.Protocol.Nebula.MemoryWireGeometry.stepPublicBits := rfl
...
end Nightstream.Implementation.Nebula.RecursiveManifestNifsCall
