import Nightstream.Implementation.NebulaV2.Application.Wasm.StatementBytes
...
namespace Nightstream.Implementation.NebulaV2.WasmStatementParser
...
theorem encoded_section_has_no_padding_alias
    ...
    {leftStatement rightStatement :
      Nightstream.Protocol.NebulaV2.WasmStatement.ProductionStatement Program}
...
theorem encoded_section_has_no_padding_aliasFor
    ...
    {leftStatement rightStatement :
      Nightstream.Protocol.NebulaV2.WasmStatement.ProductionStatement Program}
    {expectedProfile : Nightstream.Protocol.NebulaV2.Profile.Identity}
...
end Nightstream.Implementation.NebulaV2.WasmStatementParser
