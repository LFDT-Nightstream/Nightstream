...
use neo_fold_legacy::engine::ccs_native::poseidon2::{
    POSEIDON2_DIGEST_LEN, POSEIDON2_GOLDILOCKS_BITS, POSEIDON2_WIDTH,
};
...
use neo_fold_legacy::paper::f_prime::poseidon_trace::{encode_poseidon_trace, PoseidonTraceImage};
