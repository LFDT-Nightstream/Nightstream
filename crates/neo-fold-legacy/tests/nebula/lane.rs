...
use neo_fold_legacy::paper::construction2::{NebulaConfig, NebulaError, NebulaLane, NebulaStepX, StackShape};
use neo_fold_legacy::paper::digest;
use neo_fold_legacy::paper::f_prime::nebula_lane_circuit::delayed_nebula_public_suffix_len;
use neo_fold_legacy::paper::f_prime::r1cs::{FPrimePublicInputLayout, F_PRIME_PUBLIC_INPUT_LEN};
use neo_fold_legacy::paper::relations::{CcsClaim, LaneRanges, LaneScheme};
use neo_math::{D, F, K};
...
fn claim_x_requires_canonical_zero_ring_completion() {
    ...
    assert!(matches!(
        ...
        Err(neo_fold_legacy::paper::construction2::NebulaXError::NonZeroCompletion(index))
