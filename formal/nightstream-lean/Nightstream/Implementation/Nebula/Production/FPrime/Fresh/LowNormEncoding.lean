...
namespace Nightstream.Implementation.Nebula.ProductionFreshLowNormEncoding
...
theorem protocolTrit_eq_compilerTrit
  ...
  rw [CompactCommit.tritAt,
    Nightstream.Protocol.Nebula.ShiftedTernary41V1.trits_get]
  rfl
...
end Nightstream.Implementation.Nebula.ProductionFreshLowNormEncoding
