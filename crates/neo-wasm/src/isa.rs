...
impl WasmOpcode {
    ...
    pub fn selector_index(self) -> Option<usize> {
        match self {
            ...
            Self::I64Load8U => Some(79),
            Self::I64Load16U => Some(80),
            Self::I64Load32U => Some(81),
            Self::I64Load8S => Some(82),
            Self::I64Load16S => Some(83),
            Self::I64Load32S => Some(84),
            Self::I32WrapI64 => Some(85),
            Self::I64ExtendI32U => Some(86),
            Self::I64ExtendI32S => Some(87),
            Self::I32Extend8S => Some(88),
            Self::I32Extend16S => Some(89),
    ...
    pub fn name(self) -> &'static str {
        match self {
            ...
            Self::I64Load8U => "i64_load8_u",
            Self::I64Load16U => "i64_load16_u",
            Self::I64Load32U => "i64_load32_u",
            Self::I64Load8S => "i64_load8_s",
            Self::I64Load16S => "i64_load16_s",
            Self::I64Load32S => "i64_load32_s",
            Self::I32WrapI64 => "i32_wrap_i64",
            Self::I64ExtendI32U => "i64_extend_i32_u",
            Self::I64ExtendI32S => "i64_extend_i32_s",
            Self::I32Extend8S => "i32_extend8_s",
            Self::I32Extend16S => "i32_extend16_s",
            Self::I64Extend8S => "i64_extend8_s",
            Self::I64Extend16S => "i64_extend16_s",
            Self::I64Extend32S => "i64_extend32_s",
...
pub fn opcode_info_from_code(code: u16) -> WasmOpcodeInfo {
    ...
    match op {
        ...
        Op::I64Load8U => info(op, code, Class::System, 1, 1, false, None),
        Op::I64Load16U => info(op, code, Class::System, 1, 1, false, None),
        Op::I64Load32U => info(op, code, Class::System, 1, 1, false, None),
        ...
        Op::I64ExtendI32U => info(op, code, Class::Numeric, 1, 1, false, None),
        Op::I64ExtendI32S => info(op, code, Class::Numeric, 1, 1, false, None),
        Op::I32Extend8S => info(op, code, Class::Numeric, 1, 1, false, None),
        Op::I32Extend16S => info(op, code, Class::Numeric, 1, 1, false, None),
        Op::I64Extend8S => info(op, code, Class::Numeric, 1, 1, false, None),
        Op::I64Extend16S => info(op, code, Class::Numeric, 1, 1, false, None),
        Op::I64Extend32S => info(op, code, Class::Numeric, 1, 1, false, None),
...
pub fn opcode_code(op: WasmOpcode) -> u16 {
    ...
    match op {
        ...
        WasmOpcode::I64Load8U => 0x31,
        WasmOpcode::I64Load16U => 0x33,
        WasmOpcode::I64Load32U => 0x35,
        WasmOpcode::I64Load8S => 0x30,
        WasmOpcode::I64Load16S => 0x32,
        WasmOpcode::I64Load32S => 0x34,
        WasmOpcode::I32WrapI64 => 0xA7,
        WasmOpcode::I64ExtendI32S => 0xAC,
        WasmOpcode::I64ExtendI32U => 0xAD,
        WasmOpcode::I32Extend8S => 0xC0,
        WasmOpcode::I32Extend16S => 0xC1,
        WasmOpcode::I64Extend8S => 0xC2,
        WasmOpcode::I64Extend16S => 0xC3,
        WasmOpcode::I64Extend32S => 0xC4,
...
fn opcode_from_code(code: u16) -> WasmOpcode {
    match code {
        ...
        x if x == opcode_code(WasmOpcode::I64Load8U) => WasmOpcode::I64Load8U,
        x if x == opcode_code(WasmOpcode::I64Load16U) => WasmOpcode::I64Load16U,
        x if x == opcode_code(WasmOpcode::I64Load32U) => WasmOpcode::I64Load32U,
        ...
        x if x == opcode_code(WasmOpcode::I64ExtendI32U) => WasmOpcode::I64ExtendI32U,
        x if x == opcode_code(WasmOpcode::I64ExtendI32S) => WasmOpcode::I64ExtendI32S,
        x if x == opcode_code(WasmOpcode::I32Extend8S) => WasmOpcode::I32Extend8S,
        x if x == opcode_code(WasmOpcode::I32Extend16S) => WasmOpcode::I32Extend16S,
        x if x == opcode_code(WasmOpcode::I64Extend8S) => WasmOpcode::I64Extend8S,
        x if x == opcode_code(WasmOpcode::I64Extend16S) => WasmOpcode::I64Extend16S,
        x if x == opcode_code(WasmOpcode::I64Extend32S) => WasmOpcode::I64Extend32S,
