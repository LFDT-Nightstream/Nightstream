...
namespace Nightstream.Implementation.NebulaV2.ProductFullClaimParser
...
def profileWord : FixedBits.Word
    Nightstream.Protocol.NebulaV2.WasmPublicStatementEncoding.profileSerializedBitCount :=
...
end Nightstream.Implementation.NebulaV2.ProductFullClaimParser
