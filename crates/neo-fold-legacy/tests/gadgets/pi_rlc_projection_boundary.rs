...
use neo_fold_legacy::engine::r1cs_circuit::ring_action::{
    enforce_beta_ladder, enforce_ring_action_projection_batch, projection_quotient, PROJECTION_QUOTIENT_LEN,
};
use neo_fold_legacy::engine::r1cs_circuit::{R1csBuilder, Var};
use neo_math::ring::D;
use neo_math::F;
...
fn manifest(honest: &ProjectionFixture, bad: &ProjectionFixture) -> Value {
    json!({
        ...
        "source_hashes": [
            source_hash("crates/neo-fold-legacy/src/engine/r1cs_circuit/ring_action.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/mod.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/consistency.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/fold_wires.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/mod.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/padding.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/projection/binding.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/projection/identities.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/projection/mod.rs"),
            source_hash("crates/neo-fold-legacy/src/paper/nifs/circuit/pi_rlc/projection/shared.rs"),
            source_hash("crates/neo-fold-legacy/tests/gadgets/pi_rlc_projection_boundary.rs"),
