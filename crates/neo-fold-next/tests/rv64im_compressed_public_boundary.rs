...
use neo_fold_next::rv64im::{
    Rv64imChunkStepIvcStatement, Rv64imChunkStepPublic, Rv64imEncodedPublicInput, Rv64imIvcPublicImage,
...
fn canonical_construction2_boundary(x_i: Rv64imEncodedPublicInput) -> Rv64imMainRecursionConstruction2PublicBoundary {
    let boundary = Rv64imMainRecursionConstruction2PublicBoundary {
...
fn canonical_public_image() -> Rv64imIvcPublicImage {
    let x_i = Rv64imEncodedPublicInput::from_digest_bytes([4; 32]);
...
fn expect_terminal_statement_digest_rejected(label: &str, mutate: fn(&mut Rv64imIvcPublicImage)) {
...
#[test]
fn rv64im_compressed_public_boundary_rejects_terminal_metadata_tamper() {
...
#[test]
fn rv64im_compressed_public_boundary_rejects_noncanonical_terminal_statement_digest_limbs() {
...
#[test]
fn rv64im_compressed_public_boundary_rejects_construction2_u_i_tamper() {
    let image = canonical_public_image();

    let mut wrong_x = image.clone();
    wrong_x.construction2_u_i.x_i = Rv64imEncodedPublicInput::from_digest_bytes([12; 32]);
    wrong_x
        .validate_final_construction2_public_boundary()
    ...
    wrong_pc
        .validate_final_construction2_public_boundary()
        .expect_err("pc must match the single RV64IM recursion lane");
