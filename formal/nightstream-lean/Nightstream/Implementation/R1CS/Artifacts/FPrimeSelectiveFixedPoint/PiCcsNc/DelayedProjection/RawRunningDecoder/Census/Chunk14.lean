...
/-!
Executable certificate for generated raw-running decoder shard 14.
...
Owns: the exact executable certificate for generated shard 14, containing
...
|---|---|---|
| `nifs.pi_ccs.nc.delayed.raw_decoder.artifact.census.chunk14` | check exactly one 252-record decoder shard | checked artifact |
-/

namespace Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder.Census.Chunk14

open Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder

theorem exact : ExactChunk ⟨14, by decide⟩
    Generated.Chunk14.schemaVersion
    Generated.Chunk14.sourceArm
    Generated.Chunk14.childCount
    Generated.Chunk14.logicalColumnCount
    Generated.Chunk14.finalColumnCount
    Generated.Chunk14.allocationRecords := by
  unfold ExactChunk ExactRecords
  native_decide

end Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder.Census.Chunk14
