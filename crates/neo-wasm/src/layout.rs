...
define_column_region! {
    ...
    columns: [
        ...
        COL_LOCAL_ZERO_ACTIVE_BEFORE: Boolean => "local-zero mode before",
        COL_LOCAL_ZERO_ACTIVE_AFTER: Boolean => "local-zero mode after",
        COL_LOCAL_ZERO_REMAINING_BEFORE: U32 => "locals left to zero before this row",
        COL_LOCAL_ZERO_REMAINING_AFTER: U32 => "locals left to zero after this row",
        COL_LOCAL_ZERO_REMAINING_AFTER_IS_ZERO: Boolean => "local-zero countdown is exhausted",
        COL_LOCAL_ZERO_REMAINING_AFTER_INV: Field => "inverse for local-zero countdown",
        ...
        COL_ENTERED_FUNCTION_NUM_LOCALS: U32 => "verifier-bound local count of the entered function",
