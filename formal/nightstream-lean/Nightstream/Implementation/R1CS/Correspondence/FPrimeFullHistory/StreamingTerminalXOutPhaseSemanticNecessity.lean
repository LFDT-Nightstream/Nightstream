...
/-!
Contract: exact omission counterexample for the terminal phase-semantic family.
...
namespace Nightstream.Implementation.R1CS.FPrimeFullHistoryStreamingTerminalXOutPhaseSemanticNecessity
...
def changedColumn : Nat := rawArtifact.xOutSemanticColumns.getD 0 0
...
private theorem violatedRow_member_equality :
...
private theorem violatedRow_member_program :
  ...
  simp [RawArtifact.program, RawArtifact.programPieces,
...
theorem exact_removal_counterexample :
  ...
  ⟨omissionAssignment_one, omissionAssignment_canonical,
    ...
    violated_source_row, phaseSemanticRows_fail⟩

end Nightstream.Implementation.R1CS.FPrimeFullHistoryStreamingTerminalXOutPhaseSemanticNecessity
