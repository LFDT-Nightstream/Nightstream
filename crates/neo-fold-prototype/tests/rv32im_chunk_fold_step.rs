...
use neo_fold_prototype::rv32im::final_relation::build_rv32im_chunk_fold_freshs;
use neo_fold_prototype::rv32im::final_relation::build_rv32im_chunk_fold_step_traces;
use neo_fold_prototype::rv32im::final_relation::build_rv32im_chunk_step_publics;
use neo_fold_prototype::rv32im::final_relation::rv32im_chunk_fold_initial_transcript_snapshot;
use neo_fold_prototype::rv32im::rv32im_chunk_fold_seed;

#[test]
fn rv32im_chunk_step_publics_chain_terminal_handles() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build rv32im n=2 fixture");
    let step_publics =
        build_rv32im_chunk_step_publics(&fixture.final_statement, &fixture.final_proof).expect("build step publics");
...
#[test]
fn rv32im_chunk_fold_freshs_match_verified_chunk_layout() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build rv32im n=2 fixture");
    let freshs =
        build_rv32im_chunk_fold_freshs(&fixture.final_statement, &fixture.final_proof).expect("build chunk freshs");
    let step_publics =
        build_rv32im_chunk_step_publics(&fixture.final_statement, &fixture.final_proof).expect("build step publics");
...
#[test]
fn rv32im_chunk_fold_step_traces_chain_verified_carries() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build rv32im n=2 fixture");
    let traces = build_rv32im_chunk_fold_step_traces(&fixture.final_statement, &fixture.final_proof)
...
#[test]
fn rv32im_chunk_fold_step_traces_chain_transcript_state() {
    let fixture = rv32im_n2_support::build_rv32im_n2_fixture().expect("build rv32im n=2 fixture");
    let traces = build_rv32im_chunk_fold_step_traces(&fixture.final_statement, &fixture.final_proof)
        .expect("build chunk-fold step traces");
    ...
    assert_eq!(
        ...
        rv32im_chunk_fold_initial_transcript_snapshot(),
