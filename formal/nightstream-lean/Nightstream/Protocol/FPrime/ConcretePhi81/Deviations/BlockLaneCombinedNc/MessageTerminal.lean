...
Assurance tier: model-level registered production deviation until the Rust
verifier and generated terminal rows refine `AcceptedFromMessage`.
...
namespace Nightstream.Protocol.FPrime.ConcretePhi81.Deviations.BlockLaneCombinedNc.MessageTerminal
...
end Nightstream.Protocol.FPrime.ConcretePhi81.Deviations.BlockLaneCombinedNc.MessageTerminal
