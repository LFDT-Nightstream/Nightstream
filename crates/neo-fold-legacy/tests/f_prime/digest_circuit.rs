...
use neo_fold_legacy::paper::f_prime::digest_circuit::{
...
fn alloc_4(b: &mut R1csBuilder, vals: [F; 4]) -> [neo_fold_legacy::engine::r1cs_circuit::Var; 4] {
...
fn extract_4(b: &R1csBuilder, vars: [neo_fold_legacy::engine::r1cs_circuit::Var; 4]) -> [F; 4] {
