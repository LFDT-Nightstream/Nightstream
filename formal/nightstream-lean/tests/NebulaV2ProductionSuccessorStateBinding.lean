...
namespace tests.NebulaV2ProductionSuccessorStateBinding

open Nightstream.Implementation.NebulaV2.ProductionSuccessorStateBinding
...
end tests.NebulaV2ProductionSuccessorStateBinding
