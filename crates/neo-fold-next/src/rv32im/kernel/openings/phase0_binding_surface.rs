...
pub struct Rv32imPhase0BindingTarget {
...
impl Rv32imPhase0BindingTarget {
    pub fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/phase0_binding_target");
        tr.append_u64s(
            b"neo.fold.next/rv32im/opening_convergence/phase0_binding_target/meta",
            &[self.schema.tag()],
        );
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/phase0_binding_target/family_binding_anchor_digest",
            &self.family_binding_anchor_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/phase0_binding_target/stage_proof_binding_digest",
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imPhase0BindingSurface {
    pub targets: Vec<Rv32imPhase0BindingTarget>,
    pub digest: [u8; 32],
}

impl Rv32imPhase0BindingSurface {
    pub fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/phase0_binding_surface");
        tr.append_u64s(
            b"neo.fold.next/rv32im/opening_convergence/phase0_binding_surface/count",
            &[self.targets.len() as u64],
        );
        for target in &self.targets {
            tr.append_message(
                b"neo.fold.next/rv32im/opening_convergence/phase0_binding_surface/target_digest",
                &target.digest,
            );
        }
        tr.digest32()
...
pub fn build_rv32im_phase0_binding_surface_from_accepted_artifact(
