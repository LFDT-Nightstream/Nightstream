...
namespace Nightstream.Protocol.Nebula.ConcreteLaneGeometry

open Nightstream.Protocol.Nebula.LaneLayout
...
end Nightstream.Protocol.Nebula.ConcreteLaneGeometry
