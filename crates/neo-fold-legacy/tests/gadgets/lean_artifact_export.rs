...
use neo_fold_legacy::engine::r1cs_circuit::builder::R1csBuilder;
...
fn emit_lean(builder: &R1csBuilder, var_col: usize, forged_witness: &[F]) -> String {
    ...
    out.push_str("`decompose_var_to_u64_bits` (crates/neo-fold-legacy/src/engine/r1cs_circuit/u64.rs),\n");
