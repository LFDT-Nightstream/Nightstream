...
use neo_fold_legacy::engine::r1cs_circuit::alphabet_sampling::{enforce_alphabet_sample_5_d, pi_rlc_challenge_stage};
use neo_fold_legacy::engine::r1cs_circuit::boolean::enforce_bit;
use neo_fold_legacy::engine::r1cs_circuit::encoding_trace::{
    BalancedTernaryTraceTestMutation, ProductSumTraceTestMutation,
};
use neo_fold_legacy::engine::r1cs_circuit::field_ext::{enforce_k_dot_product, enforce_k_mul, KLc, KVar};
use neo_fold_legacy::engine::r1cs_circuit::poseidon2::enforce_poseidon2_permutation;
use neo_fold_legacy::engine::r1cs_circuit::ring_action::enforce_ring_mul_toom3;
use neo_fold_legacy::engine::r1cs_circuit::{Lc, R1csBuilder, R1csEncodingTrace, R1csSnapshot, TranscriptGadget, Var};
use neo_fold_legacy::frontends::f_prime::gadget_native::{
...
use neo_fold_legacy::frontends::f_prime::low_norm_r1cs::{
...
use neo_fold_legacy::paper::reductions::accumulator_sis_circuit::{enforce_commit_fields, SisAccumulatorConfig};
use neo_math::{D, F};
use p3_field::{PrimeCharacteristicRing, PrimeField64};

fn source_relation() -> (neo_fold_legacy::engine::r1cs_circuit::R1csSnapshot, usize, usize, usize) {
