...
/-!
Executable evaluation-group certificate shard 2.
...
|---|---|---|
| evaluation shard 2 | every pair in this slice matches its independent target | checked |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk2
...
def pairs : List EvaluationPair :=
  (evaluationPairs.drop 14).take 7
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk2
