...
use neo_fold_prototype::circuit::superneo::claim::{
    alloc_ce_claim, me_input_projection_digest_poseidon_values_from_native_claim,
};
use neo_fold_prototype::circuit::superneo::k_field::{alloc_constant_k, enforce_k_eq, KNum};
use neo_fold_prototype::circuit::superneo::pi_ccs::{
...
fn toy_claim(seed: u64) -> CeClaim<Commitment, GoldilocksF, neo_math::K> {
    ...
    x[(1, 0)] = GoldilocksF::from_u64(seed + 3);
    CeClaim {
        c: Commitment {
            d: neo_math::D,
            kappa: 1,
...
#[test]
fn rv32im_me_projection_digest_rejects_malformed_superneo_x_shape() {
...
fn rv32im_main_relation_pi_ccs_claim_binding_matches_native_challenges() {
