...
fn push_constraint_delta(
    stages: &mut Vec<Rv64imNamedConstraintDelta>,
    previous: &mut usize,
    current: usize,
    ...
    *previous = current;
    stages.push(Rv64imNamedConstraintDelta {
        name: name.into(),
        delta,
    });
}
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imMainRecursionStepStageAuxCounts {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imMainRecursionStepChunkReplayAuxCounts {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imMainRecursionStepChunkReplayTailAuxCounts {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imPiCcsStageAuxCounts {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imPiCcsStageConstraintCounts {
    pub after_bind_header: usize,
    pub after_bind_me_inputs: usize,
    pub after_sample_challenges: usize,
    pub after_alloc_fresh_claims: usize,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imPiCcsSumcheckConstraintBreakdown {
    pub fe_cover_round_lengths: Vec<u64>,
    pub fe_effective_round_lengths: Vec<usize>,
    pub fe_stages: Vec<Rv64imNamedConstraintDelta>,
    pub nc_cover_round_lengths: Vec<u64>,
    pub nc_effective_round_lengths: Vec<usize>,
    pub nc_stages: Vec<Rv64imNamedConstraintDelta>,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imPiCcsStageFingerprint {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imPiRlcPublicConstraintBreakdown {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imNamedConstraintDelta {
    pub name: String,
    pub delta: usize,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imPiRlcPublicStageBreakdown {
    pub stages: Vec<Rv64imNamedConstraintDelta>,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub struct Rv64imMainRecursionStepChunkReplayTailDigestAuxBreakdown {
...
pub fn debug_measure_rv64im_main_recursion_step_pi_ccs_aux_counts(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imPiCcsStageAuxCounts, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = FingerprintCS::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("pi_ccs_context", err))?;
    let optimized_cache =
        rv64im_cached_root_main_lane_optimized_cache().map_err(|err| stage_err("pi_ccs_optimized_cache", err))?;
    ...
    let (initial_sum_fe, initial_sum_fe_value) =
        crate::rv64im::main_relation_circuit::initial_sum::claimed_initial_sum_from_me_inputs(
    ...
    let (fe_challenges, sumcheck_final_fe) =
        crate::rv64im::main_relation_circuit::sumcheck_replay::verify_sumcheck_rounds(
    ...
    let zero_nc = crate::rv64im::main_relation_circuit::k_field::alloc_constant_k(
        &mut cs.namespace(|| format!("chunk_{}_initial_sum_nc_zero", ctx.chunk_index)),
        crate::rv64im::main_relation_circuit::k_field::KNum::from_neo_k(K::ZERO),
    ...
    let (nc_challenges, sumcheck_final_nc) =
        crate::rv64im::main_relation_circuit::sumcheck_replay::verify_sumcheck_rounds(
    ...
    crate::rv64im::main_relation_circuit::output_binding::enforce_me_outputs_against_inputs(
    ...
    let effective_terminal_outputs = padded_ccs_outputs[..cover_fresh_claim_count]
        ...
        .collect::<Vec<_>>();
    let _ = crate::rv64im::main_relation_circuit::terminal_identity::enforce_terminal_identity_fe(
    ...
    let _ = crate::rv64im::main_relation_circuit::terminal_identity::enforce_terminal_identity_nc(
...
pub fn debug_measure_rv64im_main_recursion_step_pi_ccs_constraint_counts(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imPiCcsStageConstraintCounts, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = ShapeCS::<Rv64imDeciderEngine>::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("pi_ccs_constraints_context", err))?;
    ...
    Ok(Rv64imPiCcsStageConstraintCounts {
        after_bind_header,
        after_bind_me_inputs,
        after_sample_challenges,
        after_alloc_fresh_claims,
...
pub fn debug_measure_rv64im_main_recursion_step_pi_ccs_bind_me_inputs_aux_breakdown(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imPiCcsBindMeInputsAuxBreakdown, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = FingerprintCS::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("pi_ccs_bind_breakdown_context", err))?;
    let optimized_cache = rv64im_cached_root_main_lane_optimized_cache()
...
pub fn debug_measure_rv64im_main_recursion_step_pi_ccs_sumcheck_constraint_breakdown(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imPiCcsSumcheckConstraintBreakdown, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = ShapeCS::<Rv64imDeciderEngine>::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("pi_ccs_sumcheck_context", err))?;
    let optimized_cache = rv64im_cached_root_main_lane_optimized_cache()
    ...
    let fe_challenge_values =
        super::super::chunk_sumcheck_challenges(&ctx.chunk.pi_ccs.row_chals, &ctx.chunk.pi_ccs.alpha_prime);
    let (fe_challenges, _) = crate::rv64im::main_relation_circuit::sumcheck_replay::verify_sumcheck_rounds_with_trace(
        &mut cs,
        &mut replayed_transcript,
        super::super::max_degree_from_cover_round_lengths(&ctx.cover_chunk.fe_round_lengths),
        &initial_sum_fe,
    ...
    let nc_challenge_values =
        super::super::chunk_sumcheck_challenges(&ctx.chunk.pi_ccs.s_col, &ctx.chunk.pi_ccs.alpha_prime_nc);
    let (nc_challenges, _) = crate::rv64im::main_relation_circuit::sumcheck_replay::verify_sumcheck_rounds_with_trace(
        &mut cs,
        &mut replayed_transcript,
        super::super::max_degree_from_cover_round_lengths(&ctx.cover_chunk.nc_round_lengths),
        &zero_nc,
    ...
    Ok(Rv64imPiCcsSumcheckConstraintBreakdown {
...
pub fn debug_measure_rv64im_main_recursion_step_chunk_replay_tail_aux_counts(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imMainRecursionStepChunkReplayTailAuxCounts, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = FingerprintCS::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("chunk_tail_context", err))?;
    let optimized_cache =
        rv64im_cached_root_main_lane_optimized_cache().map_err(|err| stage_err("chunk_tail_optimized_cache", err))?;
    ...
    Ok(Rv64imMainRecursionStepChunkReplayTailAuxCounts {
...
pub fn debug_measure_rv64im_main_recursion_step_chunk_replay_tail_digest_aux_breakdown(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imMainRecursionStepChunkReplayTailDigestAuxBreakdown, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = FingerprintCS::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("chunk_tail_digest_context", err))?;
    let optimized_cache = rv64im_cached_root_main_lane_optimized_cache()
    ...
    Ok(Rv64imMainRecursionStepChunkReplayTailDigestAuxBreakdown {
...
pub fn debug_measure_rv64im_main_recursion_step_pi_ccs_fingerprint(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imPiCcsStageFingerprint, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = FingerprintCS::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("pi_ccs_fingerprint_context", err))?;
    let optimized_cache = rv64im_cached_root_main_lane_optimized_cache()
    ...
    Ok(Rv64imPiCcsStageFingerprint {
        after_bind_header,
        after_bind_me_inputs,
        after_sample_challenges,
        after_alloc_fresh_claims,
...
pub fn debug_measure_rv64im_main_recursion_step_stage_aux_counts(
    spartan_shape: &Rv64imMainRecursionStepSpartanShape,
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imMainRecursionStepStageAuxCounts, Rv64imMainRecursionStepSpartanError> {
    ...
    Ok(Rv64imMainRecursionStepStageAuxCounts {
...
pub fn debug_measure_rv64im_main_recursion_step_pi_rlc_public_constraint_breakdown(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imPiRlcPublicConstraintBreakdown, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = ShapeCS::<Rv64imDeciderEngine>::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("pi_rlc_public_context", err))?;
    let optimized_cache = rv64im_cached_root_main_lane_optimized_cache()
    ...
    let checkpoints = super::super::debug_measure_rv64im_rlc_public_stage_ranges(
        params,
        structure,
        dims,
        &mat_digest,
    ...
    Ok(Rv64imPiRlcPublicConstraintBreakdown {
...
pub fn debug_measure_rv64im_main_recursion_step_pi_rlc_public_stage_breakdown(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imPiRlcPublicStageBreakdown, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = ShapeCS::<Rv64imDeciderEngine>::new();
    let (params, _, structure) =
        rv64im_cached_root_main_lane_context().map_err(|err| stage_err("pi_rlc_public_stage_context", err))?;
    let optimized_cache = rv64im_cached_root_main_lane_optimized_cache()
    ...
    Ok(Rv64imPiRlcPublicStageBreakdown { stages })
}

pub fn debug_measure_rv64im_main_recursion_step_chunk_replay_aux_counts(
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
) -> Result<Rv64imMainRecursionStepChunkReplayAuxCounts, Rv64imMainRecursionStepSpartanError> {
    let witness = &backend_relation.f_prime_advice;
    let payload = &backend_relation.payload;
    let mut cs = FingerprintCS::new();
    let (params, _, structure) =
    ...
    Ok(Rv64imMainRecursionStepChunkReplayAuxCounts {
        after_state_cover,
        after_chunk_meta,
        after_pi_ccs,
        after_synthetic_relation_io,
...
pub fn debug_trace_rv64im_main_recursion_step_spartan_circuit_shape_measurement(
    spartan_shape: &Rv64imMainRecursionStepSpartanShape,
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
    trace_prefix: &str,
) -> Result<Rv64imMainRecursionStepSpartanCircuitShape, Rv64imMainRecursionStepSpartanError> {
...
pub fn debug_trace_rv64im_main_recursion_step_shape_only_circuit_shape_measurement(
    spartan_shape: &Rv64imMainRecursionStepSpartanShape,
    trace_prefix: &str,
) -> Result<Rv64imMainRecursionStepSpartanCircuitShape, Rv64imMainRecursionStepSpartanError> {
    let started = Instant::now();
...
pub fn debug_trace_rv64im_main_recursion_step_fingerprint_synthesize(
    spartan_shape: &Rv64imMainRecursionStepSpartanShape,
    backend_relation: &Rv64imMainRecursionFPrimeBackendRelation,
    trace_prefix: &str,
) -> Result<Rv64imMainRecursionStepSpartanCircuitShape, Rv64imMainRecursionStepSpartanError> {
    ...
    let started = Instant::now();
    let shape = Rv64imMainRecursionStepSpartanCircuitShape {
...
pub fn debug_trace_rv64im_main_recursion_step_shape_only_fingerprint_synthesize(
    spartan_shape: &Rv64imMainRecursionStepSpartanShape,
    trace_prefix: &str,
) -> Result<Rv64imMainRecursionStepSpartanCircuitShape, Rv64imMainRecursionStepSpartanError> {
    let started = Instant::now();
