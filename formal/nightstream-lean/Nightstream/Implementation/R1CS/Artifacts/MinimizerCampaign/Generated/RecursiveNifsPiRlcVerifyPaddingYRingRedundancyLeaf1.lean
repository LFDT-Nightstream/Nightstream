...
namespace Nightstream.Implementation.R1CS.Artifacts.MinimizerCampaign.Generated.RecursiveNifsPiRlcVerifyPaddingYRingRedundancyLeaf1
...
theorem chunkLeaf1 :
    ((rowsChunk wire 1).filter
        (fun row => decide (row.family = certFamily)) =
      (certParts 1).map (fun scalar => scalar.candidate)) ∧
      ((certParts 1).all (fun scalar =>
        duplicateOk scalar &&
...
end Nightstream.Implementation.R1CS.Artifacts.MinimizerCampaign.Generated.RecursiveNifsPiRlcVerifyPaddingYRingRedundancyLeaf1
