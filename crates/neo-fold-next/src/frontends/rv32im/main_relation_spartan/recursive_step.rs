...
fn dummy_backend_relation_from_chain_step(
    ...
    let advice = crate::rv32im::f_prime::Rv32imMainRecursionFPrimeAdvice::from_parts(
        vk_fs.clone(),
        chunk_count_in,
        initial_state.carry.terminal_handle.0,
        running_state.carry.terminal_handle.0,
        crate::rv32im::f_prime::RV32IM_MAIN_RECURSION_TRIVIAL_PC,
        crate::rv32im::f_prime::Rv32imMainRecursionSideLaneWitness::zero(),
        crate::rv32im::f_prime::Rv32imMainRecursionPhiSide::zero(),
        running_state.clone(),
        build_rv32im_main_recursion_backend_statement_from_parts_with_vk_fs(
            &vk_fs,
    ...
    let statement = build_rv32im_main_recursion_step_spartan_statement_from_payload(&advice)
        .map_err(|err| Rv32imMainRecursionStepSpartanError::Prepare(err.to_string()))?;
    let construction2_u_next = crate::rv32im::f_prime::evaluate_rv32im_main_recursion_f_prime_advice(&advice)
        .map_err(|err| Rv32imMainRecursionStepSpartanError::Prepare(err.to_string()))?
...
fn enforce_inactive_side_lane_constraints<CS: ConstraintSystem<SpartanF>>(
    ...
    if !crate::rv32im::f_prime::RV32IM_MAIN_RECURSION_SIDE_WITNESS_ACTIVE {
    ...
    if !crate::rv32im::f_prime::RV32IM_MAIN_RECURSION_PHI_SIDE_ACTIVE {
...
fn build_rv32im_main_recursion_step_circuit_inner(
    ...
    let canonical_step_image =
        crate::rv32im::f_prime::evaluate_rv32im_main_recursion_f_prime_advice(&backend_relation.f_prime_advice)
            .map_err(|err| Rv32imMainRecursionStepSpartanError::Prepare(err.to_string()))?;
