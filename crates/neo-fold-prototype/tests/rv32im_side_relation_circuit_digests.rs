...
use neo_fold_prototype::public_proof::rv32im::side_opening_relation::build_rv32im_side_opening_relation_witness_from_accepted_artifact;
...
fn rv32im_side_relation_circuit_selected_opening_digests_match_carried_claims() {
    let proof =
    ...
    let side_bundle =
        build_rv32im_side_proof_bundle_from_accepted_artifact(&accepted_artifact).expect("build side bundle");
    let witness = build_rv32im_side_opening_relation_witness_from_accepted_artifact(&accepted_artifact);
