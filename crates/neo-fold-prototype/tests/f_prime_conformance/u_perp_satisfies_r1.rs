...
use neo_fold_prototype::rv32im::audit::audit_rv32im_main_recursion_default_carry_satisfies_r1_literally;
...
fn f_prime_default_carry_satisfies_r1_literally() {
    ...
    audit_rv32im_main_recursion_default_carry_satisfies_r1_literally(advices[0].fresh_state_out())
