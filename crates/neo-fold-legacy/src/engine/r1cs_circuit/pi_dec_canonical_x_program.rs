...
//! uniform-sign canonical child split for the fixed radix-two profile. Its
//! row and column costs are derived from the typed plan; no production-sized
...
impl PiDecCanonicalXProgram {
    ...
    pub fn owner(self, relative_row: usize) -> Option<PiDecCanonicalXRowOwner> {
        ...
        Some(PiDecCanonicalXRowOwner::ChildDigit {
            active_index,
            child: child_row,
        })
    }
