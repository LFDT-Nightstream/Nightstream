...
namespace NightstreamFPrime.Layout.Stage1.Wide.PiRLCInputs
...
/-- The candidate wide PiRLC parent interface in cumulative source order. -/
def interface :
    NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.Interface
...
def samplerInputs :
    NightstreamFPrime.Layout.PiRLC.Wide.SamplerChain.InputsAffine
      (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.samplerInterface
        (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.atOffset
          (interface (logicalWidth := logicalWidth) (publicFits := publicFits))
          phaseOffset))
      (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.samplerOffset
        phaseOffset) :=
  ⟨by
    simpa [interface,
      NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.samplerInterface,
      NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.atOffset] using
...
def commitmentProductionInputs :
    NightstreamFPrime.Layout.PiRLC.v1_1.CombinationFamily.ProductionInputs
      (NightstreamFPrime.Lifecycle.PiRLC.v1_1.CommitmentCombination.familyInterface
        (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.commitmentInterface
          (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.atOffset
            (interface (logicalWidth := logicalWidth) (publicFits := publicFits))
            phaseOffset)))
      (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.commitmentOffset
        phaseOffset) := by
  constructor
  · intro source lane
    exact ⟨_, rfl⟩
...
def publicInputProductionInputs :
    NightstreamFPrime.Layout.PiRLC.v1_1.CombinationFamily.ProductionInputs
      (NightstreamFPrime.Lifecycle.PiRLC.v1_1.PublicInputCombination.familyInterface
        (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.publicInputInterface
          (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.atOffset
            (interface (logicalWidth := logicalWidth) (publicFits := publicFits))
            phaseOffset)))
      (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.publicInputOffset
        phaseOffset) := by
  constructor
  · intro source lane
    exact ⟨_, rfl⟩
    ...
    NightstreamFPrime.Layout.PiRLC.v1_1.CombinationFamily.ProductionInputs
      (NightstreamFPrime.Lifecycle.PiRLC.v1_1.RingKCombination.familyInterface
        (NightstreamFPrime.Lifecycle.PiRLC.v1_1.EvalKCombination.ringInterface
          (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.evalKInterface
            (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.atOffset
              (interface (logicalWidth := logicalWidth)
                (publicFits := publicFits)) phaseOffset))))
      (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.evalKOffset phaseOffset) := by
  constructor
  · intro source lane
    exact ⟨_, rfl⟩
  · intro source block lane cell
    ...
    NightstreamFPrime.Layout.PiRLC.v1_1.CombinationFamily.ProductionInputs
      (NightstreamFPrime.Lifecycle.PiRLC.v1_1.RingKCombination.familyInterface
        (NightstreamFPrime.Lifecycle.PiRLC.v1_1.EvalACombination.ringInterface
          (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.evalAInterface
            (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.atOffset
              (interface (logicalWidth := logicalWidth)
                (publicFits := publicFits)) phaseOffset))))
      (NightstreamFPrime.Lifecycle.PiRLC.Wide.Formal.evalAOffset phaseOffset) := by
  constructor
  · intro source lane
    exact ⟨_, rfl⟩
...
def inputShapes
    (relation : ProductionKey.LogicalRelation logicalWidth publicFits) :
    NightstreamFPrime.Layout.PiRLC.Wide.InputShapes relation
      (interface (logicalWidth := logicalWidth) (publicFits := publicFits))
      phaseOffset where
...
end NightstreamFPrime.Layout.Stage1.Wide.PiRLCInputs
