...
/-!
Proof-free coefficient certificate for rewrite pairs 1000 through 1249.
...
|---|---|---|---|
| rewrite chunk 4 | all thirteen normalized port forms match | checked | 250 records |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.RewriteBridge.Coefficients.Shard4
...
def pairs : List RewritePair := rewriteCoefficientChunk4

def data : List CoefficientMatchShape := rewriteCoefficientDataChunk4

theorem dataLengthExact : data.length = 250 :=
  rewriteCoefficientDataChunkLengthsExact.2.2.2.2
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.RewriteBridge.Coefficients.Shard4
