...
def rawStep00 : RawStep where
  rowOffset := 0
  input := { constant := 15504881536434223753, terms := [{ column := .externalB 0, coefficient := 7 }, { column := .externalA 0, coefficient := 4 }, { column := .externalA 1, coefficient := 6 }, { column := .externalA 2, coefficient := 2 }, { column := .externalA 3, coefficient := 2 }] }
  output := { constant := 0, terms := [{ column := .local 11, coefficient := 1 }] }

def rawStep01 : RawStep where
  rowOffset := 1
  input := { constant := 2212164856944708396, terms := [{ column := .externalB 0, coefficient := 7 }, { column := .externalA 0, coefficient := 2 }, { column := .externalA 1, coefficient := 4 }, { column := .externalA 2, coefficient := 6 }, { column := .externalA 3, coefficient := 2 }] }
  output := { constant := 0, terms := [{ column := .local 15, coefficient := 1 }] }

def rawStep02 : RawStep where
  rowOffset := 2
  input := { constant := 1885257220781225929, terms := [{ column := .externalB 0, coefficient := 7 }, { column := .externalA 0, coefficient := 2 }, { column := .externalA 1, coefficient := 2 }, { column := .externalA 2, coefficient := 4 }, { column := .externalA 3, coefficient := 6 }] }
  output := { constant := 0, terms := [{ column := .local 19, coefficient := 1 }] }

def rawStep03 : RawStep where
  rowOffset := 3
  input := { constant := 17531637481572944510, terms := [{ column := .externalB 0, coefficient := 7 }, { column := .externalA 0, coefficient := 6 }, { column := .externalA 1, coefficient := 2 }, { column := .externalA 2, coefficient := 2 }, { column := .externalA 3, coefficient := 4 }] }
  output := { constant := 0, terms := [{ column := .local 23, coefficient := 1 }] }

def rawStep04 : RawStep where
  rowOffset := 4
  input := { constant := 16769640728293682348, terms := [{ column := .externalB 0, coefficient := 14 }, { column := .externalA 0, coefficient := 2 }, { column := .externalA 1, coefficient := 3 }, { column := .externalA 2, coefficient := 1 }, { column := .externalA 3, coefficient := 1 }] }
  output := { constant := 0, terms := [{ column := .local 27, coefficient := 1 }] }

def rawStep05 : RawStep where
  rowOffset := 5
  input := { constant := 445908668462176974, terms := [{ column := .externalB 0, coefficient := 14 }, { column := .externalA 0, coefficient := 1 }, { column := .externalA 1, coefficient := 2 }, { column := .externalA 2, coefficient := 3 }, { column := .externalA 3, coefficient := 1 }] }
  output := { constant := 0, terms := [{ column := .local 31, coefficient := 1 }] }

def rawStep06 : RawStep where
  rowOffset := 6
  input := { constant := 1308472042479836079, terms := [{ column := .externalB 0, coefficient := 14 }, { column := .externalA 0, coefficient := 1 }, { column := .externalA 1, coefficient := 1 }, { column := .externalA 2, coefficient := 2 }, { column := .externalA 3, coefficient := 3 }] }
  output := { constant := 0, terms := [{ column := .local 35, coefficient := 1 }] }

def rawStep07 : RawStep where
  rowOffset := 7
  input := { constant := 17465001500823438575, terms := [{ column := .externalB 0, coefficient := 14 }, { column := .externalA 0, coefficient := 3 }, { column := .externalA 1, coefficient := 1 }, { column := .externalA 2, coefficient := 1 }, { column := .externalA 3, coefficient := 2 }] }
