...
use neo_fold_legacy::{RelationArtifactError, VerifierKeyRelationArtifact};
use neo_math::{D, F};
use p3_field::PrimeCharacteristicRing;
use serde_json::{json, Value};

fn preprocessing() -> neo_fold_legacy::Preprocessing {
...
fn other_preprocessing() -> neo_fold_legacy::Preprocessing {
    let mut a = Mat::zero(1, D, F::ZERO);
    a[(0, 1)] = F::ONE;
