...
For a vector  $z \in \mathbb{F}^n$ , we define the  $\ell_\infty$ -norm  $\|z\|_\infty$  to be the maximum norm of its elements. For an element  $a \in \mathbb{R}_\mathbb{F}$ , we define  $\|a\|_\infty$  to be the  $\ell_\infty$ -norm of the vector  $\text{cf}(a)$ . For a vector  $z \in \mathbb{R}_\mathbb{F}^m$ , we define  $\|z\|_\infty$  to be the maximum  $\ell_\infty$ -norm of its elements.
