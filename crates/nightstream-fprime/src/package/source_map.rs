...
const PILOT_SOURCE_COLUMN_COUNT: usize = 13_691_432;
const PILOT_PRIVATE_COLUMN_COUNT: usize = 13_691_158;
const PILOT_INPUT_PRIVATE_COLUMN_COUNT: usize = 91_866;
const PROOF_INPUT_COLUMN_COUNT: usize = 29_032;
const PROOF_INPUT_SOURCE_START: usize = 13_691_436;
const PI_CCS_PHASE_OFFSET: usize = 13_720_468;
const PI_CCS_LOCAL_START: usize = 13_720_190;
const PRIVATE_COLUMN_COUNT: usize = 27_649_368;
const EXPECTED_CONTEXT_PUBLIC_START: usize = 27_649_643;

const PILOT_PRIOR_PUBLIC_START: usize = 45_933;
const PILOT_OUTPUT_PREIMAGE_START: usize = 46_203;
const PILOT_OUTPUT_DIGEST_START: usize = 92_136;
const PILOT_WITNESS_START: usize = 92_140;
const PILOT_SECOND_PRIVATE_START: usize = 45_933;
const PILOT_WITNESS_PRIVATE_START: usize = 91_866;
const PILOT_FIRST_PUBLIC_START: usize = 13_691_159;
const PILOT_SECOND_PUBLIC_START: usize = 13_691_429;
