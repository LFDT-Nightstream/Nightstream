...
namespace Nightstream.Implementation.NebulaV2.ProductionPaperFoldCoreManifestFor
...
structure Program (candidate : Id) (rowVariables : Nat) where
  ...
  piCcsTermCount : piCcsInput.constraintPolynomial.terms.length = 66
  piCcsDegreeSum :
    KSparsePolynomial.totalDegreeSum piCcsInput.constraintPolynomial.terms = 280
  samplerBase : Nat
...
end Nightstream.Implementation.NebulaV2.ProductionPaperFoldCoreManifestFor
