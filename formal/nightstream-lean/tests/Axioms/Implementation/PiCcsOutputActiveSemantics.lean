...
/-- info: 'Nightstream.Implementation.R1CS.PiCcsOutputDigest.ActiveProfile.selectiveShape_not_legacyProfile' depends on axioms: [propext,
 Quot.sound] -/
#guard_msgs in
#audit_axioms Nightstream.Implementation.R1CS.PiCcsOutputDigest.ActiveProfile.selectiveShape_not_legacyProfile
