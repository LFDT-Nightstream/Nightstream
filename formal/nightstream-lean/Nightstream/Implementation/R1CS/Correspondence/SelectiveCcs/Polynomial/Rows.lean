...
|---|---|---|
| Boolean | `g`, `bit` | Boolean |
| packed Boolean/domain | `g=e`, `bit` | Boolean |
| product | `g`, `a`, `b`, `c` | product |
| Poseidon2 S-box | `g`, `s`, `c` | product output term plus S-box |
| centered unit | `g`, `u` | centered |
| packed centered pair | `g=e=1`, `u`, `a` | two centered obligations under projective nonresiduosity |
...
namespace Nightstream.Implementation.R1CS.SelectiveCcs.Polynomial.Rows
...
def combinedBooleanPoint (selector bit : F) : Fin 13 -> F :=
  sparsePoint [(.generalSelector, selector), (.evalSelector, selector),
    (.bit, bit)]
...
def centeredPairPoint (selector left right : F) : Fin 13 -> F :=
  sparsePoint [(.generalSelector, selector), (.evalSelector, selector),
    (.centeredUnit, left), (.a, right)]
...
theorem evaluate_combinedBooleanPoint (selector bit : F) :
    evaluate (combinedBooleanPoint selector bit) =
      booleanResidual (combinedBooleanPoint selector bit) := by
  rw [evaluate_eq_combinedResidual]
  simp [combinedResidual, productResidual, sboxResidual, centeredResidual,
    centeredResidualAt, evaluationResidual,
    canonicalResidual, evaluateTerms, canonicalTerms, monomial, exponentVector,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.CCSResidualTable.evaluateMonomial,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.CCSResidualTable.pow,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.canonicalFinIndices,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.ConcreteCarrier.baseOps,
    combinedBooleanPoint, sparsePoint,
    Role.index, Fin.mul_zero, Fin.add_zero,
    Lean.Grind.AddCommGroup.neg_zero]
  apply Fin.ext
  simp [Fin.val_add, Fin.zero_mul,
    Lean.Grind.AddCommGroup.neg_zero]
  exact Nat.mod_eq_of_lt
    (booleanResidual (combinedBooleanPoint selector bit)).isLt
...
theorem evaluate_centeredPairPoint (selector left right : F) :
    evaluate (centeredPairPoint selector left right) =
      centeredResidual (centeredPairPoint selector left right) := by
  rw [evaluate_eq_combinedResidual]
  simp [combinedResidual, booleanResidual, productResidual, sboxResidual,
    evaluationResidual, canonicalResidual, evaluateTerms, canonicalTerms,
    monomial, exponentVector,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.CCSResidualTable.evaluateMonomial,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.CCSResidualTable.pow,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.canonicalFinIndices,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.ConcreteCarrier.baseOps,
    centeredPairPoint, sparsePoint,
    Role.index, Fin.zero_mul, Fin.mul_zero, Fin.zero_add, Fin.add_zero,
    Lean.Grind.AddCommGroup.neg_zero]
...
theorem evaluate_evaluationPoint (selector bit a b sbox unit digit borrow
  ...
  simp [combinedResidual, booleanResidual, productResidual, sboxResidual,
    ...
    canonicalResidual, evaluateTerms, canonicalTerms, monomial,
    exponentVector,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.CCSResidualTable.evaluateMonomial,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.CCSResidualTable.pow,
    Nightstream.SuperNeo.Folding.PiCCS.PaperJoint.canonicalFinIndices,
...
theorem evaluate_canonicalPoint
  ...
  simp [combinedResidual, booleanResidual, productResidual, sboxResidual,
    centeredResidual, centeredResidualAt,
    evaluationResidual, canonicalPoint, sparsePoint,
    Role.index, Fin.zero_mul, Fin.mul_zero, Fin.zero_add, Fin.add_zero,
    Lean.Grind.AddCommGroup.neg_zero]

end Nightstream.Implementation.R1CS.SelectiveCcs.Polynomial.Rows
