...
use neo_fold_legacy::engine::ccs_native::poseidon2_transcript::SpongeTraceBuilder;
use neo_fold_legacy::frontends::f_prime::image::{FPrimeImage, FPrimeImageConfig, FPrimeImageLayout};
use neo_fold_legacy::paper::f_prime::poseidon_trace::{assert_committed_coords_are_bits, encode_poseidon_trace};
