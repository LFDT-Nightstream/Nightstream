...
/-!
Executable certificate for generated raw-running decoder shard 2.
...
Owns: the exact executable certificate for generated shard 2, containing
...
|---|---|---|
| `nifs.pi_ccs.nc.delayed.raw_decoder.artifact.census.chunk2` | check exactly one 252-record decoder shard | checked artifact |
-/

namespace Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder.Census.Chunk2

open Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder

theorem exact : ExactChunk ⟨2, by decide⟩
    Generated.Chunk2.schemaVersion
    Generated.Chunk2.sourceArm
    Generated.Chunk2.childCount
    Generated.Chunk2.logicalColumnCount
    Generated.Chunk2.finalColumnCount
    Generated.Chunk2.allocationRecords := by
  unfold ExactChunk ExactRecords
  native_decide

end Nightstream.Implementation.R1CS.Artifacts.FPrimeSelectiveFixedPoint.PiCcsNc.DelayedProjection.RawRunningDecoder.Census.Chunk2
