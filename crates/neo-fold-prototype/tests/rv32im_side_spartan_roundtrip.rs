...
use neo_fold_prototype::public_proof::rv32im::side_eval_claim_relation::build_rv32im_bound_phase0_claim_witnesses_from_accepted_artifact;
use neo_fold_prototype::public_proof::rv32im::side_relation_spartan::{
    debug_check_rv32im_side_binding_circuit, prove_rv32im_side_binding, setup_rv32im_side_binding,
    setup_rv32im_side_binding_cached, verify_rv32im_side_binding,
};
...
fn side_shape_signature(witness: &neo_fold_prototype::public_proof::rv32im::Rv32imSideOpeningPublic) -> (usize, usize) {
