//! Direct shifted-ternary rows for the selective CCS image.

use p3_field::{PrimeCharacteristicRing, PrimeField64};

use super::{
    append_field, LinearDefinitions, LowNormR1csError, MatrixTerms, SparseR1cs, BALANCED_FIELD_WIDTH, CANON_BORROW,
    CANON_BOUND_DIGIT, CANON_DIGIT, CANON_NEXT_BORROW, CENTERED_UNIT, GENERAL_SELECTOR,
};
use neo_math::F;

pub(super) fn emit_shifted_ternary_rows(
    arm: &SparseR1cs,
