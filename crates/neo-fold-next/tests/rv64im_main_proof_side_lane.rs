...
#[test]
fn rv64im_verifier_context_digest_tracks_published_main_recursion_shape() {
    let fixture = rv64im_n2_support::build_rv64im_n2_fixture().expect("build rv64im n=2 fixture");
    let published_statement = neo_fold_next::rv64im::Rv64imAccumulatorPublicStatement::from_final_artifacts(
        &fixture.final_statement,
        &fixture.final_proof,
    ...
    .expect("build published statement");
    let baseline = rv64im_verifier_context_digest(
        fixture.accepted_artifact.statement.root_params_id,
        &published_statement,
        &fixture.ivc_recursion_snark_keys.as_ref().1,
    )
    ...
    let tampered_shape = rv64im_verifier_context_digest(
        fixture.accepted_artifact.statement.root_params_id,
    ...
    assert_ne!(
        ...
        "Nightstream verifier context must bind the published RV64IM main-recursion shape"
    );
}
...
fn rv64im_main_proof_surface_is_unchanged_by_authoritative_phi_side() {
    ...
    let statement = Rv64imAccumulatorPublicStatement::from_final_artifacts(
        &fixture.final_statement,
        &fixture.final_proof,
        fixture.accepted_artifact.statement.final_pc,
    )
