//! Owns the public IO layout for the RV32IM main-recursion Spartan surfaces.
...
use crate::rv32im::main_recursion::Rv32imEncodedPublicInput;
use crate::rv32im::main_relation_spartan::{digest32_as_spartan_fields, Rv32imMainRecursionStepSpartanStatement};
use crate::spartan_backend::SpartanF;

use super::u64_halves_as_spartan_fields;

#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct Rv32imMainRecursionStepSpartanPublishedTarget {
...
impl Rv32imMainRecursionStepSpartanPublishedTarget {
    ...
    pub fn output_statement(&self) -> Rv32imMainRecursionStepSpartanStatement {
