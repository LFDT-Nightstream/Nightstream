...
namespace Nightstream.Implementation.R1CS.TerminalR1cs.Atoms
...
def normRawRows (value square : ColumnId) :
...
theorem normRows_cube
    ...
    (satisfied :
      Nightstream.Implementation.Lowering.Goldilocks.Satisfies
        (normRows owner firstOrdinal value square) assignment) :
...
theorem normRows_honest
    ...
    Nightstream.Implementation.Lowering.Goldilocks.Satisfies
      (normRows owner firstOrdinal value square)
...
end Nightstream.Implementation.R1CS.TerminalR1cs.Atoms
