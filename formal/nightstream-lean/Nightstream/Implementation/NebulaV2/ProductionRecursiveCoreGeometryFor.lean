...
import Nightstream.Implementation.NebulaV2.ProductionFieldNativeCompactChainRowsFor
...
namespace Nightstream.Implementation.NebulaV2.ProductionRecursiveCoreGeometryFor
...
theorem productNifsRows_25 : productNifsRows 25 = 18893630 := by
  rw [productNifsRows,
...
theorem productNifsRows_26 : productNifsRows 26 = 18908809 := by
  rw [productNifsRows,
...
theorem knownCoreRows_25_table :
    knownCoreRows .e1 25 = 34142771 /\
      knownCoreRows .e4 25 = 34343966 /\
      knownCoreRows .e8 25 = 34612426 /\
      knownCoreRows .e16 25 = 35149346 := by
...
theorem knownCoreRows_26_table :
    knownCoreRows .e1 26 = 34158302 /\
      knownCoreRows .e4 26 = 34359497 /\
      knownCoreRows .e8 26 = 34627957 /\
      knownCoreRows .e16 26 = 35164877 := by
...
end Nightstream.Implementation.NebulaV2.ProductionRecursiveCoreGeometryFor
