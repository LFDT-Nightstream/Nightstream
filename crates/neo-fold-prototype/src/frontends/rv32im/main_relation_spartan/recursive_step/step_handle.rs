...
use crate::frontends::rv32im::main_relation_spartan::digest32_as_spartan_fields;
use crate::spartan_backend::SpartanF;
use crate::superneo_circuit::transcript::hash_field_linear_combinations_raw;

pub(in crate::frontends::rv32im::main_relation_spartan) fn fixed_shape_recursive_step_handle_digest_circuit<
...
pub(in crate::frontends::rv32im::main_relation_spartan) fn fixed_shape_recursive_step_handle_digest_circuit_from_vars<
    CS: ConstraintSystem<SpartanF>,
>(
    cs: &mut CS,
    label: &str,
