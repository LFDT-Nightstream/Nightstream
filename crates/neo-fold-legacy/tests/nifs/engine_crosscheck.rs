...
use neo_fold_legacy::paper::relations::{CeClaim, LaneRanges, LaneScheme};
use neo_fold_legacy::stage1::{
...
fn nonzero_pi_ccs_messages_map_to_the_lean_package_without_offsets() {
    ...
    let outputs = (0..PI_CCS_V1_1_SOURCE_COUNT)
        ...
        .collect();
    let proof = neo_fold_legacy::paper::pi_ccs::Proof {
        sumcheck: neo_fold_legacy::paper::pi_ccs::SumcheckProof::new(rounds.clone()),
        outputs,
    };
...
impl NifsProverAdapter for PassThroughOptimized {
    ...
    ) -> Result<(RunningInstance, NifsProof), neo_fold_legacy::paper::nifs::Error> {
