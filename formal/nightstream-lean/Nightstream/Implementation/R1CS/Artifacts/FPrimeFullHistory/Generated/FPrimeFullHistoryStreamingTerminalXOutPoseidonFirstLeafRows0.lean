...
/-! Generated exact final ports for first terminal XOut Poseidon2 rows 0 through 43. -/
...
def rawRow00 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 15504881541687065233 }], geometric := [{ slot := .externalA 0, initial := 6, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow01 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 2212164859571129136 }], geometric := [{ slot := .externalA 0, initial := 4, ratio := 3 }, { slot := .externalA 1, initial := 6, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow02 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 1885257223407646669 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 4, ratio := 3 }, { slot := .externalA 2, initial := 6, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow03 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 17531637489452206730 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 4, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow04 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 16769640730920103088 }], geometric := [{ slot := .externalA 0, initial := 3, ratio := 3 }, { slot := .externalA 1, initial := 1, ratio := 3 }, { slot := .externalA 2, initial := 1, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow05 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 445908669775387344 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 3, ratio := 3 }, { slot := .externalA 2, initial := 1, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow06 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 1308472043793046449 }], geometric := [{ slot := .externalA 0, initial := 1, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 3, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow07 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 17465001504763069685 }], geometric := [{ slot := .externalA 0, initial := 1, ratio := 3 }, { slot := .externalA 1, initial := 1, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
