...
use neo_fold_legacy::frontends::f_prime::image::{
    FPrimeImage, FPrimeImageConfig, FPrimeImageLayout, PoseidonPreimageLaneSource, PoseidonTransitionEnforcement,
    StateOut,
};
use neo_fold_legacy::frontends::f_prime::structure::build_f_prime_structure;
...
fn honest_image() -> (FPrimeImageLayout, FPrimeImage, [F; PREIMAGE_LEN]) {
    ...
    let state_in = neo_fold_legacy::frontends::f_prime::image::StateIn {
...
fn phase_1_4d_a4_enforcement_adds_lifted_rows_plus_variable_absorb_rows() {
    ...
    let variable_absorb_rows = absorbs * neo_fold_legacy::engine::ccs_native::poseidon2::POSEIDON2_WIDTH;
...
fn phase_1_4d_a4_tampered_internal_trace_lane_trips_round_constraint() {
    ...
    // absorb-binding row.
    use neo_fold_legacy::engine::ccs_native::poseidon2::POSEIDON2_WIDTH;
