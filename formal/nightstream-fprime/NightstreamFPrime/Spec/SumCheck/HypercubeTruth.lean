...
/-! Provenance: copied from `formal/nightstream-lean/Nightstream/SuperNeo/SumCheck/HypercubeTruth.lean`
...
namespace NightstreamFPrime.Spec.SumCheck.Finite.HypercubeTruth
