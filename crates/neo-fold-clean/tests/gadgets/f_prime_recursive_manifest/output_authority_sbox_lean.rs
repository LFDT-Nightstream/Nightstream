...
//! | calls | 17 call geometries | order, range, 600-row/column ABI | `CallGeometry.Valid` |
...
const EXPECTED_CANDIDATES: usize = 1_462;
const EXPECTED_LINEAR_USES: usize = 11_696;
const EXPECTED_TOTAL_USES: usize = 13_158;
