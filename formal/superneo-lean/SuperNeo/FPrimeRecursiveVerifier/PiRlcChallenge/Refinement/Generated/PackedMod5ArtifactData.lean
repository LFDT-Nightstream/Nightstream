import SuperNeo.FPrimeRecursiveVerifier.PiRlcChallenge.Refinement.PackedMod5ArtifactSchema
...
namespace SuperNeo.FPrimeRecursiveVerifier.PiRlcChallenge.PackedMod5ArtifactData
...
,   ⟨[⟨.quotient, 1⟩, ⟨(SourceRole.quotientBit 0), -1⟩, ⟨(SourceRole.quotientBit 1), -2⟩, ⟨(SourceRole.quotientBit 2), -4⟩, ⟨(SourceRole.quotientBit 3), -8⟩, ⟨(SourceRole.quotientBit 4), -16⟩, ⟨(SourceRole.quotientBit 5), -32⟩, ⟨(SourceRole.quotientBit 6), -64⟩, ⟨(SourceRole.quotientBit 7), -128⟩, ⟨(SourceRole.quotientBit 8), -256⟩, ⟨(SourceRole.quotientBit 9), -512⟩, ⟨(SourceRole.quotientBit 10), -1024⟩, ⟨(SourceRole.quotientBit 11), -2048⟩, ⟨(SourceRole.quotientBit 12), -4096⟩, ⟨(SourceRole.quotientBit 13), -8192⟩],
    [⟨.one, 1⟩],
    []⟩
,   ⟨[⟨(SourceRole.chunkBit 0), 1⟩, ⟨(SourceRole.chunkBit 1), 2⟩, ⟨(SourceRole.chunkBit 2), 4⟩, ⟨(SourceRole.chunkBit 3), 8⟩, ⟨(SourceRole.chunkBit 4), 16⟩, ⟨(SourceRole.chunkBit 5), 32⟩, ⟨(SourceRole.chunkBit 6), 64⟩, ⟨(SourceRole.chunkBit 7), 128⟩, ⟨(SourceRole.chunkBit 8), 256⟩, ⟨(SourceRole.chunkBit 9), 512⟩, ⟨(SourceRole.chunkBit 10), 1024⟩, ⟨(SourceRole.chunkBit 11), 2048⟩, ⟨(SourceRole.chunkBit 12), 4096⟩, ⟨(SourceRole.chunkBit 13), 8192⟩, ⟨(SourceRole.chunkBit 14), 16384⟩, ⟨(SourceRole.chunkBit 15), 32768⟩, ⟨.index, -1⟩, ⟨.quotient, -5⟩],
    [⟨.one, 1⟩],
    []⟩
]
...
def canonicalResidues : List CanonicalResidue :=
  [ { index := 0, left := -1, right := -1 }
, { index := 1, left := -1, right := 0 }
, { index := 2, left := 0, right := 0 }
, { index := 3, left := 1, right := 0 }
, { index := 4, left := 1, right := 1 } ]
...
, { role := .residueLeft, index := 46 }
, { role := .residueRight, index := 47 } ]
...
end SuperNeo.FPrimeRecursiveVerifier.PiRlcChallenge.PackedMod5ArtifactData
