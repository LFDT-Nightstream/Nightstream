...
pub(crate) struct Rv32imOpeningConvergenceArtifactBuildPerf {
...
fn opened_commitment_public_digest_from_root_digest(
    ...
    let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/final/opened_commitment");
    tr.append_message(
        b"neo.fold.next/rv32im/opening_convergence/final/opened_commitment/opened_object_digest",
        &opened_object.digest,
    );
    tr.append_message(
        b"neo.fold.next/rv32im/opening_convergence/final/opened_commitment/commitment_root_digest",
        &commitment_root_digest,
    );
    tr.digest32()
}
...
fn opening_proof_digest_from_witness_rows(packed_columns: &[AjtaiPackedColumnWitness]) -> [u8; 32] {
    let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/final/opening_proof");
    tr.append_u64s(
        b"neo.fold.next/rv32im/opening_convergence/final/opening_proof/packed_column_count",
        &[packed_columns.len() as u64],
    );
    for column in packed_columns {
        tr.append_u64s(
            b"neo.fold.next/rv32im/opening_convergence/final/opening_proof/packed_column_meta",
            &[column.column_index as u64, column.rows.len() as u64],
        );
        tr.append_fields_iter(
            b"neo.fold.next/rv32im/opening_convergence/final/opening_proof/packed_column_rows",
...
impl FinalOpeningTarget {
    pub fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/final/target");
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/final/target/reduced_claim_digest",
            &self.reduced_claim.expected_digest(),
        );
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/final/target/opened_commitment_digest",
            &self.opened_commitment.digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/final/target/opening_proof_digest",
...
fn compact_final_opening_target_digest_from_reduced_claim_digest(
    ...
    let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/compact_final_target");
    tr.append_message(
        b"neo.fold.next/rv32im/opening_convergence/compact_final_target/reduced_claim_digest",
        &reduced_claim_digest,
    );
    tr.append_message(
        b"neo.fold.next/rv32im/opening_convergence/compact_final_target/opened_commitment_digest",
        &opened_commitment_digest,
    );
    tr.append_message(
        b"neo.fold.next/rv32im/opening_convergence/compact_final_target/opening_proof_digest",
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imOpeningConvergenceProof {
    pub phase0_binding_surface: Rv32imPhase0BindingSurface,
    pub phase0: Rv32imEvalClaimBundle,
...
impl Rv32imOpeningConvergenceProof {
    pub fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/final_bundle");
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/final_bundle/phase0_binding_surface_digest",
            &self.phase0_binding_surface.digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/final_bundle/phase0_digest",
            &self.phase0.digest,
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/opening_convergence/final_bundle/phase1_count",
            &[self.phase1_results.len() as u64],
        );
        for result in &self.phase1_results {
            tr.append_message(
                b"neo.fold.next/rv32im/opening_convergence/final_bundle/phase1_result_digest",
                &result.expected_digest(),
            );
        }
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/final_bundle/phase2_digest",
            &self.phase2.digest,
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/opening_convergence/final_bundle/final_opening_count",
            &[self.final_openings.len() as u64],
        );
        for target in &self.final_openings {
            tr.append_message(
                b"neo.fold.next/rv32im/opening_convergence/final_bundle/final_opening_target_digest",
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imOpeningConvergenceArtifact {
    pub phase0_binding_surface: Rv32imPhase0BindingSurface,
...
impl Rv32imOpeningConvergenceArtifact {
    pub fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/compact_artifact");
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/compact_artifact/phase0_binding_surface_digest",
            &self.phase0_binding_surface.digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/compact_artifact/phase0_digest",
            &self.phase0_digest,
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/opening_convergence/compact_artifact/phase1_count",
            &[self.phase1_results.len() as u64],
        );
        for result in &self.phase1_results {
            tr.append_message(
                b"neo.fold.next/rv32im/opening_convergence/compact_artifact/phase1_result_digest",
                &result.expected_digest(),
            );
        }
        tr.append_message(
            b"neo.fold.next/rv32im/opening_convergence/compact_artifact/phase2_digest",
            &self.phase2.digest,
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/opening_convergence/compact_artifact/final_opening_count",
            &[self.final_openings.len() as u64],
        );
        for target in &self.final_openings {
            tr.append_message(
                b"neo.fold.next/rv32im/opening_convergence/compact_artifact/final_opening_target_digest",
                &target.digest,
            );
        }
        tr.digest32()
...
pub fn build_rv32im_opening_convergence_proof_from_witnesses(
    phase0_binding_surface: &Rv32imPhase0BindingSurface,
    claim_witnesses: &[FamilyEvalClaimWitness],
) -> Result<Rv32imOpeningConvergenceProof, FinalOpeningError> {
    let phase0 = Rv32imEvalClaimBundle::new(
        claim_witnesses
            .iter()
    ...
    let proof = Rv32imOpeningConvergenceProof {
    ...
    Ok(Rv32imOpeningConvergenceProof {
        digest: proof.expected_digest(),
        ..proof
    })
}

pub fn build_rv32im_opening_convergence_artifact_from_witnesses(
    phase0_binding_surface: &Rv32imPhase0BindingSurface,
    claim_witnesses: &[FamilyEvalClaimWitness],
) -> Result<Rv32imOpeningConvergenceArtifact, FinalOpeningError> {
    let phase0 = Rv32imEvalClaimBundle::new(
        claim_witnesses
            .iter()
            .map(|witness| witness.claim.clone())
...
pub(crate) fn build_rv32im_opening_convergence_artifact_from_phase0_bundle_and_witnesses_trusted_local(
    phase0_binding_surface: &Rv32imPhase0BindingSurface,
    phase0: &Rv32imEvalClaimBundle,
    claim_witnesses: &[FamilyEvalClaimWitness],
) -> Result<Rv32imOpeningConvergenceArtifact, FinalOpeningError> {
    let (artifact, _) =
...
pub(crate) fn build_rv32im_opening_convergence_artifact_from_phase0_bundle_and_witnesses_trusted_local_with_perf(
    phase0_binding_surface: &Rv32imPhase0BindingSurface,
    phase0: &Rv32imEvalClaimBundle,
    claim_witnesses: &[FamilyEvalClaimWitness],
) -> Result<
    (
        Rv32imOpeningConvergenceArtifact,
        Rv32imOpeningConvergenceArtifactBuildPerf,
    ),
    FinalOpeningError,
> {
    ...
    let artifact = Rv32imOpeningConvergenceArtifact {
        phase0_binding_surface: phase0_binding_surface.clone(),
    ...
    let perf = Rv32imOpeningConvergenceArtifactBuildPerf {
        phase1_results_ms,
        phase2_ms,
        final_openings_ms,
...
pub fn build_rv32im_opening_convergence_artifact_from_proof(
    proof: &Rv32imOpeningConvergenceProof,
) -> Result<Rv32imOpeningConvergenceArtifact, FinalOpeningError> {
    verify_rv32im_opening_convergence_proof(proof)?;
    ...
    Ok(Rv32imOpeningConvergenceArtifact {
        digest: artifact.expected_digest(),
        ..artifact
    })
}

pub fn verify_rv32im_opening_convergence_proof(proof: &Rv32imOpeningConvergenceProof) -> Result<(), FinalOpeningError> {
    validate_phase0_binding_surface(&proof.phase0_binding_surface)?;
    let expected_phase0 =
        Rv32imEvalClaimBundle::new(proof.phase0.claims.clone()).map_err(FinalOpeningError::Phase0BundleBuildFailed)?;
...
pub fn verify_rv32im_opening_convergence_artifact(
    artifact: &Rv32imOpeningConvergenceArtifact,
) -> Result<(), FinalOpeningError> {
    validate_phase0_binding_surface(&artifact.phase0_binding_surface)?;
    let reconstructed_phase0 = Rv32imEvalClaimBundle::new(
        artifact
            .phase1_results
            .iter()
...
pub fn verify_rv32im_opening_convergence_artifact_from_proof(
    artifact: &Rv32imOpeningConvergenceArtifact,
    proof: &Rv32imOpeningConvergenceProof,
) -> Result<(), FinalOpeningError> {
    verify_rv32im_opening_convergence_artifact(artifact)?;
    let expected = build_rv32im_opening_convergence_artifact_from_proof(proof)?;
...
fn validate_phase0_binding_surface(surface: &Rv32imPhase0BindingSurface) -> Result<(), FinalOpeningError> {
