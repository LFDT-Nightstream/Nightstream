...
use neo_fold_legacy::paper::relations::{CcsInstance, LaneRanges, LaneScheme, Structure};
use neo_math::{D, F};
...
fn verify_fold(
    prep: &Preprocessing,
    fresh_claims: &[neo_fold_legacy::paper::relations::CcsClaim],
...
fn rho_authority_binds_adv_once_at_pi_ccs_input() {
    ...
    assert_ne!(
        neo_fold_legacy::paper::digest::ccs_claim_digest(&with_adv.claim),
        neo_fold_legacy::paper::digest::ccs_claim_digest(&without_adv.claim),
    ...
    assert_eq!(
        neo_fold_legacy::paper::digest::pi_ccs_outputs_digest(&proof_a.pi_ccs.outputs),
        neo_fold_legacy::paper::digest::pi_ccs_outputs_digest(&outputs_without),
