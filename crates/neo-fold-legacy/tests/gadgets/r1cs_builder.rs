...
use neo_fold_legacy::engine::r1cs_circuit::boolean::{enforce_bit, enforce_low_norm};
use neo_fold_legacy::engine::r1cs_circuit::field_ext::{enforce_k_mul, KLc, KVar};
use neo_fold_legacy::engine::r1cs_circuit::ring_action::alloc_and_enforce_ring_mul;
...
fn ring_mul_toom3_circuit_matches_native_with_lower_row_count() {
    use neo_fold_legacy::engine::r1cs_circuit::ring_action::alloc_and_enforce_ring_mul_toom3;
...
fn ring_mul_circuit_rejects_tampered_rho_coefficient() {
    ...
    use neo_fold_legacy::engine::r1cs_circuit::ring_action::enforce_ring_mul;
    let rho_vals = cf(rho);
    let c_vals = cf(c);
