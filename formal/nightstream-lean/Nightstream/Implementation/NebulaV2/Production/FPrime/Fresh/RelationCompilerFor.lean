...
import Nightstream.Implementation.NebulaV2.NIFS.Core.ConcreteFor
import Nightstream.Implementation.NebulaV2.Production.FPrime.Fresh.LinearSubstitution
...
namespace Nightstream.Implementation.NebulaV2.ProductionFreshRelationCompilerFor
...
def relationProfile
  ...
  publicFits := by
    ...
    have public270 : 270 ≤ logicalWidth privateWidth :=
      Nat.le_trans (by decide) public540
    simpa [ringDegree,
      Nightstream.SuperNeo.Concrete.Phi81Relation.FPrimeCarrier270.publicRingColumns,
      logicalWidth_carrier_exact] using public270
...
def cubeLayout
  ...
  PrefixLayout.layout rowVariables
    (Phi81CarrierLayout.carrierWidth (logicalWidth privateWidth))
...
end Nightstream.Implementation.NebulaV2.ProductionFreshRelationCompilerFor
