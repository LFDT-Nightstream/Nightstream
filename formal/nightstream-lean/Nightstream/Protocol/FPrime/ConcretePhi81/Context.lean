...
| `fprime.zero_arity.branch.recursive.nifs.setup` | key, alignment, canonical production dimensions, BlockLane schedule, sampler, and profile are template-owned | verifier setup | `Template` |
-/
