...
use super::super::final_ce::{measure_direct_final_ce_relation_breakdown, DirectFinalCeRelationBreakdown};
use super::super::snark::{DirectCcsIvcSnark, DirectCcsIvcSnarkVerifierKey};
use super::super::terminal_committed::{
...
use super::super::terminal_measure::{measure_direct_ccs_f_prime_constraints, DirectCcsFPrimeConstraintBreakdown};
use super::{DirectCcsFPrimeCircuit, DirectCcsFPrimeSnarkError, DirectCcsFPrimeSnarkPerf, DirectCcsFPrimeSnarkProof};

pub(super) fn prove_direct_ccs_f_prime_circuit(
...
fn measure_terminal_shape(
    terminal_circuit: &super::DirectCcsTerminalFPrimeCircuit,
    emit: &mut dyn FnMut(&str),
...
struct TerminalProofPackage {
    proof: super::super::terminal_committed::DirectCcsTerminalCommittedProof,
    pcs_ms: f64,
    prove_ms: f64,
}
