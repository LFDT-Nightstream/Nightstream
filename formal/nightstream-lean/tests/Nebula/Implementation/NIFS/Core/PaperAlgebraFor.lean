...
namespace tests.NebulaProductPaperAlgebraFor
...
example {logicalWidth : Nat}
    ...
    (running :
      Nightstream.Implementation.Nebula.ProductionFieldNativeFullClaim.Running
        (FullShape 26 logicalWidth publicFits)) :
    (Nightstream.Implementation.Nebula.ProductionFieldNativeFullClaim.runningFields
      running).length = 83212 := by
  rw [Nightstream.Implementation.Nebula.ProductionFieldNativeFullClaim.runningFields_lengthFor
...
end tests.NebulaProductPaperAlgebraFor
