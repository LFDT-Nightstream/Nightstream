...
use neo_fold_prototype::rv32im::audit::audit_rv32im_main_recursion_construction2_pi_fold_debug_dump;
...
fn f_prime_pi_fold_does_not_carry_fiat_shamir_challenges() {
    ...
    let dump = audit_rv32im_main_recursion_construction2_pi_fold_debug_dump(&advices[0]).to_ascii_lowercase();
