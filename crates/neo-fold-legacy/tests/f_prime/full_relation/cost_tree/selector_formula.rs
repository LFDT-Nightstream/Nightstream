...
use neo_fold_legacy::engine::r1cs_circuit::builder::BALANCED_TERNARY_DIGITS;
use neo_fold_legacy::frontends::f_prime::gadget_native::{
    SelectorGatedGadgetNativeCostLayout, SelectorGatedGadgetNativeEstimate,
};
use neo_fold_legacy::frontends::f_prime::low_norm_r1cs::{LowNormR1csEstimate, SelectorGatedR1csEstimate};
...
pub(crate) fn assert_fixed_selector_cost_formula(fixed: &SelectorGatedGadgetNativeEstimate) {
    ...
    let ordinary_coordinates =
        ordinary_slots * neo_fold_legacy::frontends::f_prime::gadget_native::ORDINARY_PRIVATE_DIGITS;
    let balanced_slots =
...
fn selector_gated_layout_partitions_every_fixed_column(fixed: &SelectorGatedGadgetNativeEstimate) {
    ...
    assert_eq!(
        ...
        [
            ...
            ("ordinary_private", 5_509_750..9_713_890),
            ("balanced_ternary", 9_713_890..12_476_552),
            ("packed_mod5_residues", 12_476_552..12_478_472),
            ("canonical_source_raw", 12_478_472..12_478_600),
            ("canonical_source_prefix", 12_478_600..12_478_662),
            ("canonical_ring_raw", 12_478_662..12_478_662),
            ("canonical_ring_prefix", 12_478_662..12_478_662),
            ("canonical_product_sum_raw", 12_478_662..12_617_542),
            ("canonical_product_sum_prefix", 12_617_542..12_684_812),
        ],
