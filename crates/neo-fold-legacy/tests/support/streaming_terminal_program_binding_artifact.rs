...
use neo_fold_legacy::paper::f_prime::nebula_lane_circuit::enforce_nebula_program_binding_digest_circuit;
use neo_math::F;
...
fn reference_relation(
    full_source: &neo_fold_legacy::engine::r1cs_circuit::R1csSnapshot,
    full_lane: [usize; 50],
    constant_values: &[u64],
) -> (neo_fold_legacy::engine::r1cs_circuit::R1csSnapshot, [usize; 4]) {
