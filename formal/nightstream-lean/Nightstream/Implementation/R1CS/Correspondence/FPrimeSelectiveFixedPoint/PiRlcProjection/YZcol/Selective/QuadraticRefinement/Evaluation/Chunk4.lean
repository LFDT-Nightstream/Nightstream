...
/-!
Executable evaluation-group certificate shard 4.
...
|---|---|---|
| evaluation shard 4 | every pair in this slice matches its independent target | checked |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk4
...
def pairs : List EvaluationPair :=
  (evaluationPairs.drop 28).take 7
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk4
