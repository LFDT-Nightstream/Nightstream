...
/-!
Executable evaluation-group certificate shard 6.
...
|---|---|---|
| evaluation shard 6 | every pair in this slice matches its independent target | checked |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk6
...
def pairs : List EvaluationPair :=
  (evaluationPairs.drop 42).take 7
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk6
