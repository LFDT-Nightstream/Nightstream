...
def occurrences : List Occurrence := [
    { sourceRow := 36760, side := .a, coefficient := 18446744069414584320, family := "fprime.base.verifier_key" },
    { sourceRow := 46436, side := .a, coefficient := 18446744069414584320, family := "fprime.base.verifier_key" },
    { sourceRow := 48864, side := .a, coefficient := 18446744069414584320, family := "fprime.base.verifier_key" },
  ]
...
def rawArtifact : Nightstream.Implementation.R1CS.FPrimeFullHistoryStreamingLifecycleBaseVerifierKeyOmission.Artifact.RawArtifact :=
  { schemaVersion := 1,
    ...
    family := "fprime.base.verifier_key", stagePath := "fprime.base.verifier_key", occurrence := 7,
    sourceRows := { start := 36133, stop := 50723 }, sourceColumns := { start := 36007, stop := 50543 },
    sourceRowCount := 741068, selectedRowCount := 14590, retainedRowCount := 726478,
    columnCount := 740549, constantOneColumn := 0, changedColumn := 36007,
    baselineValue := 4688330738293476679, candidateValue := 1,
    finalRowCount := 10306243, sourceRuns := sourceRuns, finalRuns := finalRuns,
...
theorem occurrences_owned : OccurrenceOwnership "fprime.base.verifier_key" occurrences :=
by
  unfold occurrences
  exact OccurrenceOwnership.cons rfl
    (OccurrenceOwnership.cons rfl
    (OccurrenceOwnership.cons rfl
    (OccurrenceOwnership.nil)))
