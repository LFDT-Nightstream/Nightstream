...
use crate::layout::{
    ...
    COL_EVBUF_SLOT1_BEFORE, COL_EVBUF_SLOT2_BEFORE, COL_EVBUF_SLOT3_BEFORE, COL_HALTED_BEFORE,
    COL_HOST_ARGS_ACTIVE_BEFORE,
    COL_HOST_ARGS_REMAINING_BEFORE, COL_HOST_CALLEE_FREF_BEFORE, COL_HOST_RESULT_PENDING_BEFORE, COL_LOCALS_FBP_BEFORE,
    COL_MAX_MEMORY_PAGES_BEFORE, COL_MEMORY_PAGES_BEFORE, COL_OUTPUT_ENABLED_BEFORE, COL_OUTPUT_VALUE_HI_BEFORE,
    COL_OUTPUT_VALUE_LO_BEFORE, COL_PARAM_INIT_ACTIVE_BEFORE, COL_PARAM_INIT_REMAINING_BEFORE, COL_PC_BEFORE,
    COL_PERM_PENDING_BEFORE, COL_PERM_ROUND_BEFORE, COL_PERM_STATE0_BEFORE, COL_PERM_STATE10_BEFORE,
    COL_PERM_STATE11_BEFORE, COL_PERM_STATE1_BEFORE, COL_PERM_STATE2_BEFORE, COL_PERM_STATE3_BEFORE,
    COL_PERM_STATE4_BEFORE, COL_PERM_STATE5_BEFORE, COL_PERM_STATE6_BEFORE, COL_PERM_STATE7_BEFORE,
    COL_PERM_STATE8_BEFORE, COL_PERM_STATE9_BEFORE, COL_SP_BEFORE, COL_TRAPPED_BEFORE,
};
