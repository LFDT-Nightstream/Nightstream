...
fn print_constraint_breakdown(
    ...
    if let Some(spartan_perf) = spartan_perf {
        ...
        println!(
            ...
            terminal.r1cs.sizes[4].saturating_sub(terminal.r1cs.sizes[0]),
            100.0 * terminal.r1cs.sizes[4].saturating_sub(terminal.r1cs.sizes[0]) as f64
                / terminal.r1cs.sizes[0].max(1) as f64
        );
        println!(
