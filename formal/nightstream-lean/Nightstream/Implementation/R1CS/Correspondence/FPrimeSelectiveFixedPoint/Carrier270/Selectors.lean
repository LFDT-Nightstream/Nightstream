...
def constantColumn : Fin 14338890 :=
  ⟨0, by decide⟩

def selectorColumn (arm : Fin 3) : Fin 14338890 :=
  ⟨270 + arm.val, by omega⟩

def expectedSelectorDecodedPort (arm : Fin 3)
    (port : Fin 13) : DecodedPort 14338890 :=
  if port.val = 0 then
    unitDecodedPort 14338890 (selectorColumn arm).val
      (selectorColumn arm).isLt
  else if port.val = 1 then
    unitDecodedPort 14338890 constantColumn.val
      constantColumn.isLt
  else
    emptyDecodedPort 14338890
...
theorem expectedSelectorRow_decode_exact
  ...
  have emittedBound : arm.val < 17669277 := by
...
def decodedFirstSelectorTerm : DecodedTerm 14338890 :=
  canonicalDecodedTerm 14338890 270 1 (by decide) (by decide) (by decide)

def decodedSecondSelectorTerm : DecodedTerm 14338890 :=
  canonicalDecodedTerm 14338890 271 1 (by decide) (by decide) (by decide)

def decodedThirdSelectorTerm : DecodedTerm 14338890 :=
  canonicalDecodedTerm 14338890 272 1 (by decide) (by decide) (by decide)

def decodedNegativeOneTerm : DecodedTerm 14338890 :=
  canonicalDecodedTerm 14338890 constantColumn.val
    Artifact.negativeOneWord constantColumn.isLt (by decide)
      negativeOne_nonzero

def expectedTotalCDecodedPort : DecodedPort 14338890 :=
  { explicit :=
...
private theorem decodeTotalCPort :
  ...
  have decodedNegative :=
    decodeTerm_canonical 14338890 0
      Artifact.negativeOneWord (by decide) (by decide)
        negativeOne_nonzero
  have decodedFirst :=
    decodeTerm_canonical 14338890 270 1
      (by decide) (by decide) (by decide)
  have decodedSecond :=
    decodeTerm_canonical 14338890 271 1
      (by decide) (by decide) (by decide)
  have decodedThird :=
    decodeTerm_canonical 14338890 272 1
      (by decide) (by decide) (by decide)
  unfold decodePort
...
private theorem expectedTotalPort_decode_exact (port : Fin 13) :
    decodePort 14338890 (Artifact.totalPort port) =
...
theorem expectedSelectorDecodedRow_shape
  ...
  · change
    ...
    exact expandedFieldTerms_unit 14338890 (selectorColumn arm).val
      (selectorColumn arm).isLt
  · change
      expandedFieldTerms
    ...
    rw [show expectedSelectorDecodedPort arm (1 : Fin 13) =
      ...
      simp [expectedSelectorDecodedPort]]
    exact expandedFieldTerms_unit 14338890 constantColumn.val
      constantColumn.isLt
  · intro port bitNe generalNe
    ...
    rw [show expectedSelectorDecodedPort arm port =
        emptyDecodedPort 14338890 by
      simp [expectedSelectorDecodedPort, notZero, notOne]]
    exact expandedFieldTerms_empty 14338890
...
theorem expectedTotalDecodedRow_shape :
  ...
  · intro port generalNe cNe
    ...
    rw [show expectedTotalDecodedPort port = emptyDecodedPort 14338890 by
...
def GeneratedRowsSatisfied
    (assignment : Fin 14338890 → F) : Prop :=
  (∀ arm : Fin 3,
      RowSatisfied (expectedSelectorDecodedRow arm) assignment) ∧
    RowSatisfied expectedTotalDecodedRow assignment
