//! Owns compact selected-opening and kernel-opening claim surfaces for the RV32IM simple kernel.
...
impl Stage1OpeningPoints {
    ...
    fn append_digest_material(&self, tr: &mut Poseidon2Transcript) {
        tr.append_u64s(b"rv32im/stage_opening_points/variant", &[0]);
        append_labeled_opening_ref(
            tr,
            b"rv32im/stage_opening_points/tag",
            b"rv32im/stage_opening_points/label",
            b"rv32im/stage_opening_points/present",
            b"rv32im/stage_opening_points/opening_id",
            b"rv32im/stage_opening_points/value_digest",
            OpeningPointLabel::Stage1First,
            Some(&self.first),
        );
        append_labeled_opening_ref(
...
impl Stage2OpeningPoints {
    ...
    fn append_digest_material(&self, tr: &mut Poseidon2Transcript) {
        tr.append_u64s(b"rv32im/stage_opening_points/variant", &[1]);
...
impl Stage3OpeningPoints {
    ...
    fn append_digest_material(&self, tr: &mut Poseidon2Transcript) {
        tr.append_u64s(b"rv32im/stage_opening_points/variant", &[2]);
        for (label, reference) in [
...
impl KernelBindingOpeningPoints {
    ...
    fn append_digest_material(&self, tr: &mut Poseidon2Transcript) {
        tr.append_u64s(b"rv32im/kernel_binding_opening_points/variant", &[0]);
        for (label, reference) in [
            ...
            append_labeled_opening_ref(
                tr,
                b"rv32im/kernel_binding_opening_points/tag",
                b"rv32im/kernel_binding_opening_points/label",
                b"rv32im/kernel_binding_opening_points/present",
                b"rv32im/kernel_binding_opening_points/opening_id",
                b"rv32im/kernel_binding_opening_points/value_digest",
                label,
                reference,
            );
        }
...
impl KernelPreparedStepOpeningPoints {
    ...
    fn append_digest_material(&self, tr: &mut Poseidon2Transcript) {
        tr.append_u64s(b"rv32im/kernel_prepared_step_opening_points/variant", &[1]);
        for (label, reference) in [
            (
            ...
            append_labeled_opening_ref(
                tr,
                b"rv32im/kernel_prepared_step_opening_points/tag",
                b"rv32im/kernel_prepared_step_opening_points/label",
                b"rv32im/kernel_prepared_step_opening_points/present",
                b"rv32im/kernel_prepared_step_opening_points/opening_id",
                b"rv32im/kernel_prepared_step_opening_points/value_digest",
                label,
                reference,
            );
        }
...
impl Stage1SelectedOpeningClaim {
    ...
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_selected_opening_claim");
        tr.append_message(b"rv32im/stage_selected_opening_claim/label", b"rv32im/stage1");
        tr.append_message(
            b"rv32im/stage_selected_opening_claim/stage1_rows_family",
            &self.rows_family_digest,
        );
        tr.append_u64s(
            b"rv32im/stage_selected_opening_claim/meta_words",
            &[
                self.row_count,
                self.effect_row_count,
                self.commit_row_count,
...
impl Stage2SelectedOpeningClaim {
    ...
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_selected_opening_claim");
        tr.append_message(b"rv32im/stage_selected_opening_claim/label", b"rv32im/stage2");
        tr.append_message(
            b"rv32im/stage_selected_opening_claim/register_reads_family",
            &self.register_reads_family_digest,
        );
        tr.append_message(
            b"rv32im/stage_selected_opening_claim/register_writes_family",
            &self.register_writes_family_digest,
        );
        tr.append_message(
            b"rv32im/stage_selected_opening_claim/ram_events_family",
            &self.ram_events_family_digest,
        );
        tr.append_message(
            b"rv32im/stage_selected_opening_claim/twist_links_family",
...
impl Stage3SelectedOpeningClaim {
    ...
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_selected_opening_claim");
        tr.append_message(b"rv32im/stage_selected_opening_claim/label", b"rv32im/stage3");
        tr.append_message(
            b"rv32im/stage_selected_opening_claim/continuity_family",
...
fn packaged_opening_proof_digest(claim_digest: [u8; 32], packaged: &PackagedProof) -> [u8; 32] {
    let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_packaged_opening_claim_proof");
    tr.append_fields(
...
impl SimpleKernelStagePackageBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        ...
        tr.append_message(b"rv32im/stage_package_bundle/stage1", &self.stage1.digest);
        tr.append_message(b"rv32im/stage_package_bundle/stage2", &self.stage2.digest);
        tr.append_message(b"rv32im/stage_package_bundle/stage3", &self.stage3.digest);
        tr.digest32()
    }
}
...
impl KernelBindingOpeningClaim {
    ...
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_binding_opening_claim");
        tr.append_message(
            b"rv32im/kernel_binding_opening_claim/stage_claim_bundle",
            &self.stage_claim_bundle_digest,
        );
        tr.append_message(
            b"rv32im/kernel_binding_opening_claim/stage_package_bundle",
            &self.stage_package_bundle_digest,
        );
        tr.append_message(
            b"rv32im/kernel_binding_opening_claim/stage1_package",
            &self.stage1_package_digest,
        );
        tr.append_message(
            b"rv32im/kernel_binding_opening_claim/stage2_package",
            &self.stage2_package_digest,
        );
        tr.append_message(
            b"rv32im/kernel_binding_opening_claim/stage3_package",
            &self.stage3_package_digest,
        );
        tr.append_message(
            b"rv32im/kernel_binding_opening_claim/prepared_step_bindings",
            &self.prepared_step_bindings_digest,
        );
        tr.append_u64s(
            b"rv32im/kernel_binding_opening_claim/meta_words",
            &[
                self.binding_count,
                self.stage1_row_count,
                self.stage2_register_read_count,
...
impl KernelPreparedStepOpeningClaim {
    ...
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_prepared_step_opening_claim");
        tr.append_message(
            b"rv32im/kernel_prepared_step_opening_claim/execution_digest",
            &self.execution_digest,
        );
        tr.append_message(
            b"rv32im/kernel_prepared_step_opening_claim/final_state_digest",
            &self.final_state_digest,
        );
        tr.append_message(
            b"rv32im/kernel_prepared_step_opening_claim/transcript_final_digest",
            &self.transcript_final_digest,
        );
        tr.append_u64s(
            b"rv32im/kernel_prepared_step_opening_claim/meta_words",
...
impl SimpleKernelOpeningClaim {
    ...
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        ...
        tr.append_message(
            b"rv32im/kernel_opening_claim/bindings",
            &self.bindings.expected_digest(),
        );
        tr.append_message(
            b"rv32im/kernel_opening_claim/prepared_steps",
...
impl SimpleKernelOpeningBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_opening_bundle");
        tr.append_message(b"rv32im/kernel_opening_bundle/claim_digest", &self.claim.digest);
        tr.append_message(b"rv32im/kernel_opening_bundle/bindings", &self.bindings.digest);
        tr.append_message(
            b"rv32im/kernel_opening_bundle/prepared_steps",
