...
namespace Nightstream.Implementation.R1CS.SelectiveCcs.LeanCompiler.DirectRows
...
end Nightstream.Implementation.R1CS.SelectiveCcs.LeanCompiler.DirectRows
