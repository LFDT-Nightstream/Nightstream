...
use neo_fold_prototype::public_proof::rv32im::side_opening_spartan::setup_rv32im_side_opening_spartan;
...
pub fn source_case(name: &str) -> neo_fold_prototype::rv32im::Rv32imParitySourceCase {
    parity_source_cases()
        .into_iter()
