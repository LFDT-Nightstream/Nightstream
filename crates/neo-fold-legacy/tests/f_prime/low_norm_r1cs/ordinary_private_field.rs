...
use neo_fold_legacy::paper::relations::RelationError;
use neo_math::{D, F};
...
fn ordinary_fixture(
    ...
    neo_fold_legacy::engine::r1cs_circuit::R1csSnapshot,
    neo_fold_legacy::engine::r1cs_circuit::R1csEncodingTrace,
    Vec<usize>,
) {
...
fn fresh_assignment_fixture() -> neo_fold_legacy::frontends::f_prime::gadget_native::EncodedGadgetNativeR1cs {
    let mut builder = R1csBuilder::new();
    builder.enable_encoding_trace();
...
fn fresh_assignment_commitment(
    encoded: &neo_fold_legacy::frontends::f_prime::gadget_native::EncodedGadgetNativeR1cs,
) -> (neo_fold_legacy::Params, AjtaiSModule) {
