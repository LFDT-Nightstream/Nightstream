...
define_column_region! {
    ...
    columns: [
        ...
        COL_STACK_READ0_ACTIVE: Boolean => "stack lane 0 read activity flag",
        COL_STACK_READ1_ACTIVE: Boolean => "stack lane 1 read activity flag",
        COL_STACK_READ2_ACTIVE: Boolean => "stack lane 2 read activity flag",
        ...
        COL_STACK_READ0_ADDR_LO: U32 => "operand-stack read lane 0 low-limb physical address",
        COL_STACK_READ0_ADDR_HI: U32 => "operand-stack read lane 0 high-limb physical address",
        COL_STACK_READ0_VALUE_LO: U32 => "operand-stack read lane 0 value",
        COL_STACK_READ0_VALUE_HI: U32 => "operand-stack read lane 0 high limb for future i64 support",
        COL_STACK_READ1_ADDR_LO: U32 => "operand-stack read lane 1 low-limb physical address",
        COL_STACK_READ1_ADDR_HI: U32 => "operand-stack read lane 1 high-limb physical address",
        COL_STACK_READ1_VALUE_LO: U32 => "operand-stack read lane 1 value",
        COL_STACK_READ1_VALUE_HI: U32 => "operand-stack read lane 1 high limb for future i64 support",
        COL_STACK_READ2_ADDR_LO: U32 => "operand-stack read lane 2 low-limb physical address",
        COL_STACK_READ2_ADDR_HI: U32 => "operand-stack read lane 2 high-limb physical address",
        COL_STACK_READ2_VALUE_LO: U32 => "operand-stack read lane 2 value",
        COL_STACK_READ2_VALUE_HI: U32 => "operand-stack read lane 2 high limb for future i64 support",
