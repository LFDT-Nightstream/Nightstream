...
fn rv32im_mixed_opcode_perf_snapshot() {
    ...
    let side_keys = neo_fold_next::nightstream::rv32im::audit::setup_rv32im_side_binding_cached(
        &side_statement,
    ...
    let side_opening_keys = neo_fold_next::nightstream::rv32im::audit::setup_rv32im_side_opening_spartan_cached(
        &opening_statement,
        &opening_witness,
    )
