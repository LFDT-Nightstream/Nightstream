...
namespace Nightstream.Implementation.Nebula.MemoryProductBalanceBridge
...
theorem mapState_oneProductsK :
    mapState MemoryCarryCodec.oneProductsK =
      (Nightstream.Protocol.Nebula.ProductState.one :
...
end Nightstream.Implementation.Nebula.MemoryProductBalanceBridge
