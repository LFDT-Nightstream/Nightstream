...
namespace Nightstream.Implementation.NebulaV2.ProductConcreteNifs
...
structure RelationArtifact
  ...
  identityFirstEntry : forall
    ...
    (ProductPaperAlgebra.matrixSource system).matrices
      ...
      (PrefixLayout.layout ProductNifsCodec.shape.cubeVariables
...
end Nightstream.Implementation.NebulaV2.ProductConcreteNifs
