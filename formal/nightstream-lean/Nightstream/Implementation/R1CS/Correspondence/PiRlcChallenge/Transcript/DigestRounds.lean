...
abbrev fieldAt := CallRefinement.fieldAt
abbrev callInputState := CallRefinement.callInputState
abbrev callOutputState := CallRefinement.callOutputState
...
theorem callAccepted_permute
  ...
  exact CallRefinement.callAccepted_permute canonical one call absorbed accepted
