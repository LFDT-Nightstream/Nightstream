...
import tests.Nebula.Implementation.Application.Wasm.PublicStatementCodec

set_option autoImplicit false

namespace tests.NebulaStatementAuthority
...
def statement := tests.NebulaWasmPublicStatementCodec.statement
...
end tests.NebulaStatementAuthority
