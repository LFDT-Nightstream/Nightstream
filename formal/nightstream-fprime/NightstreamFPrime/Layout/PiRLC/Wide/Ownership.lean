...
/-!
Owns the total row and column maps for the candidate wide PiRLC layout.
...
namespace NightstreamFPrime.Layout.PiRLC.Wide.Ownership
...
end NightstreamFPrime.Layout.PiRLC.Wide.Ownership
