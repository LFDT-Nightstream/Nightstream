...
theorem oddChunk7_valid :
    ∀ call ∈ oddChunk7,
      PoseidonCallValid 1302326 call ∧ 311846 ≤ call.rowStart := by
  norm_num [oddChunk7, oddTail7, oddTail6, oddTail5, oddTail4, oddTail3, oddTail2,
    oddTail1, oddTail0, PoseidonCallValid, oddArm]

theorem oddTail8_valid :
    ∀ call ∈ oddTail8,
      PoseidonCallValid 1302326 call ∧ 311846 ≤ call.rowStart := by
  norm_num [oddTail8, oddTail7, oddTail6, oddTail5, oddTail4, oddTail3, oddTail2,
    oddTail1, oddTail0, PoseidonCallValid, oddArm]

theorem oddArm_poseidon2Calls_valid : oddArm.Poseidon2CallsValid := by
  unfold RawArm.Poseidon2CallsValid
  change ∀ call ∈ oddTail0,
    PoseidonCallValid 1302326 call ∧ 311846 ≤ call.rowStart
        ...
        (valid_of_take_drop oddChunk3_valid
          (valid_of_take_drop oddChunk4_valid
            (valid_of_take_drop oddChunk5_valid
              (valid_of_take_drop oddChunk6_valid
                (valid_of_take_drop oddChunk7_valid oddTail8_valid)))))))
