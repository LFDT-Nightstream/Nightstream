...
use neo_fold_prototype::core::proof::StepInput;
use neo_fold_prototype::rv32im::ccs::RV32IM_ROOT_ROW_WIDTH;
use neo_fold_prototype::rv32im::kernel::{AjtaiFamilyKind, OpeningPointLabel, SelectedOpeningRef};
...
fn same_public_step(
    lhs: &neo_fold_prototype::core::proof::PublicStep,
    rhs: &neo_fold_prototype::core::proof::PublicStep,
) -> bool {
    lhs.label == rhs.label
...
fn simple_kernel_roundtrip_exports_one_prepared_step_per_execution_row() {
    ...
    let public_steps = output
        ...
        .collect::<Vec<_>>();
    let main_lane_family = neo_fold_prototype::rv32im::kernel::build_main_lane_family_summary(&public_steps);
