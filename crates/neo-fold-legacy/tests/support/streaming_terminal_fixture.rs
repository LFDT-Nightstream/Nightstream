...
use neo_fold_legacy::frontends::nebula::layout::{encode_delayed_f_prime_suffix, NebulaParams, StepPublicInput};
...
use neo_fold_legacy::paper::construction2::{NebulaLane, StackShape};
use neo_fold_legacy::paper::digest::{self, StateXOutDigestMode, StateXOutPreimageInstruction};
use neo_fold_legacy::paper::f_prime::nebula_lane_circuit::NebulaLaneWires;
use neo_fold_legacy::paper::f_prime::stage as fprime_stage;
use neo_fold_legacy::paper::params::Params;
use neo_fold_legacy::paper::relations::product_commitment_circuit::{adv_commitment_data_wires, alloc_adv};
...
pub fn build_streaming_terminal_audit_fixture() -> StreamingTerminalAuditFixture {
    ...
    terminal.record_row_family(
        neo_fold_legacy::frontends::r1cs_f_prime::terminal_r1cs::STREAMING_TERMINAL_R1CS_FAMILY_NAMES[6],
        family_start,
    );
