...
theorem chunkLeaf1 :
    chunkFacts (rowsChunk wire 1) 65536 65536 11187825 11078210
...
theorem censusGroup :
  ...
  by_cases is1 : k = 1
  · subst is1
    exact (chunkFacts_split chunkLeaf1).1
...
theorem wfGroup :
  ...
  by_cases is1 : k = 1
  · subst is1
    exact (chunkFacts_split chunkLeaf1).2.1
  exact absurd upper (by omega)
...
theorem coverGroup :
  ...
  by_cases is1 : k = 1
  · subst is1
    exact (chunkFacts_split chunkLeaf1).2.2.1
  exact absurd upper (by omega)
