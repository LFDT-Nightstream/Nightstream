import Nightstream.Implementation.Nebula.Memory.Transition.OpenSegmentRows
...
namespace Nightstream.Implementation.Nebula.MemoryOpenSegmentSound

open Nightstream.Implementation.Nebula.MemoryCarryCodec
open Nightstream.Implementation.Nebula.MemoryClaimCodec
open Nightstream.Implementation.Nebula.MemoryOpenSegmentRows
...
private theorem rows_sound_of_challenge_exact
  ...
  have timestampRange : before.globalTimestamp < timestampLimit := by
    simpa [timestampLimit, Nightstream.Protocol.Nebula.timestampBits,
...
end Nightstream.Implementation.Nebula.MemoryOpenSegmentSound
