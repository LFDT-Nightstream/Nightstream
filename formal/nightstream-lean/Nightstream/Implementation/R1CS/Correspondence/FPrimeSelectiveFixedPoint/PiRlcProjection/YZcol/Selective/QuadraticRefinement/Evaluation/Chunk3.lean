...
/-!
Executable evaluation-group certificate shard 3.
...
|---|---|---|
| evaluation shard 3 | every pair in this slice matches its independent target | checked |
-/

namespace Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk3
...
def pairs : List EvaluationPair :=
  (evaluationPairs.drop 21).take 7
...
end Nightstream.Implementation.R1CS.FPrimeSelectiveFixedPoint.PiRlcProjection.YZcol.Selective.QuadraticRefinement.Evaluation.Chunk3
