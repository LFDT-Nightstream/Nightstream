...
namespace Nightstream.Assurance.Nebula.PiRlcSamplerSecurity
...
def lifetimeFolds : Nat :=
  Nightstream.Protocol.Nebula.Lifecycle.totalClaims
    Nightstream.Protocol.Nebula.Lifecycle.maximumSegments

/-- Number of independently selected PiRLC coefficient positions per fold. -/
def coefficientsPerFold : Nat :=
  Nightstream.Implementation.Nebula.ProductPiRlcFirstAcceptedBatchRows.coordinateCount

/-- Number of full-field attempts per coefficient position. -/
def attemptsPerCoefficient : Nat :=
  Nightstream.Implementation.Nebula.ProductPiRlcTranscriptRows.attemptCount

theorem exact_schedule :
    lifetimeFolds = 69632 ∧
      coefficientsPerFold = 810 ∧ attemptsPerCoefficient = 3 := by
  exact
    ⟨Nightstream.Protocol.Nebula.Lifecycle.maximum_claim_count,
      Nightstream.Implementation.Nebula.ProductPiRlcFirstAcceptedBatchRows.coordinateCount_eq,
      Nightstream.Implementation.Nebula.ProductPiRlcTranscriptRows.attemptCount_eq⟩
...
end Nightstream.Assurance.Nebula.PiRlcSamplerSecurity
