...
#[derive(Clone, Debug)]
pub(crate) struct DirectCcsTerminalCommittedProofPackage {
    pub(crate) proof: DirectCcsTerminalCommittedProof,
    pub(crate) pcs_ms: f64,
}
...
pub(super) struct DirectCcsTerminalR2Layout {
    ...
    pub(super) sources: Vec<TerminalPrivateColumnEncoding>,
