...
abbrev ProductionContext :=
  DirectCcsFPrime.DirectParentOnlyProductionConcreteFPrimePriorBackendOpening.ProductionContext

/-- Public image for the parent-only production path. -/
abbrev PublicImage :=
  DirectCcsFPrime.DirectParentOnlyProductionConcreteFPrimePriorBackendOpening.PublicImage

/-- Proof-carrying folded prior authority for the induced production context. -/
abbrev ProofCarryingPriorProof :=
  @DirectCcsFPrime.DirectParentOnlyProductionConcreteFPrimePriorBackendOpening.ProofCarryingPriorProof

/-- Structured terminal/boundary public IO returned by the production verifier. -/
abbrev ExactTerminalBoundaryPublicIO :=
  DirectCcsFPrime.DirectParentOnlyProductionConcreteFPrimePriorBackendOpening.ExactTerminalBoundaryPublicIO

/-- Concrete production prior verifier surface used by the F' target. -/
abbrev ConcretePriorVerifierSurface :=
  @DirectCcsFPrime.DirectParentOnlyProductionConcreteFPrimePriorBackendOpening.ConcreteRuntimeExactPublicIOOpeningSurface
...
abbrev ConcreteVerifyPrior
    ...
    Nat →
      ...
      PublicImage Digest Boundary →
        Prop :=
  DirectCcsFPrime.DirectParentOnlyProductionConcreteFPrimePriorBackendOpening.RuntimeVerifyPriorOfRuntimeExactPublicIOChecks
    surface
...
theorem concreteVerifyPrior_opensAuthority
  ...
  rcases
    DirectCcsFPrime.DirectParentOnlyProductionConcreteFPrimePriorBackendOpening.runtimeVerifyPriorOfRuntimeExactPublicIOChecks_acceptedOpens
        surface
        steps
        proof
        image
...
theorem concreteVerifyPrior_openedAuthority_accepts
    ...
    FoldedFPrimeAuthority.Accepts
      ...
      authority
      image :=
  DirectCcsFPrime.DirectParentOnlyProductionConcreteFPrimePriorBackendOpening.runtimeVerifyPriorOfRuntimeExactPublicIOChecks_openedAuthority_accepts_of_open
      surface
      hVerify
      hOpen
