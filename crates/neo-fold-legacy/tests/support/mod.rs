...
use neo_fold_legacy::{config, preprocess, CcsInstance, DecMixer, Params, Preprocessing, RlcMixer, Structure};
...
pub fn empty_f_prime_image_config() -> neo_fold_legacy::frontends::f_prime::image::FPrimeImageConfig {
    use neo_fold_legacy::paper::f_prime::ring_action_trace::{LowNormEncoding, RingActionTraceLayout};

    neo_fold_legacy::frontends::f_prime::image::FPrimeImageConfig {
        limbs: 3,
...
#[allow(dead_code)]
pub fn mutate_ce_claim(claim: &mut neo_fold_legacy::CeClaim) {
