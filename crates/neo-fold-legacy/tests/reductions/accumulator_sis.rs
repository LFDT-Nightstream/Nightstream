...
use neo_fold_legacy::engine::r1cs_circuit::builder::{RowFamilyRange, Var, BALANCED_TERNARY_DIGITS};
use neo_fold_legacy::engine::r1cs_circuit::R1csBuilder;
use neo_fold_legacy::frontends::f_prime::gadget_native::encode_r1cs_gadget_native;
use neo_fold_legacy::frontends::r1cs_f_prime::{
    build_multi_branch_selective_low_norm_r1cs_with_alignment, lower_field_r1cs,
};
use neo_fold_legacy::paper::digest::accumulator_ce_claim_digest;
...
fn forge_alternate_shifted_base3_opening(
    ...
    field: neo_fold_legacy::engine::r1cs_circuit::Var,
    commitment_data: &[neo_fold_legacy::engine::r1cs_circuit::Var],
) {
