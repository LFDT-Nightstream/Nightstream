...
const FINGERPRINT_DOMAIN: &[u8] = b"neo.fold.next/rv32im/main_recursion_step_spartan/fingerprint_cs";
...
pub(super) struct FingerprintCS {
    state: [u64; 4],
    inputs: usize,
    aux: usize,
    constraints: usize,
...
impl FingerprintCS {
    ...
    pub(super) fn public_input_count(&self, num_challenges: usize) -> usize {
        self.inputs.saturating_sub(1 + num_challenges)
    }

    pub(super) fn num_aux(&self) -> usize {
        self.aux
    }
    ...
    pub(super) fn finish_digest32(mut self, num_challenges: usize) -> [u8; 32] {
