...
namespace Nightstream.Implementation.NebulaV2.ProductionProductNifsPublicTranscript
...
noncomputable def publicNifsFields
  ...
  fixedPrefix candidate fullShape degreeBound ++
    ...
    nativeValues
      ((ConcreteNifsCanonicalCodecCore.publicInputCodec fullShape.publicWidth).encode
...
theorem publicNifsFields_lengthFor
  ...
  rw [(ConcreteNifsCanonicalCodecCore.publicInputCodec
...
end Nightstream.Implementation.NebulaV2.ProductionProductNifsPublicTranscript
