...
fn build_coordinate_call(
    ...
    opening_traces: &[neo_fold_legacy::engine::r1cs_circuit::BalancedTernaryOpeningTraceEntry],
...
fn phase_and_chunk_links(
    contract: &neo_fold_legacy::frontends::r1cs_f_prime::OverlayKindLinks,
    synthesis: &NebulaFPrimeClaimCoordinateOverlaySynthesis,
...
fn build_active_arm(
    overlay_kind: usize,
    maps: &[Vec<Vec<(usize, usize)>>; 3],
    contracts: &[neo_fold_legacy::frontends::r1cs_f_prime::OverlayKindLinks],
