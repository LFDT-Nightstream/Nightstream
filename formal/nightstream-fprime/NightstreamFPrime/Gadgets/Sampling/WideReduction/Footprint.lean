...
`h` outputs. A witness program that allocates exactly the 353 new bits gives
617 private variables. This module does not provide that executable program
or a retained-coordinate layout.
-/
