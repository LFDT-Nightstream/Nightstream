...
namespace Nightstream.Implementation.Nebula.ProductionMemoryBatchCarrierBridge
...
end Nightstream.Implementation.Nebula.ProductionMemoryBatchCarrierBridge
