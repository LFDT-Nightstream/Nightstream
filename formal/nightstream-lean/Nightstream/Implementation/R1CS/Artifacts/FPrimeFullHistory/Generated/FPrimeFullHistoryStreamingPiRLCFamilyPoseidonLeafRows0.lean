...
def rawRow00 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 15504881536434223753 }], geometric := [{ slot := .externalA 0, initial := 4, ratio := 3 }, { slot := .externalA 1, initial := 6, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }, { slot := .externalA 3, initial := 2, ratio := 3 }, { slot := .externalB 0, initial := 2, ratio := 3 }, { slot := .externalB 1, initial := 3, ratio := 3 }, { slot := .externalB 2, initial := 1, ratio := 3 }, { slot := .externalB 3, initial := 1, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow01 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 2212164856944708396 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 4, ratio := 3 }, { slot := .externalA 2, initial := 6, ratio := 3 }, { slot := .externalA 3, initial := 2, ratio := 3 }, { slot := .externalB 0, initial := 1, ratio := 3 }, { slot := .externalB 1, initial := 2, ratio := 3 }, { slot := .externalB 2, initial := 3, ratio := 3 }, { slot := .externalB 3, initial := 1, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow02 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 1885257220781225929 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 4, ratio := 3 }, { slot := .externalA 3, initial := 6, ratio := 3 }, { slot := .externalB 0, initial := 1, ratio := 3 }, { slot := .externalB 1, initial := 1, ratio := 3 }, { slot := .externalB 2, initial := 2, ratio := 3 }, { slot := .externalB 3, initial := 3, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow03 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 17531637481572944510 }], geometric := [{ slot := .externalA 0, initial := 6, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }, { slot := .externalA 3, initial := 4, ratio := 3 }, { slot := .externalB 0, initial := 3, ratio := 3 }, { slot := .externalB 1, initial := 1, ratio := 3 }, { slot := .externalB 2, initial := 1, ratio := 3 }, { slot := .externalB 3, initial := 2, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow04 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 16769640728293682348 }], geometric := [{ slot := .externalA 0, initial := 2, ratio := 3 }, { slot := .externalA 1, initial := 3, ratio := 3 }, { slot := .externalA 2, initial := 1, ratio := 3 }, { slot := .externalA 3, initial := 1, ratio := 3 }, { slot := .externalB 0, initial := 4, ratio := 3 }, { slot := .externalB 1, initial := 6, ratio := 3 }, { slot := .externalB 2, initial := 2, ratio := 3 }, { slot := .externalB 3, initial := 2, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow05 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 445908668462176974 }], geometric := [{ slot := .externalA 0, initial := 1, ratio := 3 }, { slot := .externalA 1, initial := 2, ratio := 3 }, { slot := .externalA 2, initial := 3, ratio := 3 }, { slot := .externalA 3, initial := 1, ratio := 3 }, { slot := .externalB 0, initial := 2, ratio := 3 }, { slot := .externalB 1, initial := 4, ratio := 3 }, { slot := .externalB 2, initial := 6, ratio := 3 }, { slot := .externalB 3, initial := 2, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow06 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 1308472042479836079 }], geometric := [{ slot := .externalA 0, initial := 1, ratio := 3 }, { slot := .externalA 1, initial := 1, ratio := 3 }, { slot := .externalA 2, initial := 2, ratio := 3 }, { slot := .externalA 3, initial := 3, ratio := 3 }, { slot := .externalB 0, initial := 2, ratio := 3 }, { slot := .externalB 1, initial := 2, ratio := 3 }, { slot := .externalB 2, initial := 4, ratio := 3 }, { slot := .externalB 3, initial := 6, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
...
def rawRow07 : RawRow where
  ...
  , { explicit := [{ column := .one, coefficient := 17465001500823438575 }], geometric := [{ slot := .externalA 0, initial := 3, ratio := 3 }, { slot := .externalA 1, initial := 1, ratio := 3 }, { slot := .externalA 2, initial := 1, ratio := 3 }, { slot := .externalA 3, initial := 2, ratio := 3 }, { slot := .externalB 0, initial := 6, ratio := 3 }, { slot := .externalB 1, initial := 2, ratio := 3 }, { slot := .externalB 2, initial := 2, ratio := 3 }, { slot := .externalB 3, initial := 4, ratio := 3 }] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
  , { explicit := [], geometric := [] }
