...
namespace Nightstream.Assurance.Nebula.ProductionPaperReleasePipeline
...
inductive Failure
  ...
  | lifetime
      (failure :
        Nightstream.Implementation.Nebula.ProductionPaperExactLifetimeSoundness.Failure
          context) :
...
structure LifetimeFailureAccounting
  ...
  fingerprint : ∀ {before :
      Nightstream.Protocol.Nebula.FPrime.ClosedCarry
        Nightstream.Protocol.Nebula.Digest.Value}
      (run :
        Nightstream.Implementation.Nebula.ProductionMemoryRowSegments.SegmentRun
          context.candidate context.Schema context.Verifier context.headers
          before),
    Nightstream.Protocol.Nebula.IdealFingerprint.EvaluationFailure
        (Nightstream.Implementation.Nebula.ProductionMemorySegmentSoundness.SegmentRun.fingerprintCheck
          run) →
  ...
  initialRoot : ∀ {before :
    ...
    context.snapshotRoot
          (Nightstream.Implementation.Nebula.ProductionMemorySnapshotCoverage.SegmentRun.snapshot
  ...
  finalRoot : ∀ {before :
    ...
    context.snapshotRoot
      ...
      occurs .circuitRefinement
  snapshotCollision :
    Nightstream.Protocol.Nebula.IdealAcceptance.SnapshotRootCollision
        context.snapshotRoot →
      occurs .poseidonOrTranscript
...
structure Certificate
  ...
  semantic :
    Nightstream.Implementation.Nebula.ProductionPaperExactLifetimeSoundness.CertifiedExecution
      lifetime.base
...
theorem baseChallengeAuthorityExact
    ...
    certificate.lifetime.base.opening.authority =
      Nightstream.Implementation.Nebula.ProductionPaperBaseInvocationFor.challengeAuthority
...
theorem exactClaimSchedule
    ...
    {proof : Bytes}
    (certificate : Certificate boundary proof) :
    Nightstream.Implementation.Nebula.ProductionPaperExactFPrimeLifetimeFor.Lifetime.ExactSchedule
...
theorem fixedBranchSchedule
    ...
    {proof : Bytes}
    (certificate : Certificate boundary proof) :
    Nightstream.Implementation.Nebula.ProductionPaperExactFPrimeLifetimeFor.Lifetime.FixedBranchSchedule
      certificate.semantic.extraction.claimLifetime :=
...
theorem fullStateContinuityExact
    ...
    {proof : Bytes}
    (certificate : Certificate boundary proof) :
    Nightstream.Implementation.Nebula.ProductionPaperExactFPrimeLifetimeFor.Schedule.FullStateContinuous
...
theorem exactClaimOpenings
    ...
    {proof : Bytes}
    (certificate : Certificate boundary proof) :
    Nightstream.Implementation.Nebula.ProductionPaperClaimOpeningLifetimeFor.ClaimLifetime.ExactOpenings
      certificate.semantic.extraction.claimLifetime :=
    ...
    forall receipt,
      receipt ∈ certificate.semantic.extraction.claimLifetime.consumedReceipts ->
        exists assignment : context.claimLifecycle.FreshAssignment,
          Nightstream.Implementation.Nebula.ProductCommitmentAlgebra.commit
              context.config assignment =
            Nightstream.Implementation.Nebula.ProductNifsCodec.codecBundle
      ...
      receipt ∈ certificate.semantic.extraction.claimLifetime.consumedReceipts ->
        exists assignment : context.claimLifecycle.FreshAssignment,
          Nightstream.SuperNeo.CCS.Holds
            (Nightstream.Implementation.Nebula.ProductPaperAlgebraFor.semantics
              context.config)
            Nightstream.SuperNeo.Concrete.productionGlobalParams
            (Nightstream.Implementation.Nebula.ProductionPaperClaimOpeningLifetimeFor.ClaimLifetime.statementOfProtocolClaim
...
theorem everyConsumedClaimSelectsGeneratedCore
  ...
  rcases
      Nightstream.Implementation.Nebula.ProductionPaperClaimOpeningLifetimeFor.ClaimLifetime.ReceiptOpening.exactDecodedBranch
        opened with
...
structure GeneratedCertificate
  ...
  finiteCapacity :
    Nightstream.Implementation.Nebula.RecursiveSizeClosure.FiniteArtifactCapacity
...
theorem recursivePayloadCanonical
    ...
    (Nightstream.Implementation.Nebula.RecursiveSizeClosure.payloadCodec
...
theorem rowsAndCarrierFit
    ...
    generated.verifierArtifact.fPrimeProgram.rows.length <=
      ...
      Nightstream.Implementation.Nebula.ProductionFreshLowNormEncoding.logicalWidth
...
end Nightstream.Assurance.Nebula.ProductionPaperReleasePipeline
