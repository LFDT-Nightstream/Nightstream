...
use neo_fold_legacy::engine::r1cs_circuit::field_ext::KVar;
use neo_fold_legacy::engine::r1cs_circuit::{enforce_sumcheck_round, R1csBuilder};
use neo_fold_legacy::frontends::direct_ccs::{self, R1cs};
use neo_fold_legacy::paper::construction2::{self, State};
...
fn state_x_out(prep: &neo_fold_legacy::Preprocessing, state: &State) -> [F; 4] {
...
fn full_history_fixture() -> (neo_fold_legacy::Preprocessing, neo_fold_legacy::UncompressedAudit) {
