//! Owns the frozen Phase 0 real-point derivation helpers for RV32IM eval claims.
//!
//! It owns:
...
pub fn derive_phase0_point(
    ...
    let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/opening_convergence/phase0/point");
