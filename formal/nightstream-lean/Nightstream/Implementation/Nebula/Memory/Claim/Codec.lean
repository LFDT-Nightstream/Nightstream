...
namespace Nightstream.Implementation.Nebula.MemoryClaimCodec
...
private theorem digestValue_lt_wordCapacity
  ...
  exact value.property.trans (by
    norm_num [Nightstream.Protocol.Nebula.ShiftedTernary41V1.modulus,
      baseFieldBitCount])
...
theorem encodeFields_binary
    ...
    digit < 2 :=
  Nightstream.Implementation.Nebula.WasmStateCodec.encodeWord_binary
    _ _ _ member
...
end Nightstream.Implementation.Nebula.MemoryClaimCodec
