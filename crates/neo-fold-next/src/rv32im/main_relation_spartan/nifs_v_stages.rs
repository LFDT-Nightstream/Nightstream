...
pub(in crate::rv32im::main_relation_spartan) struct Rv32imPiCcsStageOutput {
    pub(in crate::rv32im::main_relation_spartan) effective_output_count: usize,
    pub(in crate::rv32im::main_relation_spartan) me_input_projection_digests: Vec<[AllocatedNum<SpartanF>; 4]>,
    pub(in crate::rv32im::main_relation_spartan) padded_ccs_outputs: Vec<CeClaimVar>,
    pub(in crate::rv32im::main_relation_spartan) r_prime_vars: Vec<KNumVar>,
    pub(in crate::rv32im::main_relation_spartan) s_col_prime_vars: Vec<KNumVar>,
    pub(in crate::rv32im::main_relation_spartan) fold_digest: [AllocatedNum<SpartanF>; 4],
    pub(in crate::rv32im::main_relation_spartan) public_chunk_instance_digest: [AllocatedNum<SpartanF>; 4],
    pub(in crate::rv32im::main_relation_spartan) public_chunk_digest: [AllocatedNum<SpartanF>; 4],
    pub(in crate::rv32im::main_relation_spartan) public_chunk_start_index: AllocatedNum<SpartanF>,
    pub(in crate::rv32im::main_relation_spartan) public_chunk_start_index_halves: [AllocatedNum<SpartanF>; 2],
    pub(in crate::rv32im::main_relation_spartan) public_chunk_start_index_half_values: [SpartanF; 2],
    pub(in crate::rv32im::main_relation_spartan) public_chunk_start_index_value: SpartanF,
    pub(in crate::rv32im::main_relation_spartan) public_step_count: AllocatedNum<SpartanF>,
    pub(in crate::rv32im::main_relation_spartan) public_step_count_halves: [AllocatedNum<SpartanF>; 2],
    pub(in crate::rv32im::main_relation_spartan) public_step_count_half_values: [SpartanF; 2],
    pub(in crate::rv32im::main_relation_spartan) public_step_count_value: SpartanF,
    pub(in crate::rv32im::main_relation_spartan) public_step_vars:
        Vec<crate::superneo_circuit::public_chunk::PublicStepVar>,
    pub(in crate::rv32im::main_relation_spartan) fe_rounds: Vec<Vec<KNumVar>>,
    pub(in crate::rv32im::main_relation_spartan) fe_round_values: Vec<Vec<K>>,
    pub(in crate::rv32im::main_relation_spartan) nc_rounds: Vec<Vec<KNumVar>>,
    pub(in crate::rv32im::main_relation_spartan) nc_round_values: Vec<Vec<K>>,
}
