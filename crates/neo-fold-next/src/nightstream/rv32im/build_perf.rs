...
use crate::rv32im::kernel::{
    ...
    verify_rv32im_kernel_export_proof_with_relation_output,
};
...
> {
    ...
    let _opening_artifact =
        super::opening_artifact::build_rv32im_opening_artifact_from_trusted_local_phase0_and_convergence_artifacts(
    ...
    let side_opening_statement = super::side_opening_relation::build_rv32im_side_opening_relation_statement(
        &accepted_artifact.statement,
        &side_proof_bundle,
    )?;
    let side_opening_witness =
        super::side_opening_relation::build_rv32im_side_opening_relation_witness_from_accepted_artifact(
            accepted_artifact,
        );
    ...
    let started = Instant::now();
    let side_opening_keys = super::side_opening_spartan::setup_rv32im_side_opening_spartan_cached(
    ...
    let started = Instant::now();
    let side_opening_proof = super::side_opening_spartan::prove_rv32im_side_opening_spartan(
    ...
    let side_proof = Rv32imSideProof {
