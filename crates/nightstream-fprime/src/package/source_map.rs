...
const PILOT_SOURCE_COLUMN_COUNT: usize = 13_692_624;
const PILOT_PRIVATE_COLUMN_COUNT: usize = 13_692_350;
const PILOT_INPUT_PRIVATE_COLUMN_COUNT: usize = 91_874;
const PROOF_INPUT_COLUMN_COUNT: usize = 29_072;
const PROOF_INPUT_SOURCE_START: usize = 13_692_628;
const PI_CCS_PHASE_OFFSET: usize = 13_721_700;
const PI_CCS_LOCAL_START: usize = 13_721_422;
const PRIVATE_COLUMN_COUNT: usize = 27_695_694;
const EXPECTED_CONTEXT_PUBLIC_START: usize = 27_695_969;

const PILOT_PRIOR_PUBLIC_START: usize = 45_937;
const PILOT_OUTPUT_PREIMAGE_START: usize = 46_207;
const PILOT_OUTPUT_DIGEST_START: usize = 92_144;
const PILOT_WITNESS_START: usize = 92_148;
const PILOT_SECOND_PRIVATE_START: usize = 45_937;
const PILOT_WITNESS_PRIVATE_START: usize = 91_874;
const PILOT_FIRST_PUBLIC_START: usize = 13_692_351;
const PILOT_SECOND_PUBLIC_START: usize = 13_692_621;
