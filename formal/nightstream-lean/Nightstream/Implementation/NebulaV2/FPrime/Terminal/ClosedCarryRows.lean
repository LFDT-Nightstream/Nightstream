...
namespace Nightstream.Implementation.NebulaV2.TerminalClosedCarryRows
...
theorem parsed_phase_closed
    {layout : Layout} {assignment : Nat → Nat}
    {headers : Nightstream.Protocol.NebulaV2.FPrime.ChainHeaders
...
end Nightstream.Implementation.NebulaV2.TerminalClosedCarryRows
