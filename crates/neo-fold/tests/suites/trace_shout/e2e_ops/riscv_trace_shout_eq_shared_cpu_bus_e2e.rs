...
#[test]
fn riscv_trace_wiring_ccs_shared_cpu_bus_shout_eq_prove_verify() {
    ...
    // Legacy no-shared packed Shout tests need enough witness width to host the packed bus lane.
    let min_m = layout
        .m_in
