...
namespace tests.NebulaProductionPaperClaimOpeningLifetimeFor

open Nightstream.Implementation.Nebula.ProductionPaperClaimOpeningLifetimeFor
...
end tests.NebulaProductionPaperClaimOpeningLifetimeFor
