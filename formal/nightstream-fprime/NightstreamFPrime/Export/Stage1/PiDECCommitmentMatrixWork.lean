...
private theorem selectedWidth : 184359519 = PiDECInputCheck.logicalWidth :=
...
private def blocks (_ : Unit) : Result (RetainedBlock × RetainedBlock) :=
  ⟨(⟨.field, 1188, 119927322⟩, ⟨.field, 49248, 125343586⟩), 10⟩
...
private theorem blocks_value (application : Lifecycle.Stage1.Application.Program) :
  ...
  have parentStart : PiDECRetainedGeometry.parentCommitmentStart application = 119927322 := by
    ...
    change PiRLCRetainedGeometry.productOutputStart application + 19008 * 41 = 119927322
    omega
  have proofStart : PiDECRetainedGeometry.proofStart application = 125343586 := by
    exact PiRLCPoseidonGeometry.pilotLogicalWidth_eq application
  change ((⟨.field, 1188, 119927322⟩, ⟨.field, 49248, 125343586⟩) : RetainedBlock × RetainedBlock) =
...
def commitmentForms (index : Fin 1188) :
  ...
  let result := run 184359519 (by decide) index
...
theorem commitmentForms_value (index : Fin 1188) :
  ...
  @cast_run_value Poseidon2HashChainV1Package.application 184359519 PiDECInputCheck.logicalWidth
...
theorem commitmentForms_lengths (index : Fin 1188) :
  ...
  @cast_lengths 184359519 PiDECInputCheck.logicalWidth selectedWidth
    (run 184359519 (by decide) index).value
    (@run_lengths Poseidon2HashChainV1Package.application 184359519 (by decide)
...
theorem commitmentForms_work_le (index : Fin 1188) :
  ...
  run_work_le 184359519 (by decide) index
