...
use super::layout::{
    ...
    COL_COMM_CHAIN3_AFTER, COL_COMM_CHAIN3_BEFORE, COL_EVBUF_AFTER, COL_EVBUF_BEFORE, COL_EVBUF_SLOT_AFTER,
    COL_EVBUF_SLOT_BEFORE, COL_GRAMMAR_ARGS_BASE_AFTER, COL_GRAMMAR_ARGS_BASE_BEFORE, COL_GRAMMAR_EVIDX_AFTER,
    COL_GRAMMAR_EVIDX_BEFORE, COL_GRAMMAR_EVREM_AFTER, COL_GRAMMAR_EVREM_BEFORE, COL_GRAMMAR_MODE_AFTER,
    COL_GRAMMAR_MODE_BEFORE, COL_GRAMMAR_SLOT_CURSOR_AFTER, COL_GRAMMAR_SLOT_CURSOR_BEFORE, COL_HALTED,
