...
noncomputable abbrev polyEval := SuperNeo.polyEval

/-- [Role: Theorem-Target] Constructive interpolation coefficients. -/
noncomputable abbrev interpolateCoeffs := SuperNeo.interpolateCoeffs
...
noncomputable abbrev interpolationCase := SuperNeo.interpolationCase
