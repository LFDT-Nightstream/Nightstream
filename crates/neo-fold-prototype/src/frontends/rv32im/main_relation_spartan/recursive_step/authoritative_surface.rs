...
use crate::rv32im::final_relation::{
    rv32im_chunk_fold_transcript_snapshot_digest, rv32im_recursive_accumulator_instance_digest_from_parts,
    Rv32imChunkFoldTranscriptSnapshot,
};
use crate::rv32im::main_relation_trace::Rv32imMainCircuitChunkReplaySurface;
use crate::rv32im::SimpleKernelError;

#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct Rv32imMainRecursionStepAuthoritativeChunkSurface {
    pub chunk_index: u64,
...
impl Rv32imMainRecursionStepAuthoritativeChunkSurface {
    pub fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface");
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/version",
            b"v1",
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/chunk_index",
            &[self.chunk_index],
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/vk_fs_digest",
            &self.vk_fs_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/transcript_in_digest",
            &self.transcript_in_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/transcript_out_digest",
            &self.transcript_out_digest,
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/state_in_claim_count",
            &[self.state_in_claim_count],
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/state_in_claims_digest",
            &self.state_in_claims_digest,
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/state_out_claim_count",
            &[self.state_out_claim_count],
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/state_out_claims_digest",
            &self.state_out_claims_digest,
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/ccs_output_count",
            &[self.ccs_output_count],
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/ccs_outputs_digest",
            &self.ccs_outputs_digest,
        );
        tr.append_u64s(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/child_claim_count",
            &[self.child_claim_count],
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/child_claims_digest",
            &self.child_claims_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/parent_claim_digest",
            &self.parent_claim_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/public_chunk_instance_digest",
            &self.public_chunk_instance_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/public_chunk_digest",
            &self.public_chunk_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/bridge_handoff_digest",
            &self.bridge_handoff_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/chunk_relation_digest",
            &self.chunk_relation_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/carry_state_in_digest",
            &self.carry_state_in_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/carry_state_out_digest",
            &self.carry_state_out_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/folded_accumulator_digest",
            &self.folded_accumulator_digest,
        );
        tr.append_message(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/terminal_handle_digest",
...
fn build_surface_from_parts(
    ...
    replay_surface: &Rv32imMainCircuitChunkReplaySurface,
    ...
    Rv32imMainRecursionStepAuthoritativeChunkSurface {
        ...
        transcript_in_digest: rv32im_chunk_fold_transcript_snapshot_digest(transcript_in),
        transcript_out_digest: rv32im_chunk_fold_transcript_snapshot_digest(transcript_out),
        state_in_claim_count: state_in_claims.len() as u64,
        state_in_claims_digest: digest_me_claim_sequence(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/state_in_claims",
            state_in_claims,
        ),
        state_out_claim_count: state_out_claims.len() as u64,
        state_out_claims_digest: digest_me_claim_sequence(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/state_out_claims",
            state_out_claims,
        ),
        ccs_output_count: replay_surface.pi_ccs.ccs_outputs.len() as u64,
        ccs_outputs_digest: digest_me_claim_sequence(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/ccs_outputs",
        ...
        child_claims_digest: digest_me_claim_sequence(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/children",
            &replay_surface.pi_dec.children,
        ),
        parent_claim_digest: digest_me_claim_sequence(
            b"neo.fold.next/rv32im/main_recursion_step_authoritative_chunk_surface/parent",
        ...
        carry_state_in_digest: rv32im_chunk_step_recursive_carry_state_digest(
            state_in_claims,
            transcript_in,
            *backend_relation.payload.z_i(),
        ),
        carry_state_out_digest: rv32im_chunk_step_recursive_carry_state_digest(
            state_out_claims,
            transcript_out,
            terminal_handle_digest,
        ),
        folded_accumulator_digest: rv32im_recursive_accumulator_instance_digest_from_parts(
            state_out_claims,
            terminal_handle_digest,
        ),
        terminal_handle_digest,
...
fn build_native_surface(
    backend_relation: &Rv32imMainRecursionFPrimeBackendRelation,
) -> Result<Rv32imMainRecursionStepAuthoritativeChunkSurface, SimpleKernelError> {
...
pub fn build_rv32im_main_recursion_step_authoritative_chunk_surface(
    backend_relation: &Rv32imMainRecursionFPrimeBackendRelation,
) -> Result<Rv32imMainRecursionStepAuthoritativeChunkSurface, SimpleKernelError> {
    ...
    if payload.state_in_claims.len() < state_in_claim_count || payload.state_out_claims.len() < state_out_claim_count {
        return Err(SimpleKernelError::Bridge(
            "RV32IM recursive-step authoritative chunk surface cannot truncate carried claims past the live step counts"
                .into(),
        ));
    }
    Ok(build_surface_from_parts(
...
pub fn debug_check_rv32im_main_recursion_step_authoritative_chunk_surface_matches_native(
    backend_relation: &Rv32imMainRecursionFPrimeBackendRelation,
) -> Result<(), SimpleKernelError> {
    let carried_surface = build_rv32im_main_recursion_step_authoritative_chunk_surface(backend_relation)?;
    let native_surface = build_native_surface(backend_relation)?;
    if carried_surface != native_surface {
        return Err(SimpleKernelError::Bridge(
            "RV32IM recursive-step authoritative chunk surface recovered from the carried payload does not match the native chunk replay theorem surface"
                .into(),
        ));
    }
    Ok(())
