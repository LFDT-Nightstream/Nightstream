...
use neo_fold_legacy::frontends::r1cs_f_prime::lean_manifest::GOLDILOCKS_MODULUS;
use neo_fold_legacy::frontends::r1cs_f_prime::lean_native_ccs_manifest::{
    LEAN_NATIVE_CCS_MANIFEST_FORMAT, LEAN_NATIVE_CCS_MANIFEST_SCHEMA_VERSION,
};
use neo_fold_legacy::{LeanNativeCcsManifest, LeanNebulaCombinedManifest};
...
fn terminal_r1cs_cost(
    ...
    let running_claims = neo_fold_legacy::config::K_RHO as usize;
...
pub(super) fn valid_manifest() -> Value {
    ...
    json!({
        ...
        "profile": {
            ...
            "running_source_count": neo_fold_legacy::config::K_RHO,
            ...
            "decomposition_children": neo_fold_legacy::config::K_RHO,
        },
        "widths": {
            "iteration": 1,
            "state": 2,
