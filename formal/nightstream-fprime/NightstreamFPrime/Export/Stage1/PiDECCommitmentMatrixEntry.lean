...
private theorem width_eq : PiDECInputCheck.logicalWidth = 172217903 :=
...
def entry (matrix : Fin productionShape.matrixCount)
  ...
  let result := CoefficientWork.coefficient (logicalWidth := 172217903)
...
theorem entry_value (matrix : Fin productionShape.matrixCount)
  ...
  change (CoefficientWork.coefficient (logicalWidth := 172217903)
