...
use super::fixed_transcript::derive_rv32im_fixed_transcript_out_from_chunk_body;
use super::{
...
fn build_rv32im_main_recursion_f_prime_payload_with_trace(
    advice: &Rv32imMainRecursionFPrimeAdvice,
    spartan_shape: &Rv32imMainRecursionStepSpartanShape,
    ...
    let mut payload = Rv32imMainRecursionFPrimePayload {
        ...
        pc_i: advice.pc_i(),
        pc_next: crate::rv32im::main_recursion::RV32IM_MAIN_RECURSION_TRIVIAL_PC,
