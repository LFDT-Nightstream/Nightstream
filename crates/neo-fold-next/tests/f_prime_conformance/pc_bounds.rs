...
//! specialization, the RV32IM trivial control lane fixes `pc_i = 1`, so any
...
use neo_fold_next::rv32im::audit::{
    evaluate_rv32im_main_recursion_f_prime_advice, rv32im_main_recursion_advice_tamper_pc_i,
};
...
fn f_prime_rejects_out_of_bounds_pc_i() {
    ...
    rv32im_main_recursion_advice_tamper_pc_i(&mut tampered);
    assert!(
