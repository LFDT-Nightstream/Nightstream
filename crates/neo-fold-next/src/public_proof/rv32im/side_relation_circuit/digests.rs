...
use crate::rv32im::stage1::{stage1_row_words, Stage1RowBinding};
...
use crate::rv32im::stage3::{continuity_event_words, ContinuityEvent};
use crate::superneo_circuit::public_chunk::{alloc_public_step, public_chunk_instance_digest, PublicStepVar};
...
pub fn stage1_row_digest<CS: ConstraintSystem<SpartanF>>(
    ...
    digest_u64_words(
        ...
        b"neo.fold.next/rv32im/stage1_selected_row",
        b"stage1/row",
...
pub fn register_read_event_digest<CS: ConstraintSystem<SpartanF>>(
    ...
    digest_u64_words(
        ...
        b"neo.fold.next/rv32im/stage2_selected_register_read",
        b"stage2/read",
...
pub fn register_write_event_digest<CS: ConstraintSystem<SpartanF>>(
    ...
    digest_u64_words(
        ...
        b"neo.fold.next/rv32im/stage2_selected_register_write",
        b"stage2/write",
...
pub fn ram_event_digest<CS: ConstraintSystem<SpartanF>>(
    ...
    digest_u64_words(
        ...
        b"neo.fold.next/rv32im/stage2_selected_ram_event",
        b"stage2/ram",
...
pub fn twist_link_event_digest<CS: ConstraintSystem<SpartanF>>(
    ...
    digest_u64_words(
        ...
        b"neo.fold.next/rv32im/stage2_selected_twist_link",
        b"stage2/twist",
...
pub fn continuity_event_digest<CS: ConstraintSystem<SpartanF>>(
    ...
    digest_u64_words(
        ...
        b"neo.fold.next/rv32im/stage3_selected_continuity",
        b"stage3/continuity",
        &words,
...
pub fn single_step_packaged_statement_digest_from_exact_words<CS: ConstraintSystem<SpartanF>>(
    ...
    let step = crate::rv32im::kernel::build_claim_packaged_public_step(step_label, words)
...
pub fn kernel_binding_opening_packaged_statement_digest<CS: ConstraintSystem<SpartanF>>(
    ...
    single_step_packaged_statement_digest_from_exact_words_with_native_step(
        ...
        final_main_claim_digests,
        "rv32im_kernel_opening_bundle_bindings",
    )
}
...
pub fn kernel_prepared_step_opening_packaged_statement_digest<CS: ConstraintSystem<SpartanF>>(
    ...
    single_step_packaged_statement_digest_from_exact_words_with_native_step(
        ...
        final_main_claim_digests,
        "rv32im_kernel_opening_bundle_prepared_steps",
    )
}
