use neo_fold_legacy::engine::r1cs_circuit::builder::{Poseidon2HashAudit, Poseidon2HashRoundAuditKind};
use neo_fold_legacy::engine::r1cs_circuit::{enforce_poseidon2_permutation, R1csBuilder, R1csSnapshot, Var};
use neo_fold_legacy::frontends::f_prime::gadget_native::audit_r1cs_gadget_native_source_manifest;
...
def sourcePath : String :=\n\
  \"crates/neo-fold-legacy/tests/nebula/streaming_prelude_relation.rs\"\n\n",
    );
    writeln!(
        out,
...
set_option maxRecDepth 2048\n\n",
    ...
    writeln!(
        out,
        "  sourcePath := \"crates/neo-fold-legacy/src/frontends/nebula/f_prime/streaming_prelude_relation.rs\""
    )
    .expect("render main");
