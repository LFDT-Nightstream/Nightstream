...
fn render_body_opening_rows_artifact(
    audit: &neo_fold_legacy::frontends::nebula::f_prime::NebulaFPrimePiRlcBodyOpeningRowsAudit,
) -> String {
    let mut rendered = String::new();
    writeln!(
        rendered,
...
fn render_body_algebra_retained_artifact(
    audit: &neo_fold_legacy::frontends::nebula::f_prime::NebulaFPrimePiRlcBodyAlgebraRetainedAudit,
) -> String {
    let mut rendered = String::new();
    writeln!(
        rendered,
...
fn render_body_carry_retained_artifact(
    audit: &neo_fold_legacy::frontends::nebula::f_prime::NebulaFPrimePiRlcBodyCarryRetainedAudit,
) -> String {
    let mut rendered = String::new();
    writeln!(
        rendered,
...
fn render_body_residual_retained_artifact(
    audit: &neo_fold_legacy::frontends::nebula::f_prime::NebulaFPrimePiRlcBodyResidualRetainedAudit,
) -> String {
    let mut rendered = String::new();
    writeln!(
        rendered,
...
fn render_overlay_retained_artifact(
    audit: &neo_fold_legacy::frontends::nebula::f_prime::NebulaFPrimePiRlcFamilyOverlayRetainedAudit,
) -> String {
    let mut rendered = String::new();
    writeln!(
        rendered,
    ...
    for (arm, (decoder, expected_range)) in decoders.iter().zip(expected_ranges).enumerate() {
        ...
        for run in decoder.runs() {
            let kind = match run.resolution() {
                neo_fold_legacy::frontends::r1cs_f_prime::SelectiveProjectedSourceResolutionRun::Direct {
                    ..
                } => "direct",
                neo_fold_legacy::frontends::r1cs_f_prime::SelectiveProjectedSourceResolutionRun::DecompositionAlias {
                    ..
                } => "decomposition_alias",
                neo_fold_legacy::frontends::r1cs_f_prime::SelectiveProjectedSourceResolutionRun::EqualityAlias {
                    ..
                } => "equality_alias",
                neo_fold_legacy::frontends::r1cs_f_prime::SelectiveProjectedSourceResolutionRun::LinearDefinition => {
                    "linear_definition"
                }
                neo_fold_legacy::frontends::r1cs_f_prime::SelectiveProjectedSourceResolutionRun::TraceEliminated => {
                    "trace_eliminated"
                }
            };
