...
use neo_fold_legacy::frontends::nebula::layout::{MemOpRecord, MemSpace, NebulaParams, H_RS};
...
fn tampered_assignments_are_rejected_by_rows() {
    ...
    let h_out_col = 1 + neo_fold_legacy::frontends::nebula::layout::x_offsets::H_OUT;
...
fn field_native_r1cs_lowering_matches_s_mem_acceptance_and_rejection() {
    ...
    let tamper_columns = [
        1 + neo_fold_legacy::frontends::nebula::layout::x_offsets::H_OUT,
        circuit.m_in() + 1,
