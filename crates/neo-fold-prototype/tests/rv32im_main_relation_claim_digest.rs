...
use neo_fold_prototype::circuit::superneo::claim::{alloc_ce_claim, me_digest_poseidon, me_digest_poseidon_values};
use neo_math::{D, F, K};
...
fn rv32im_main_relation_claim_digest_matches_native_poseidon() {
    let claim = toy_claim();
