...
use neo_fold_legacy::paper::digest::F_PRIME_STATE_X_OUT_DOMAIN;
use neo_math::F;
...
fn constant_row_output(source: &neo_fold_legacy::engine::r1cs_circuit::R1csSnapshot, row: usize) -> usize {
    let outputs = source
        .a_row(row)
        .iter()
...
fn branch_constant_values(
    source: &neo_fold_legacy::engine::r1cs_circuit::R1csSnapshot,
    row_start: usize,
...
fn terminal_x_out_first_poseidon2_leaf_shape() {
    ...
    let first_round = &fixture
        ...
        .after_x_out_hash_audit(
            neo_fold_legacy::frontends::nebula::f_prime::NebulaFPrimeStreamingLifecycleArm::Recursive,
        )
        .hash()
        .rounds[0];
