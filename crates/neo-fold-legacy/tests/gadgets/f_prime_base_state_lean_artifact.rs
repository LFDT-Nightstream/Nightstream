...
use neo_ccs::Mat;
use neo_fold_legacy::engine::decider::__test_isolation::enforce_base_state_constants_against;
use neo_fold_legacy::frontends::direct_ccs::{self, R1cs};
use neo_fold_legacy::paper::f_prime::r1cs::FPrimePublicInputLayout;
use neo_math::F;
...
fn build() -> neo_fold_legacy::engine::r1cs_circuit::R1csBuilder {
...
fn pinned_values(builder: &neo_fold_legacy::engine::r1cs_circuit::R1csBuilder) -> Vec<u64> {
    PINNED_COLUMNS
        .iter()
...
fn artifact_hashes(builder: &neo_fold_legacy::engine::r1cs_circuit::R1csBuilder) -> (String, String) {
