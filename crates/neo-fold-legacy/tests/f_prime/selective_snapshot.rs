...
use neo_fold_legacy::engine::r1cs_circuit::field_ext::{enforce_k_dot_product, KVar};
use neo_fold_legacy::engine::r1cs_circuit::u64_arith::decompose_var_to_u64_bits;
use neo_fold_legacy::engine::r1cs_circuit::{Lc, R1csBuilder};
use neo_fold_legacy::frontends::r1cs_f_prime::lowering::{LowNormR1csError, SelectiveSnapshotError};
...
use neo_fold_legacy::paper::f_prime::r1cs::{F_PRIME_PUBLIC_INPUT_LEN, F_PRIME_SUPERNEO_PUBLIC_INPUT_LEN};
use neo_fold_legacy::paper::reductions::accumulator_sis_circuit::{enforce_commit_fields, CCS_CLAIM_SIS_CONFIG};
use neo_math::{D, F};
...
fn write_raw_source_rows(
    rendered: &mut String,
    source_arm: &neo_fold_legacy::frontends::r1cs_f_prime::SparseR1cs,
...
fn render_carrier_270_artifact(
    layout: &neo_fold_legacy::frontends::r1cs_f_prime::SelectiveLayoutAudit,
...
fn snapshot_arm(seed: u64) -> (neo_fold_legacy::frontends::r1cs_f_prime::SparseR1cs, Vec<F>) {
...
fn f_prime_public_carrier_fixture() -> Vec<(neo_fold_legacy::frontends::r1cs_f_prime::SparseR1cs, Vec<F>)> {
    (0..3)
        .map(|_| {
            let mut builder = R1csBuilder::new();
