...
use neo_fold_prototype::public_proof::rv32im::rv32im_verifier_context_digest;
...
use neo_fold_prototype::rv32im::main_proof::Rv32imCompressedMainProof;
...
fn final_fixture_from_input(
    ...
    neo_fold_prototype::rv32im::final_relation::Rv32imFinalStatement,
    neo_fold_prototype::rv32im::final_relation::Rv32imFinalBuildProof,
    neo_fold_prototype::public_proof::NightstreamStatement,
) {
    ...
    let published_statement = neo_fold_prototype::rv32im::Rv32imAccumulatorPublicStatement::from_final_artifacts(
        &statement,
        &final_proof,
...
fn compressed_main_proof_fixture(
    statement: &neo_fold_prototype::rv32im::final_relation::Rv32imFinalStatement,
    final_proof: &neo_fold_prototype::rv32im::final_relation::Rv32imFinalBuildProof,
    final_pc: u64,
