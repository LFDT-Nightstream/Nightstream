//! Owns RV32IM-owned witness-facing wrappers above the simple-kernel export.
...
use super::{
    ...
    RootLaneColumns, RootLaneCommitmentSummaryArtifact, Rv32imParityCaseManifest, SimpleKernelError,
...
use crate::rv32im::TranscriptRecord;

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Rv32imProofWitnessBundle {
    pub root_params_id: [u8; 32],
    pub trace: Rv32imTraceProofBundle,
    pub stages: Rv32imStageWitnessProofBundle,
...
pub struct Rv32imKernelOpeningBindingBundle {
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Rv32imKernelOpeningProofBundle {
    pub opening_digest: [u8; 32],
    pub bindings: Rv32imKernelOpeningBindingBundle,
    pub digest: [u8; 32],
    pub opening: SimpleKernelOpeningBundle,
}

#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imKernelOpeningSummaryBundle {
    pub opening_digest: [u8; 32],
    pub bindings: Rv32imKernelOpeningBindingBundle,
    pub digest: [u8; 32],
}
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imKernelClaimTerminalBundle {
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imKernelClaimSummaryBundle {
    pub prepared_step_bindings_digest: [u8; 32],
    pub terminal: Rv32imKernelClaimTerminalBundle,
    pub digest: [u8; 32],
}

#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imKernelClaimSummaryProofBundle {
    pub summary: Rv32imKernelClaimSummaryBundle,
    pub digest: [u8; 32],
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Rv32imKernelExportClaimProof {
    pub final_state_digest: [u8; 32],
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Rv32imKernelClaimProofBundle {
    pub summary: Rv32imKernelClaimSummaryBundle,
    pub packaged: PackagedProof,
    pub digest: [u8; 32],
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imStageClaimDigestBundle {
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imStageClaimSummaryProofBundle {
    pub summary: Rv32imStageClaimDigestBundle,
    pub digest: [u8; 32],
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Rv32imStageClaimProofBundle {
    pub summary: Rv32imStageClaimDigestBundle,
    pub packaged: PackagedProof,
    pub digest: [u8; 32],
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imStagePackageDigestBundle {
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imStagePackageSummaryProofBundle {
    pub summary: Rv32imStagePackageDigestBundle,
    pub digest: [u8; 32],
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Rv32imStagePackageProofBundle {
    pub summary: Rv32imStagePackageDigestBundle,
    pub digest: [u8; 32],
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imTraceShapeBundle {
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imTraceProjectionBundle {
    pub manifest: Rv32imParityCaseManifest,
    pub execution_digest: [u8; 32],
    pub shape: Rv32imTraceShapeBundle,
    pub digest: [u8; 32],
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Rv32imTraceProofBundle {
    pub manifest: Rv32imParityCaseManifest,
    pub execution_digest: [u8; 32],
    pub shape: Rv32imTraceShapeBundle,
    pub digest: [u8; 32],
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imStageWitnessSummaryBundle {
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
pub struct Rv32imStageWitnessProjectionBundle {
    pub summary: Rv32imStageWitnessSummaryBundle,
    pub digest: [u8; 32],
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Rv32imStageWitnessProofBundle {
    pub summary: Rv32imStageWitnessSummaryBundle,
    pub digest: [u8; 32],
...
fn kernel_claim_bundle_words(claims: &SimpleKernelKernelClaimBundle) -> Vec<u64> {
    kernel_claim_words_from_components(
        ...
        u64::from(claims.kernel.final_pc),
...
pub(crate) fn build_stage_claim_packaged_proof(
    ...
    build_claim_packaged_proof("rv32im/stage_claim_bundle", &stage_claim_bundle_words(claims))
}
...
pub(crate) fn verify_stage_claim_packaged_proof(
    ...
    verify_claim_packaged_proof("rv32im/stage_claim_bundle", &stage_claim_bundle_words(claims), packaged)
}
...
pub(crate) fn build_kernel_claim_packaged_proof(
    ...
    build_claim_packaged_proof("rv32im/kernel_claim_bundle", &kernel_claim_bundle_words(claims))
}
...
pub(crate) fn verify_kernel_export_claim_packaged_proof(
    claims: &Rv32imKernelExportClaimProof,
    packaged: &PackagedProof,
) -> Result<(), SimpleKernelError> {
    verify_claim_packaged_proof(
        "rv32im/kernel_export_claim_bundle",
        &kernel_export_claim_words_from_components(claims.final_state_digest()),
        packaged,
    )
}

impl Rv32imProofWitnessBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/proof_witness_bundle");
        tr.append_message(b"rv32im/proof_witness_bundle/root_params_id", &self.root_params_id);
        tr.append_message(b"rv32im/proof_witness_bundle/trace_digest", &self.trace.digest);
        tr.append_message(b"rv32im/proof_witness_bundle/stages_digest", &self.stages.digest);
        tr.append_message(
            b"rv32im/proof_witness_bundle/stage_claims_digest",
            &self.stage_claims.digest,
        );
        tr.append_message(
            b"rv32im/proof_witness_bundle/stage_packages_digest",
            &self.stage_packages.digest,
        );
        tr.append_message(
            b"rv32im/proof_witness_bundle/kernel_opening_digest",
            &self.kernel_opening.digest,
        );
        tr.append_message(
            b"rv32im/proof_witness_bundle/kernel_claims_digest",
            &self.kernel_claims.digest,
        );
        tr.append_message(
            b"rv32im/proof_witness_bundle/root_lane_columns_digest",
            &self.root_lane_columns.digest,
        );
        tr.append_message(
            b"rv32im/proof_witness_bundle/root_lane_commitment_digest",
...
impl Rv32imKernelOpeningBindingBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_opening_binding_bundle");
        tr.append_message(b"rv32im/kernel_opening_binding_bundle/claim_digest", &self.claim_digest);
        tr.append_message(
            b"rv32im/kernel_opening_binding_bundle/bindings_digest",
            &self.bindings_digest,
        );
        tr.append_message(
            b"rv32im/kernel_opening_binding_bundle/prepared_steps_digest",
...
impl Rv32imKernelOpeningProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_opening_proof_bundle");
        tr.append_message(
            b"rv32im/kernel_opening_proof_bundle/opening_digest",
            &self.opening_digest,
        );
        tr.append_message(b"rv32im/kernel_opening_proof_bundle/bindings", &self.bindings.digest);
        tr.digest32()
    }
    ...
    pub fn summary(&self) -> Rv32imKernelOpeningSummaryBundle {
        let summary = Rv32imKernelOpeningSummaryBundle {
            opening_digest: self.opening_digest,
            bindings: self.bindings.clone(),
            digest: [0; 32],
        };
        Rv32imKernelOpeningSummaryBundle {
...
impl Rv32imKernelOpeningSummaryBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_opening_summary_bundle");
        tr.append_message(
            b"rv32im/kernel_opening_summary_bundle/opening_digest",
            &self.opening_digest,
        );
        tr.append_message(
            b"rv32im/kernel_opening_summary_bundle/bindings_digest",
...
impl Rv32imKernelClaimTerminalBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_claim_terminal_bundle");
        tr.append_message(b"rv32im/kernel_claim_terminal_bundle/root0_digest", &self.root0_digest);
        tr.append_message(
            b"rv32im/kernel_claim_terminal_bundle/execution_digest",
            &self.execution_digest,
        );
        tr.append_message(
            b"rv32im/kernel_claim_terminal_bundle/final_state_digest",
            &self.final_state_digest,
        );
        tr.append_message(
            b"rv32im/kernel_claim_terminal_bundle/transcript_final_digest",
            &self.transcript_final_digest,
        );
        tr.append_u64s(
            b"rv32im/kernel_claim_terminal_bundle/meta",
...
impl Rv32imKernelClaimSummaryBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_claim_summary_bundle");
        tr.append_message(
            b"rv32im/kernel_claim_summary_bundle/prepared_step_bindings_digest",
            &self.prepared_step_bindings_digest,
        );
        tr.append_message(
            b"rv32im/kernel_claim_summary_bundle/terminal_digest",
...
impl Rv32imKernelClaimSummaryProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_claim_summary_proof_bundle");
        tr.append_message(
            b"rv32im/kernel_claim_summary_proof_bundle/summary",
            &self.summary.digest,
        );
        tr.digest32()
    }
...
impl Rv32imKernelClaimProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
    ...
    pub fn summary_bundle(&self) -> Rv32imKernelClaimSummaryProofBundle {
        let summary = Rv32imKernelClaimSummaryProofBundle {
            summary: self.summary.clone(),
            digest: [0; 32],
        };
        Rv32imKernelClaimSummaryProofBundle {
            digest: summary.expected_digest(),
            ..summary
        }
    }
...
impl Rv32imKernelExportClaimProof {
    pub(crate) fn summary_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/kernel_export_claim_terminal");
        tr.append_message(
            b"rv32im/kernel_export_claim_terminal/final_state_digest",
            &self.final_state_digest,
        );
        tr.digest32()
    }
    ...
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        packaged_claim_proof_digest(
            b"neo.fold.next/rv32im/kernel_export_claim_proof",
            self.summary_digest(),
            &self.packaged,
        )
    }
...
pub(crate) fn kernel_export_claim_proof_from_bundle(
    bundle: &Rv32imKernelClaimProofBundle,
) -> Result<Rv32imKernelExportClaimProof, SimpleKernelError> {
    let packaged = build_claim_packaged_proof(
        "rv32im/kernel_export_claim_bundle",
        &kernel_export_claim_words_from_components(bundle.final_state_digest()),
    )?;
    let proof = Rv32imKernelExportClaimProof {
        final_state_digest: bundle.final_state_digest(),
        packaged,
        digest: [0; 32],
    };
    Ok(Rv32imKernelExportClaimProof {
        digest: proof.expected_digest(),
        ..proof
    })
}

impl Rv32imStageClaimDigestBundle {
    pub(crate) fn from_claims(claims: &SimpleKernelStageClaimBundle) -> Self {
        let summary = Self {
    ...
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        ...
        tr.append_message(b"rv32im/stage_claim_digest_bundle/stage1_digest", &self.stage1_digest);
        tr.append_message(b"rv32im/stage_claim_digest_bundle/stage2_digest", &self.stage2_digest);
        tr.append_message(b"rv32im/stage_claim_digest_bundle/stage3_digest", &self.stage3_digest);
        tr.append_message(
...
impl Rv32imStageClaimSummaryProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_claim_summary_proof_bundle");
        tr.append_message(b"rv32im/stage_claim_summary_proof_bundle/summary", &self.summary.digest);
        tr.digest32()
    }
...
impl Rv32imStageClaimProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        packaged_claim_proof_digest(
    ...
    pub fn summary_bundle(&self) -> Rv32imStageClaimSummaryProofBundle {
        let summary = Rv32imStageClaimSummaryProofBundle {
            summary: self.summary.clone(),
            digest: [0; 32],
        };
        Rv32imStageClaimSummaryProofBundle {
            digest: summary.expected_digest(),
            ..summary
        }
    }
...
impl Rv32imStagePackageDigestBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_package_digest_bundle");
        tr.append_message(
            b"rv32im/stage_package_digest_bundle/package_bundle_digest",
            &self.package_bundle_digest,
        );
        tr.append_message(b"rv32im/stage_package_digest_bundle/stage1_digest", &self.stage1_digest);
        tr.append_message(b"rv32im/stage_package_digest_bundle/stage2_digest", &self.stage2_digest);
        tr.append_message(b"rv32im/stage_package_digest_bundle/stage3_digest", &self.stage3_digest);
        tr.digest32()
    }
}

impl Rv32imStagePackageSummaryProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_package_summary_proof_bundle");
        tr.append_message(
            b"rv32im/stage_package_summary_proof_bundle/summary",
            &self.summary.digest,
        );
        tr.digest32()
    }
...
impl Rv32imStagePackageProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_package_proof_bundle");
        tr.append_message(b"rv32im/stage_package_proof_bundle/summary", &self.summary.digest);
        tr.digest32()
    }
    ...
    pub fn summary_bundle(&self) -> Rv32imStagePackageSummaryProofBundle {
        let summary = Rv32imStagePackageSummaryProofBundle {
            summary: self.summary.clone(),
            digest: [0; 32],
        };
        Rv32imStagePackageSummaryProofBundle {
            digest: summary.expected_digest(),
            ..summary
        }
    }
...
fn family_word(family: Rv32FamilyTag) -> u64 {
    match family {
...
impl Rv32imTraceShapeBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/trace_shape_bundle");
        tr.append_u64s(
            b"rv32im/trace_shape_bundle/meta",
            &[
...
impl Rv32imTraceProjectionBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/trace_summary_proof_bundle");
        tr.append_message(b"rv32im/trace_summary_proof_bundle/name", self.manifest.name.as_bytes());
        tr.append_message(
            b"rv32im/trace_summary_proof_bundle/fixture_id",
            self.manifest.fixture_id.as_bytes(),
        );
        tr.append_u64s(
            b"rv32im/trace_summary_proof_bundle/meta",
            &[self.manifest.protocol_version_id, self.manifest.lowering_version_id],
        );
        tr.append_u64s(
            b"rv32im/trace_summary_proof_bundle/family_tag_len",
            &[self.manifest.family_tags.len() as u64],
        );
        for family in &self.manifest.family_tags {
            tr.append_u64s(b"rv32im/trace_summary_proof_bundle/family_tag", &[family_word(*family)]);
        }
        tr.append_message(
            b"rv32im/trace_summary_proof_bundle/execution_digest",
            &self.execution_digest,
        );
        tr.append_message(b"rv32im/trace_summary_proof_bundle/shape_digest", &self.shape.digest);
        tr.digest32()
    }
...
impl Rv32imTraceProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/trace_proof_bundle");
        tr.append_message(b"rv32im/trace_proof_bundle/name", self.manifest.name.as_bytes());
        tr.append_message(
            b"rv32im/trace_proof_bundle/fixture_id",
            self.manifest.fixture_id.as_bytes(),
        );
        tr.append_u64s(
            b"rv32im/trace_proof_bundle/meta",
            &[self.manifest.protocol_version_id, self.manifest.lowering_version_id],
        );
        tr.append_u64s(
            b"rv32im/trace_proof_bundle/family_tag_len",
            &[self.manifest.family_tags.len() as u64],
        );
        for family in &self.manifest.family_tags {
            tr.append_u64s(b"rv32im/trace_proof_bundle/family_tag", &[family_word(*family)]);
        }
        tr.append_message(b"rv32im/trace_proof_bundle/execution_digest", &self.execution_digest);
        tr.append_message(b"rv32im/trace_proof_bundle/shape_digest", &self.shape.digest);
        tr.digest32()
    }
    ...
    pub fn projection(&self) -> Rv32imTraceProjectionBundle {
        let summary = Rv32imTraceProjectionBundle {
            manifest: self.manifest.clone(),
            execution_digest: self.execution_digest,
            shape: self.shape.clone(),
            digest: [0; 32],
        };
        Rv32imTraceProjectionBundle {
            digest: summary.expected_digest(),
            ..summary
        }
    }
...
impl Rv32imStageWitnessSummaryBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
...
impl Rv32imStageWitnessProjectionBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
...
impl Rv32imStageWitnessProofBundle {
    pub(crate) fn expected_digest(&self) -> [u8; 32] {
        let mut tr = Poseidon2Transcript::new(b"neo.fold.next/rv32im/stage_witness_proof_bundle");
        tr.append_message(b"rv32im/stage_witness_proof_bundle/summary", &self.summary.digest);
        tr.digest32()
    }
    ...
    pub fn projection_bundle(&self) -> Rv32imStageWitnessProjectionBundle {
        let summary = Rv32imStageWitnessProjectionBundle {
            summary: self.summary.clone(),
            digest: [0; 32],
        };
        Rv32imStageWitnessProjectionBundle {
            digest: summary.expected_digest(),
            ..summary
        }
    }
...
pub(crate) fn trace_projection_bundle_from_rows(
    ...
    let bundle = Rv32imTraceProjectionBundle {
...
pub(crate) fn stage_witness_proof_bundle_from_stages(
    ...
    .summary;
    let bundle = Rv32imStageWitnessProofBundle {
        summary,
        digest: [0; 32],
        stages: stages.clone(),
    };
...
pub(crate) fn stage_witness_projection_bundle_from_summaries(
    ...
    let summary = Rv32imStageWitnessSummaryBundle {
    ...
    let bundle = Rv32imStageWitnessProjectionBundle {
        summary,
        digest: [0; 32],
    };
    Rv32imStageWitnessProjectionBundle {
...
pub(crate) fn stage_claim_summary_bundle_from_claims(
    ...
    let bundle = Rv32imStageClaimSummaryProofBundle {
        summary,
        digest: [0; 32],
    };
    Rv32imStageClaimSummaryProofBundle {
...
pub(crate) fn stage_claim_proof_bundle_from_claims(
    claims: &SimpleKernelStageClaimBundle,
) -> Result<Rv32imStageClaimProofBundle, SimpleKernelError> {
    let summary = stage_claim_summary_bundle_from_claims(claims).summary;
    let packaged = build_stage_claim_packaged_proof(claims)?;
    let bundle = Rv32imStageClaimProofBundle {
        summary,
        packaged,
        digest: [0; 32],
        claims: claims.clone(),
    };
    Ok(Rv32imStageClaimProofBundle {
        digest: bundle.expected_digest(),
        ..bundle
    })
}
...
) -> Rv32imStagePackageProofBundle {
    let summary = stage_package_summary_bundle_from_packages(packages);
    let bundle = Rv32imStagePackageProofBundle {
        summary,
        digest: [0; 32],
...
pub(crate) fn stage_package_summary_bundle_from_packages(
    packages: &SimpleKernelStagePackageBundle,
) -> Rv32imStagePackageDigestBundle {
    let summary = Rv32imStagePackageDigestBundle {
...
) -> Rv32imKernelOpeningProofBundle {
    let bindings = kernel_opening_binding_bundle_from_opening(opening);
    let bundle = Rv32imKernelOpeningProofBundle {
...
pub(crate) fn kernel_opening_binding_bundle_from_opening(
    opening: &SimpleKernelOpeningBundle,
) -> Rv32imKernelOpeningBindingBundle {
    let bindings = Rv32imKernelOpeningBindingBundle {
...
pub(crate) fn kernel_claim_summary_bundle_from_claims(
    ...
    let terminal = Rv32imKernelClaimTerminalBundle {
        ...
        final_pc: u64::from(summary.final_pc),
    ...
    let summary = Rv32imKernelClaimSummaryBundle {
    ...
    let bundle = Rv32imKernelClaimSummaryProofBundle {
        summary,
        digest: [0; 32],
    };
    Rv32imKernelClaimSummaryProofBundle {
...
pub(crate) fn kernel_claim_proof_bundle_from_claims(
    claims: &SimpleKernelKernelClaimBundle,
) -> Result<Rv32imKernelClaimProofBundle, SimpleKernelError> {
    let summary = kernel_claim_summary_bundle_from_claims(claims).summary;
    let packaged = build_kernel_claim_packaged_proof(claims)?;
    let bundle = Rv32imKernelClaimProofBundle {
        summary,
        packaged,
        digest: [0; 32],
        claims: claims.clone(),
    };
    Ok(Rv32imKernelClaimProofBundle {
        digest: bundle.expected_digest(),
        ..bundle
    })
}
...
pub(crate) fn proof_witness_bundle_from_public_kernel_and_trace_stages(
    ...
    let bundle = Rv32imProofWitnessBundle {
        root_params_id,
        trace,
        stages,
        stage_claims,
