...
pub(crate) fn build_ivc_state_continuity_links() -> Vec<WasmCrossStepLinkSpec> {
    vec![
        ...
        WasmCrossStepLinkSpec {
            ...
            column_pairs: vec![
                WasmCrossStepColumnPair {
                    prev_after: Column(COL_HOST_EVENTS_REMAINING_AFTER),
                    next_before: Column(COL_HOST_EVENTS_REMAINING_BEFORE),
                },
                WasmCrossStepColumnPair {
                    prev_after: Column(COL_HOST_EVENT_INDEX_AFTER),
                    next_before: Column(COL_HOST_EVENT_INDEX_BEFORE),
                },
                WasmCrossStepColumnPair {
                    prev_after: Column(COL_HOST_EVENT_ARGS_BASE_AFTER),
                    next_before: Column(COL_HOST_EVENT_ARGS_BASE_BEFORE),
                },
                WasmCrossStepColumnPair {
                    prev_after: Column(COL_HOST_EVENT_SLOT_CURSOR_AFTER),
                    next_before: Column(COL_HOST_EVENT_SLOT_CURSOR_BEFORE),
                },
            ],
        },
        WasmCrossStepLinkSpec {
