...
impl DirectCcsRecursiveIvcState {
    ...
    > {
        ...
        let perf = DirectCcsRecursiveIvcSnarkPerf {
            ...
            f_prime_chain: None,
            f_prime_chain_setup_ms: 0.0,
            f_prime_chain_prove_ms: 0.0,
            f_prime_chain_verify_ms: 0.0,
            f_prime_chain_constraints: 0,
            f_prime_chain_proof_bytes: 0,
            f_prime_final_ce_setup_ms,
            f_prime_final_ce_prove_ms,
            f_prime_final_ce_verify_ms,
            f_prime_final_ce_constraints,
            ...
            total_prove_ms: terminal_perf.total_prove_ms + f_prime_final_ce_prove_ms,
            total_verify_ms: terminal_perf.total_verify_ms + f_prime_final_ce_verify_ms,
            terminal_proof_bytes: terminal_perf.final_proof_bytes,
            f_prime_final_ce_proof_bytes,
            total_proof_bytes: terminal_perf.final_proof_bytes + f_prime_final_ce_proof_bytes,
        };
        Ok((
            DirectCcsRecursiveIvcSnark {
                terminal,
...
impl DirectCcsRecursiveIvcSnark {
    ...
    pub fn verify(
        ...
        if self.f_prime_chain.is_some() || vk.f_prime_chain.is_some() {
            return Err(DirectCcsFPrimeSnarkError::PublicIoMismatch);
        }
        if expected_public_image.folded_f_prime_r2_steps == 0
            && expected_public_image.proven_f_prime_accumulator_digest != vk.expected_f_prime_default_accumulator_digest
        {
            return Err(DirectCcsFPrimeSnarkError::PublicIoMismatch);
        }
        match (
