...
namespace Nightstream.SuperNeo.Concrete.Phi81Relation.PiRLCAlgebra.PublicInput
...
end Nightstream.SuperNeo.Concrete.Phi81Relation.PiRLCAlgebra.PublicInput
